---
title: "Por qué tu empresa tendrá (si no lo hace ya) comunidades de prácticas"
notion_id: 1e3fe674-5ff1-4260-88b8-8afe66b9b341
...
tags: ["Español", "Line/People/Team Management", "Article", "Paradigma Digital"]
---
...
La Comunidad Agile de Paradigma, aunque con una vida relativamente corta, ha pasado por diferentes estados y ha vivido sus aventuras y desventuras.

En este post contamos la importancia de las comunidades de prácticas, las lecciones aprendidas a lo largo del camino y los retos futuros de la Comunidad Agile de Paradigma, de forma que pueda servir de ejemplo a otros que se animen con este tipo de iniciativas o que ya estén andando el camino.

Comunidad Agile de Paradigma
...
En este sentido, las compañías, desde hace años, adoptan nuevas formas de organización, pasan de organizarse de forma jerárquica y con silos departamentales a organizarse en torno a equipos multidisciplinares y cambiar su estructura jerárquica por áreas o círculos de especialidad con responsabilidades compartidas.

En este escenario, surge casi de forma natural, la necesidad de crear las comunidades de prácticas para que, personas que comparten un mismo expertise, sigan manteniendo contacto, compartiendo conocimiento y mejorando continuamente. Podemos hablar aquí de organizaciones ágiles.
...
- Contribuir e influir en la estrategia de la compañía.
- Generar nuevas líneas de negocio.
- Solucionar problemas.
- Promover buenas prácticas dentro de la compañía.
- Desarrollar los skills de los profesionales que la integran.
- Ayudar a atraer y a fidelizar el talento.
...
- Definir unos objetivos que aportasen valor a la comunidad y a la compañía: Aprender algo nuevo que poder poner en práctica en los equipos. Peticiones de ayuda: exponer dudas o problemas que puedan surgir en los equipos o con los clientes de forma que otros que hayan pasado por ello puedan ayudar o buscar una solución en común. Conocer a los nuevos integrantes, más allá de lo meramente profesional, para generar un entorno de mayor confianza
- Rotar la facilitación de las reuniones. Es importante que los miembros se sientan parte del propósito, evitando sensación de jerarquía o de dirección.
- La disposición de la sala. Pasar de sentarnos en modo aula a sentarnos en círculo hace que la gente se sienta parte de la reunión.
- Dotar de unas estructuras que den soporte a todo el conocimiento generado: un gestor documental, un espacio de documentación compartido, un gestor de tareas…
- Establecer una estructura para la sesiones de la comunidad con timeboxes para que estas sean más productivas.
- Contar con los miembros de la comunidad para que participen en iniciativas de la compañía como formaciones, acompañamientos, mentoring, dinámicas… para fomentar aún más el sentimiento de pertenencia.
...
Para conseguir todo esto, alguien tiene que dedicar tiempo suficiente a la comunidad: para asegurar la esponsorización por parte de la compañía, compartir las iniciativas que surgen y visibilizar el trabajo realizado con otras áreas, mantener la implicación y motivación de sus integrantes...

Para ello, es necesario contar con líderes de la comunidad. En el caso de Paradigma, esta labor recae en los responsables del Círculo Agile.

Pero es importante no aferrarse a la comunidad como algo en propiedad sobre lo que solo los líderes tienen capacidad de decisión y dejar lugar a la autoorganización, ya que solo a través de la participación activa de sus miembros se consigue que esta siga evolucionando y creciendo.
...
- Contribuir e influir en la estrategia de la compañía. Por ejemplo, se realizó una dinámica tipo Lean Coffee para reflexionar sobre el papel del líder ágil en los equipos de la que salió nuestro *Manifiesto del Agilista Paradigmático y, tras el cual, se han llevado a cabo ciertas iniciativas que están permitiendo mejorar el funcionamiento de los equipos. De la Comunidad Agile también surgió nuestra herramienta de ADN, que proporciona un valor añadido a equipos y clientes.
- Generar o impactar en nuevas líneas de negocio. De la Comunidad Agile, surge una subcomunidad enfocada en los proyectos de transformación digital y que impacta en la línea de negocio llamada Digital DNA, de forma que sus integrantes aportan valor trabajando en un framework de transformación y un conjunto de herramientas para trabajar con los clientes como dashboards de KPI’s, assessments, formaciones, planes de comunicación o dinámicas.
- Solucionar problemas a diario, entre compañeros, entre círculos…,
- Promover buenas prácticas dentro de la compañía. A través de formaciones, talleres de kanbanización, seminarios, meetups, mentoring, acompañamiento a equipos, contando experiencias y casos de éxito.
- Desarrollar los skills de los profesionales que la integran. Con la creación de una matriz de habilidades que contempla a todos los miembros de la comunidad, alrededor de 70, y que permite descubrir gaps de conocimiento y poner foco en aquellos skills más demandados a la hora de planificar formaciones, charlas o promover certificaciones.
