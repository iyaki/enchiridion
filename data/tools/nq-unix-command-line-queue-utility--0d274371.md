---
title: "nq - Unix command line queue utility"
notion_id: 0d274371-97e7-461b-a07d-5b056c87154b
notion_url: https://app.notion.com/p/nq-Unix-command-line-queue-utility-0d27437197e7461ba07d5b056c87154b
last_edited: 2023-03-02T17:12:00.000Z
source_url: https://github.com/leahneukirchen/nq
tags: ["English", "Linux", "Tool"]
---
## nq: queue utilities
...
`at` runs jobs at a given time. `batch` runs jobs "when system load levels permit". `nq` and [`task-spooler`](https://vicerveza.homeunix.net/~viric/soft/ts/) run jobs in sequence with no regard to the system's load average.
...
To the extent possible under law, Leah Neukirchen [leah@vuxu.org](mailto:leah@vuxu.org) has waived all copyright and related or neighboring rights to this work.
