...
notion_id: ca5cae15-21b4-4b8b-afa2-f0dec188e0b9
...
tags: ["rauno", "English", "UI/UX", "Article"]
---
...
Notice how pinching on a touch screen works in reverse. You start with your fingers together, and then move them apart to zoom in. But to grab something, you bring fingers together from afar.

This is because the interface needs to first establish an anchor point from where the zooming originates, and it's a lot easier and more precise to pick the anchor point with the fingers pinched together:

<!-- image hosted by Notion: its URL expires and is not preserved (ADR-05) -->

Technically, the anchor point also needs to be calculated when the fingers start from apart. But usually this implies zooming out, and that the exact precision of the origin is not as important. In essence: on touch screens, higher precision means fingers starting closer together.
...
No artificial intelligence was used to generate content for this article.
