---
title: "Notes for new hires"
notion_id: 10095780-5c94-46ca-a206-1a5c7c7b0d87
...
tags: ["Clinton Blackburn", "English", "Producer (Individual Contributor)", "Career Growth", "Jobs", "Article"]
---
...
In addition to helping improve decision making, understanding why some things are as they are will help you avoid falling into the trap of trying to refactor or “improve” something that should simply be left alone. [This post on Chesterton’s Fence](https://thoughtbot.com/blog/chestertons-fence) explains these ideas further.

### Maintain a friction log

I learned about [friction logs during my time at Stripe](https://dev.to/stripe/how-we-use-friction-logs-to-improve-products-at-stripe-i6p), but didn’t truly appreciate them until I joined Vori. The idea is simple: take note of all the things—not just product-related—that are causing you trouble. You focus on internal process, in addition to product run-throughs, because we are still working on these internal processes and scaling them as the team scales. This is all quite subjective and could include anything from a README missing a step to some process simply taking too long. We’ve all been here a while, and have either gotten used to the friction or have not taken time to prioritize reducing it.
...
This [blog post on a “WTF Notebook”](https://www.simplermachines.com/why-you-need-a-wtf-notebook/) offers a similar v iewpoint and deeper example of using what is essentially a friction log.

### Keep a brag doc

Brag docs helped me keep track of my accomplishments over the year to prepare for mid-year and full-year reviews at Stripe. Julia Evans, a former Stripe, has [an amazing post on brag docs](https://jvns.ca/blog/brag-documents/) that you should read right now.
...
⭐ _These are items have made the greatest impact on me. I consistently reference them. Prioritize reading them if nothing else._

⭐️ [What Got You Here Won’t Get You There: How Successful People Become Even More Successful](https://www.amazon.com/What-Got-Here-Wont-There/dp/1401301304?tag=blackbfounda-20)
...
⭐️ [Accelerate: Building and Scaling High Performing Technology Organizations](https://www.amazon.com/Accelerate-Building-Performing-Technology-Organizations/dp/B07BMBYHXL)
...
The [Wikipedia page](https://en.wikipedia.org/wiki/Accelerate_(book)) offers a good summary of the key capabilities and metrics.
...
[The 5 Love Languages](https://5lovelanguages.com/learn)
...
This was a magazine printed by Stripe. Publication has ended but the digital site remains. I suggest you at least skim through each issue to see what sticks out to you. You can (almost) never have too much [testing](https://increment.com/testing/)!
