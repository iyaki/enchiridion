---
title: "offpunk - An offline first command-line browser for the smolnet"
notion_id: 16854f1c-7d23-8137-91cc-ce44872015be
notion_url: https://app.notion.com/p/offpunk-An-offline-first-command-line-browser-for-the-smolnet-16854f1c7d23813791ccce44872015be
last_edited: 2025-02-10T18:20:00.000Z
source_url: https://sr.ht/~lioploum/offpunk/
tags: ["Tool", "English", "Office", "?"]
---
## OFFPUNK
...
Official page : [https://offpunk.net](https://offpunk.net/) Development (repository/mailing lists) : [https://sr.ht/~lioploum/offpunk/](https://sr.ht/~lioploum/offpunk/)

![image](https://git.sr.ht/~lioploum/offpunk/blob/HEAD/screenshots/1.png)

Screenshot HTML page with picture

![image](https://git.sr.ht/~lioploum/offpunk/blob/HEAD/screenshots/2.png)

Screenshot Gemini page
...
You use the `go` command to visit a URL, e.g. `go gemini.circumlunar.space`. ([gemini://](gemini://) is assumed if no protocol is specified. Supported protocols are gemini, gopher, finger, http, https, mailto, spartan and file. Default protocol is configurable).
...
Important news and releases will be announced on the offpunk-devel mailing list => [https://lists.sr.ht/~lioploum/offpunk-devel](https://lists.sr.ht/~lioploum/offpunk-devel)

Questions can be asked on the users mailing list: => [https://lists.sr.ht/~lioploum/offpunk-users](https://lists.sr.ht/~lioploum/offpunk-users)
...
- PIP: [requirements file to install dependencies with pip](https://git.sr.ht/~lioploum/offpunk/tree/HEAD/requirements.txt)
- Ubuntu/Debian: [command to install dependencies on Ubuntu/Debian without pip](https://git.sr.ht/~lioploum/offpunk/tree/HEAD/ubuntu_dependencies.txt)
