...
notion_id: 8c27ae85-0ddb-4cbc-b0fb-f8f969799efe
notion_url: https://app.notion.com/p/Rules-of-thumb-for-a-1x-developer-8c27ae850ddb4cbcb0fbf8f969799efe
last_edited: 2026-09-21T17:20:00.000Z
source_url: https://muldoon.cloud/programming/2020/04/17/programming-rules-thumb.html
tags: ["English", "Programming", "Productivity", "Producer (Individual Contributor)", "Guide", "Website"]
---
[https://muldoon.cloud/programming/2020/04/17/programming-rules-thumb.html](https://muldoon.cloud/programming/2020/04/17/programming-rules-thumb.html)

## Contents

- Contents
- Preamble I have little to say that’s of general value and haven’t found the time to level up My theory of bootstrapping
- The Rules Meta Rule 1: Rules are good Productivity and learning Rule 2: Most of what I learn is useless outside of its immediate context Rule 3: Focus “learning time” on things that compound Programming languages Rule 4: When to use Java or C# Rule 5: When to use Python or Ruby Rule 6: When to use a hardcore language Rule 7: How to do Javascript Rule 8: When to use C or C++ Rule 9: Use PHP or Hack if you want to test server changes without rebuilding Technologies Rule 10: When to make a serverless function Rule 11: Which database technology to choose Testing Rule 12: When to write a unit test Rule 13: When to write an integration test Rule 14: When to write an end-to-end test DevOps Rule 15: When to bring on a dedicated support engineer Security Rule 16: If you delegate all your IT security to the InfoSec, they will come up with draconian rules Designing and Whiteboarding Rule 17: Make the design session about input, not approval Project management Rule 18: Estimates serve more for creating pressure than for project planning Rule 19: Be explicit about the difference between hard deadlines, soft deadlines, internal deadlines, and expected completion dates Rule 20: When somebody says Agile, push for Kanban, not Scrum

## Preamble

I’m not a 10x developer. I haven’t been building websites since the days of dialup. I picked up programming a few years out of college because I was at a dead end in my career in government and politics.
...
2. Try to push as much logic as possible to the server. If the front end weren’t super complex, I would consider something like Phoenix instead which actually pushes everything to the server.
...
Choose SQL when you need to do ad hoc queries and/or you need support for ACID and transactions. Otherwise choose no-SQL. Though noSQL is getting better with transactions and PostgreSQL (I’m familiar with the AWS Aurora flavor) is getting better with availability, scalability, and durability, which have traditionally been the strengths of noSQL.
