...
notion_id: 3b254f1c-7d23-81bf-b58f-d82cd700e48d
notion_url: https://app.notion.com/p/portless-Named-localhost-URLs-for-Development-3b254f1c7d2381bfb58fd82cd700e48d
last_edited: 2026-08-04T02:13:00.000Z
source_url: https://portless.sh/
tags: ["Web Development", "DevOps", "Frontend", "Backend", "Docker", "Continuous Integration/Continuous Delivery", "Node.js", "Tool", "unknown", "English"]
---
## Getting Started
...
```plain text
- "dev": "next dev"                  # http://localhost:3000+ "dev": "portless myapp next dev"   # https://myapp.localhost
```
...
```plain text
Browser (myapp.localhost) -> proxy (port443) -> App (random port)
```
