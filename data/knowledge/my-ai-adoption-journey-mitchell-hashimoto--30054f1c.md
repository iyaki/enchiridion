...
notion_id: 30054f1c-7d23-81a9-ac60-c60518b2fbca
notion_url: https://app.notion.com/p/My-AI-Adoption-Journey-Mitchell-Hashimoto-30054f1c7d2381a9ac60c60518b2fbca
last_edited: 2026-09-18T00:53:00.000Z
source_url: https://mitchellh.com/writing/my-ai-adoption-journey
tags: ["Article", "Mitchell Hashimoto", "English", "Artificial Intelligence (AI)", "Productivity", "Career Growth", "Learning", "Systems Design / Software Architecture"]
---
**Table of Contents**
...
To find value, you _must_ use an **agent**. An agent is the industry-adopted term for an LLM that can chat and invoke external behavior in a loop[1](https://mitchellh.com/writing/my-ai-adoption-journey?utm_source=tldrnewsletter%2F#user-content-fn-1) At a bare minimum, the agent must have the ability to: read files, execute programs, and make HTTP requests.
...
Through this journey, I've personally reached a point where I'm having success with modern AI tooling and I believe I'm approaching it with the proper measured view that is grounded in reality. I really don't care one way or the other if AI is here to stay[3](https://mitchellh.com/writing/my-ai-adoption-journey?utm_source=tldrnewsletter%2F#user-content-fn-4), I'm a software craftsman that just wants to build stuff for the love of the game.
