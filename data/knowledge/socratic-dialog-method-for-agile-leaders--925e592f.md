---
title: "Socratic Dialog Method for Agile Leaders"
notion_id: 925e592f-655f-4e4d-998c-24ade45d00d0
notion_url: https://app.notion.com/p/Socratic-Dialog-Method-for-Agile-Leaders-925e592f655f4e4d998c24ade45d00d0
last_edited: 2023-03-30T13:53:00.000Z
source_url: https://management30.com/blog/socratic-dialog-method/
tags: ["Communication", "Leadersheep", "Article", "Management 3.0 Blog", "English"]
---
_By _[_Tanya Akin_](https://management30.com/facilitators/about/?trainer=5054)_, Management 3.0 Facilitator and Agile Coach, and Change Practitioner. She specializes in team building, new work and communication, and has been using the Socratic Method with her Agile and non-Agile teams for many years. She loves the method’s solution focus and, having studied philosophy herself, enjoys sharing her love for critical thinking and improving transparency and communication._

- [What is the Socratic Method?](https://management30.com/blog/socratic-dialog-method/#definition)
- [How to conduct a Socratic Dialog?](https://management30.com/blog/socratic-dialog-method/#how)
- [What are topics to be discussed via the Socratic Dialog?](https://management30.com/blog/socratic-dialog-method/#topics)
- [When to use the Socratic Method?](https://management30.com/blog/socratic-dialog-method/#reasons)
- [How can you use the Socratic Dialog as a leader?](https://management30.com/blog/socratic-dialog-method/#leadership)

> The unexamined life is not worth living.

[Making decisions and reaching consensus](https://management30.com/blog/team-decision-making/) is hard and it’s getting harder day by day – or so we may think. We’re confronted with an ever-changing world at a breathtaking pace. The working world is also changing, often emerging from a traditional Management 1.0 command-and-control style and transforming into a more [people-centric form of organization and leadership](https://management30.com/blog/human-centered-leadership/), leading to an entirely new understanding of the roles of employees and managers and the way they communicate and do their job. Instead of managers deciding which goals to pursue and how work is to be done, people have come to realize that really good decisions are made by the experts who are actually doing the work. This brings in a lot of new perspectives and the need to be able to skillfully maneuver in a world filled with a high diversity of thought.
...
- Postpone reflection.
- Postpone empathy.
- [Listen carefully](https://management30.com/blog/power-of-listening/).
...
- develop visions and missions and discuss team and [company values](https://management30.com/align-constraints/values-culture/),
- identify underlying issues,
- develop new ideas and [innovations](https://management30.com/blog/innovation-guidelines/).
...
**With the Socratic Method, leaders actually find answers together with their employees instead of asking for an answer or telling them what to do. **This [empowers](https://management30.com/empower-teams/) and [motivates](https://management30.com/energize-people/motivation-engagement/) your employees, gives them a greater sense of [psychological safety](https://management30.com/blog/psychological-safety/) and **will make you a pretty darn good manager**.

Management 3.0 offers several other wonderful tools and practices that can be used in combination with the Socratic Method to help you create a system of motivated and self-organized workers, such as [Moving Motivators](https://management30.com/practice/moving-motivators/), [Delegation Boards](https://management30.com/practice/delegation-poker/), and [Team Decision Cards](https://management30.com/practice/team-decision-matrix/), to name just a few.

Header Photo by Zach Plank ([Unsplash](https://unsplash.com/photos/2hq6jMnUK0g))
