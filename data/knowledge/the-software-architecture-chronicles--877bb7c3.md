...
notion_id: 877bb7c3-59f9-47e4-868f-cb617647cd0d
...
For us, as developers, it helps us build on our predecessor developers knowledge. It helps us learn from their mistakes, from their paths, from their experiences: their knowledge. It helps us achieve higher grounds by “_standing on the shoulders of giants_“!

In my path to be a better developer, I’ve read a lot of articles, watched a lot of conference talks, and read plenty of books. I do my best to _stand on the shoulders of giants_!
...
## **Posts in **_**The Software Architecture Chronicles**_
...
8. [1979 – Model-View-Controller](https://herbertograca.com/2017/08/17/mvc-and-its-variants/#model-view-controller)
9. [1987/2000 – PAC / Hierarchical Model-View-Controller](https://herbertograca.com/2017/08/17/mvc-and-its-variants/#hierarchical-model-view-controller)
10. [1996 – Model-View-Presenter](https://herbertograca.com/2017/08/17/mvc-and-its-variants/#model-view-presenter)
11. [1998 –”Model 1″ & “Model 2”](https://herbertograca.com/2018/08/29/model-1-model-2)
12. [2005 – Model-View-ViewModel](https://herbertograca.com/2017/08/17/mvc-and-its-variants/#model-view-view_model)
13. [???? – Model-View-Presenter-ViewModel](https://herbertograca.com/2017/08/17/mvc-and-its-variants/#model-view-presenter-view_model)
14. [2008 – Resource-Method-Representation](https://herbertograca.com/2018/08/31/resource-method-representation)
15. [2014 – Action-Domain-Responder](https://herbertograca.com/2018/09/03/action-domain-responder)
16. [EBI Architecture](https://herbertograca.com/2017/08/24/ebi-architecture/)
17. [Packaging & namespacing](https://herbertograca.com/2017/08/31/packaging-code/)
18. [Domain-Driven Design](https://herbertograca.com/2017/09/07/domain-driven-design/)
19. [Ports & Adapters Architecture (aka Hexagonal Architecture)](https://herbertograca.com/2017/09/14/ports-adapters-architecture/)
20. [Onion Architecture](https://herbertograca.com/2017/09/21/onion-architecture/)
21. [Clean Architecture](https://herbertograca.com/2017/09/28/clean-architecture-standing-on-the-shoulders-of-giants/)
22. [Event-Driven Architecture](https://herbertograca.com/2017/10/05/event-driven-architecture/)
23. [From CQS to CQRS](https://herbertograca.com/2017/10/19/from-cqs-to-cqrs/)
24. [Service Oriented Architecture (SOA)](https://herbertograca.com/2017/11/09/service-oriented-architecture-soa/)
25. [Explicit Architecture #01: DDD, Hexagonal, Onion, Clean, CQRS, … How I put it all together](https://herbertograca.com/2017/11/16/explicit-architecture-01-ddd-hexagonal-onion-clean-cqrs-how-i-put-it-all-together/)
26. [Explicit Architecture #02: More than concentric layers](https://herbertograca.com/2018/07/07/more-than-concentric-layers/)
27. [Explicit Architecture #03: Reflecting architecture and domain in code](https://herbertograca.com/2019/06/05/reflecting-architecture-and-domain-in-code/)
28. Explicit Architecture #04: Documenting the architecture
29. Evolving a project: from MVP to P
30. 4 + 1 Architecture view model
...
I will talk about most of these subjects in [this series of posts](https://herbertograca.com/category/development/series/software-architecture/).
...
- **Object Oriented Programming** (first thoughts were in the late [1960](http://userpage.fu-berlin.de/~ram/pub/pub_jf47ht81Ht/doc_kay_oop_en)s, though)
- **Layering: 2 tier**, the 1st tier with the UI, the 2nd tier with Business Logic and Data Storage
- ~1980 – C++
- **CORBA** – Common Object Request Broker Architecture (though the first stable version was only out in [1991](https://en.wikipedia.org/wiki/Common_Object_Request_Broker_Architecture#Versions_history), the first usages were during the [1980](https://en.wikipedia.org/wiki/TIBCO_Software)s)
- ~1986 – Erlang
- ~1987 – Perl
- [1987](https://www.lri.fr/~mbl/ENS/FONDIHM/2013/papers/Coutaz-Interact87.pdf) – PAC aka **Hierarchical Model-View-Controller**
- [1988](https://drive.google.com/file/d/0BwhCYaYDn8EgNzAzZjA5ZmItNjU3NS00MzQ5LTkwYjMtMDJhNDU5ZTM0MTlh/view) – **LSP (~**SO**L**ID**)**
-  
...
- ~1991 –** Message Bus**
- ~1991 – Python
- [1992](https://www.amazon.com/Object-Oriented-Software-Engineering-Driven-Approach/dp/0201403471) – **Entity-Boundary-Interactor** Architecture aka EBC aka EIC
- ~1993 – Ruby
...
- ~1997 –** Web Services**
- ~[1997](http://shop.oreilly.com/product/9780596006754.do) –** ESB** – Enterprise Service Bus (although the book that coined the term was published in 2004, the concept was already used before)
-  
...
- [2005](http://alistair.cockburn.us/Hexagonal+architecture) – **Ports & Adapters Architecture** aka Hexagonal Architecture
- [2006](https://youtu.be/JHGkaShoyNs?t=1m17s)? – **CQRS & ES** (Command Query Responsibility Segregation & Event Sourcing)
- [2008](http://jeffreypalermo.com/blog/the-onion-architecture-part-1/) – **Onion Architecture**
- [2009](https://medium.com/s-c-a-l-e/talking-microservices-with-the-man-who-made-netflix-s-cloud-famous-1032689afed3) –** Microservices** (at Netflix)
-  
...
[Chinese](https://www.jianshu.com/p/b477b2cc6cfa), by Qinyusuain
