...
Hand-drawn cover illustration for the opinion piece 'Why senior developers fail to communicate their expertise.'
...
But if you’re _not_ a senior developer and you think this is true, I think you’re probably right.
...
_Need to collect survey data?_ Google forms, baby.

_Need to build a whole new feature to test it?_ Have you tried putting a button in the existing UI and seeing if people click it?

_Need new analytics service?_ What’s the most important decision we need analytics for? Can we start with one decision, one chart, one metric?

_You want to bake me a whole birthday cake?_ Just put a candle on my sandwich.
