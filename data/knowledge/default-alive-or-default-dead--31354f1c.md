...
notion_id: 31354f1c-7d23-813e-ba0b-f1a944547ca8
notion_url: https://app.notion.com/p/Default-Alive-or-Default-Dead-31354f1c7d23813eba0bf1a944547ca8
last_edited: 2026-02-26T01:55:00.000Z
source_url: https://www.paulgraham.com/aord.html
tags: ["English", "Entrepreneurship", "Career Growth", "Decision Making", "Article", "Paul Graham"]
---
...
If you're paying attention, you'll be asking at this point not just how to avoid the fatal pinch, but how to avoid being default dead. That one is easy: don't hire too fast. Hiring too fast is by far the biggest killer of startups that raise money. [[2](https://www.paulgraham.com/aord.html#f2n)]
...
What the company should have done is address the fundamental problem: that the product is only moderately appealing. Hiring people is rarely the way to fix that. More often than not it makes it harder. At this early stage, the product needs to evolve more than to be "built out," and that's usually easier with fewer people. [[4](https://www.paulgraham.com/aord.html#f4n)]

Asking whether you're default alive or default dead may save you from this. Maybe the alarm bells it sets off will counteract the forces that push you to overhire. Instead you'll be compelled to seek growth in other ways. For example, by [doing things that don't scale](https://www.paulgraham.com/ds.html), or by redesigning the product in the way only founders can. And for many if not most startups, these paths to growth will be the ones that actually work.
