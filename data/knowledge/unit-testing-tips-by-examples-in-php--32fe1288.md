...
Firstly I would like to validate this idea. So I hope that you will be able to help me with this. If you are interested in this ebook, have a look at:

<!-- image hosted by Notion: its URL expires and is not preserved (ADR-05) -->

[Details](https://sarvendev.com/ebook-practical-guide-to-testing-best-practices/)
...
> To verify incoming interactions, use a stub, but to verify outcoming interactions, use a mock. More: [Mock vs Stub](https://github.com/sarven/unit-testing-tips#mock-vs-stub)
...
[!ATTENTION] **Do not write code 1:1, 1 class : 1 test. It leads to fragile tests which make that refactoring is tough.**
...
- [Object mother](https://github.com/sarven/unit-testing-tips#object-mother)
- [Builder](https://github.com/sarven/unit-testing-tips#builder)
...
[!NOTE] Don't duplicate the production logic in tests. Just verify results by hardcoded values.
...
[!NOTE] The necessity to mock a concrete class to replace a part of its behavior means that this class is probably too complicated and violates the Single Responsibility Principle.
