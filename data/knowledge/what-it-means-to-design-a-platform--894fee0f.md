...
notion_id: 894fee0f-c024-47be-8089-bdd0a49496b3
...
tags: ["Article", "English", "System Design / Software Architecture", "Product Management", "UI/UX"]
---
<!-- image hosted by Notion: its URL expires and is not preserved (ADR-05) -->

**Editor’s note:** This essay was adapted from a post I wrote on an employees-only blog at Stripe.
...
Let’s put all these pieces together.[3](https://matthewstrom.com/writing/platform-design/#fn3)
...
The level of precision of a Lego brick is mesmerizing. Manufacturing tolerances (exact to 2 microns, less than the width of a human hair) are so rigorously maintained that every lego brick ever manufactured attaches to every other brick. Pieces fit together and lock tightly, but can be pulled apart easily by a child. Instructions for lego sets also keep children in mind, only using pictures to communicate.[4](https://matthewstrom.com/writing/platform-design/#fn4)

But the simplicity of the design is misleading: if you have 6 standard lego bricks, you can put them together in 915,103,765 different ways.[5](https://matthewstrom.com/writing/platform-design/#fn5)
...
1. “How Funk Band Vulfpeck Took on Spotify.” CNBC, 2 Apr. 2018, www.cnbc.com/video/2018/04/02/how-funk-band-vulfpeck-took-on-spotify.html. [↩︎](https://matthewstrom.com/writing/platform-design/#fnref1)
2. “Second-Order Problem.” Farnam Street, April 7, 2019. https://fs.blog/second-order/. [↩︎](https://matthewstrom.com/writing/platform-design/#fnref2)
3. Pun fully intended. [↩︎](https://matthewstrom.com/writing/platform-design/#fnref3)
4. [The instructions for the largest lego set](https://www.lego.com/cdn/product-assets/product.bi.core.pdf/6218872.pdf) (The Millennium Falcon) run over 450 pages, all without a single word. [↩︎](https://matthewstrom.com/writing/platform-design/#fnref4)
5. Eilers, Søren. “A Lego Counting Problem.” University of Copenhagen, April 7, 2005. https://web.math.ku.dk/~eilers/lego.html. [↩︎](https://matthewstrom.com/writing/platform-design/#fnref5)
6. Lendon, Brad. “Lego Won’t Make Modern War Machines, but Others Are Picking up the Pieces.” CNN, December 13, 2020. https://www.cnn.com/style/article/lego-military-sets-intl-hnk-dst/index.html. [↩︎](https://matthewstrom.com/writing/platform-design/#fnref6)
7. White, Jeremy. “How Lego Perfected the Recycled Plastic Brick.” Wired, July 11, 2021. https://www.wired.com/story/lego-recycled-plastic-brick/. [↩︎](https://matthewstrom.com/writing/platform-design/#fnref7)
