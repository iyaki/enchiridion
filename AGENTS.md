...
- Current state: `v0.4.1` — `sync` (full/incremental, mirror split into
  ...
  matches over title, tags, filename and body, printing each hit's
  citation URL per ADR-16; exit 1 when nothing matches).
