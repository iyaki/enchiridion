...
tags: ["English", "Databases", "Article"]
---
...
- [Level 0: Sky Zone](https://www.avestura.dev/blog/explaining-the-postgres-meme#level-0-sky-zone): `CREATE TABLE`, `JOIN`, `NULL`, ...
- [Level 1: Surface Zone](https://www.avestura.dev/blog/explaining-the-postgres-meme#level-1-surface-zone): ACID, outer joins, normal forms, ...
- [Level 2: Sunlight Zone](https://www.avestura.dev/blog/explaining-the-postgres-meme#level-2-sunlight-zone): Connection pools, LATERAL Join, Stored Procedures, ...
- [Level 3: Twilight Zone](https://www.avestura.dev/blog/explaining-the-postgres-meme#level-3-twilight-zone): Isolation levels, ZigZag Join, Triggers, ...
- [Level 4: Midnight Zone](https://www.avestura.dev/blog/explaining-the-postgres-meme#level-4-midnight-zone): Denormalization, `SELECT FOR UPDATE`, star schemas, ...
- [Level 5: Abyssal Zone](https://www.avestura.dev/blog/explaining-the-postgres-meme#level-5-abyssal-zone): `MATCH PARTIAL` foreign keys, `null::jsonb IS NULL = false`, ...
- [Level 6: Hadal Zone](https://www.avestura.dev/blog/explaining-the-postgres-meme#level-6-hadal-zone): volcano model, join ordering is NP Hard, ...
- [Level 7: Pitch Black Zone](https://www.avestura.dev/blog/explaining-the-postgres-meme#level-7-pitch-black-zone): `NULL`, the halloween problem, fsyncgate, ...
...
In many cases, using offset will slow down the performance of your query as the database must count all rows from the beginning until it reaches the requested page. For more information, read the [Keyset pagination](https://www.avestura.dev/blog/explaining-the-postgres-meme#keyset-pagination) section.
...
### `NULL`s in `CHECK` constraints are truthy
...
### `NULL`s are equal in `DISTINCT` but unequal in `UNIQUE`
