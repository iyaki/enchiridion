...
_The business wants to make money and keep making more of it while cutting costs. _We know this. I think of business goals as the tonic pedal, a single note playing underneath the rest of the music. Or perhaps it’s a cloud always hanging over us.

## Our process often starts with a feature, a piece of the product. We might say it’s a “[hypothesis](https://deltacxdebbie.medium.com/hypothesis-based-approaches-e4802b8d26a0)” or “solution.”

- **Sometimes it’s a solution to a problem that’s not well understood.** We’re sure we _really know our customers, _so we didn’t bother researching people, tasks, or their decisions.
- **Sometimes the problem doesn’t exist. **We reverse engineer use cases hoping someone might have some reason to use this thing we came up with.
- **Sometimes it’s a stakeholder-centric solution**; this is what a leader or stakeholder wants us to do for their own good or bad reasons.
- **Sometimes we call customers and ask what features they need. **We forget that most people think in terms of their tasks and making them efficient and accurate. Our target audiences might be open to any feature that achieves that. They might not be able to envision or invent the feature that would serve them best. But we’re focused on the product, so we ask them about the product, our ideas, and _what do you think of this mockup_?

# Over time, we’ve moved further and further away from focusing on _product_ as how we deliver value to our customers.

We fell so in love with **product **that we forgot that product doesn’t exist to push customers around a chessboard and make execs happy. Our products and services are all we have, and their main job is to win, satisfy, and retain customers. If we are not doing those well, we are [failing](https://rbefored.com/high-product-failure-rates-celebrate-or-improve-196127b386a7).

We claim that we want to **deliver value and satisfy customers**, but how do we follow through on that? How is that baked into our processes? Are we driven more by deadlines or by quality? Are we counting _how many _features or fixes we release, and not considering how users perceive their quality or value?

Do we say, “Outcomes over outputs,” and then celebrate one or both being low quality or failures? Is anyone truly held accountable for poor outcomes, failures, and bad decisions? If we [celebrate or glorify failures](https://rbefored.com/high-product-failure-rates-celebrate-or-improve-196127b386a7), does that mean we see outcomes as good even when we have failed?
...
“Product” should be a strategic and tactical process through which we create something valuable, desirable, accessible, and _hey, it’s what I need and it just works_. If you’re lucky, it’ll be innovative. But considering how badly companies do “the basics,” I’ll settle for _not innovative at all_ _but it’s great for how I need to accomplish my task._

[Don’t start with product, features, ideas, or hypotheses](https://rbefored.com/hypothesis-based-approaches-e4802b8d26a0b). Start with a good understanding of target audiences’ tasks, experiences, and pain points. Be solution-agnostic early in your process. Avoid the feature factory and order taking.
...
Product first is too often _empathy theater_, pretending that we really care about our users while treating them as pawns.
...
Product first doesn’t mean you have product-market fit for your _next big idea. _Your concept, hypothesis, or solution-looking-for-a-problem might be a poor fit for your experience ecosystem or the market.
...
We’re solution-agnostic at this phase. We’re not exploring or testing features or ideas. We’re not checking if people imagine that they might be interested in a thing we _could _build that they can’t see or experience now.
...
Instead of _which feature should we do first, _we prioritize problem statements. Which problems should we handle first? Why?
...
- Does it solve the original problem statement?
- Does it solve it well?
- Did it create any new problems?
- Is this the right execution of the right idea? Or do we need to go with a different execution… or a completely different idea or solution?
...
Demolish and abandon the feature factory. Crumbling factory image from DepositPhotos.

![image](https://miro.medium.com/v2/resize:fit:700/1*UaxooMbFF-f2P9BD14nOtw.jpeg)
...
We measure outcomes beyond _did the business get the conversion rate it was hoping for._ We measure experiences.

- Does the task take less time while also being less error-prone?
- Are users seeing increased efficiency or accuracy?
- Does this system work well for their tasks, habits, perspectives, decision-making, and styles?
- Are our target audiences complaining? Returning products or ending contracts?
...
![image](https://miro.medium.com/v2/da:true/resize:fit:0/5c50caa54067fd622d2f0fac18392213bf92f6e2fae89b691e62bceb40885e74)
