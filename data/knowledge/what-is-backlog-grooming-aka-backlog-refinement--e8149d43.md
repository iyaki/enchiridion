---
title: "What is backlog grooming (aka backlog refinement)?"
notion_id: e8149d43-0225-428d-be6f-da131a3e3129
notion_url: https://app.notion.com/p/What-is-backlog-grooming-aka-backlog-refinement-e8149d430225428dbe6fda131a3e3129
last_edited: 2022-12-19T15:19:00.000Z
source_url: https://blog.logrocket.com/product-management/what-is-backlog-grooming-aka-refinement/
tags: ["Article", "LogRocket Blog", "English", "Agile", "Project Management", "Product Management"]
---
...
As per the [scrum framework](https://blog.logrocket.com/product-management/what-are-five-types-of-scrum-meetings/), the team goes through following events:

- Sprint — A time-boxed event where the team works on the sprint backlog
- [Sprint planning](https://blog.logrocket.com/product-management/what-is-sprint-planning-guide-meeting-agenda-cheat-sheet/) — The team evaluates the groomed user stories in terms of story points. This event defines the goal of the sprint and work that needs to be completed in the next sprint
- [Sprint review](https://blog.logrocket.com/product-management/what-is-a-sprint-review-meeting-agenda-example/) — The team reviews the work done during the sprint with the product owner and key stakeholders
- [Sprint retrospective](https://blog.logrocket.com/product-management/what-is-a-sprint-retrospective-templates-and-best-practices/) — Once a sprint is completed, the team to comes together to discuss what can be improved in future sprints and congratulate each other for work well done

Before a sprint can begin_,_ the team needs a product backlog. Backlog grooming is the process that ensures the product backlog is ready for the team to work on.

## Backlog grooming vs. sprint planning

It’s important to understand the difference between sprint planning and [backlog grooming](https://blog.logrocket.com/product-management/what-is-backlog-grooming-aka-refinement/). Sprint planning is a scrum event conducted by the scrum master to set a sprint plan and goal for the upcoming sprint. Sprint planning happens before a sprint starts and after the backlog grooming session and is time-boxed (maximum of eight hours for a month-long sprint).
...
- The **sprint retrospective** would be held on the last day of the sprint — in this case, Friday evening — before the next sprint starts
- **Sprint planning** can happen on either Friday or Thursday before the sprint starts on Monday (or, worst case, Monday morning before the sprint starts, depending on everyone’s availability and when the grooming session happens)
- **Backlog grooming** is conducted by a product owner and is based on their availability
...
- Update backlog items with all the details necessary for the developers to execute on the plan
- Align the team on the product roadmap and strategy
...
### Define user stories to avoid confusion/uncertainty
...
### Add new user stories according to new insights
...
In 2010, product management luminaries Roman Pichler and Mike Cohn came up with the [DEEP framework for backlog grooming](https://www.romanpichler.com/blog/make-the-product-backlog-deep/). DEEP stipulates the following:

_To ensure that the product backlog is DEEP and stays that way, you have to groom or refine it regularly. Grooming the product backlog is an ongoing, collaborative process that involves the product owner and team._
