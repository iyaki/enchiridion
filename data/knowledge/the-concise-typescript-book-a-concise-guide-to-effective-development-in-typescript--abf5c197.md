...
- [The Concise TypeScript Book](https://github.com/gibbok/typescript-book?utm_source=tldrnewsletter#the-concise-typescript-book) 
- [Table of content](https://github.com/gibbok/typescript-book?utm_source=tldrnewsletter#table-of-content)
- [Introduction](https://github.com/gibbok/typescript-book?utm_source=tldrnewsletter#introduction)
- [About the author](https://github.com/gibbok/typescript-book?utm_source=tldrnewsletter#about-the-author)
- [TypeScript an introduction](https://github.com/gibbok/typescript-book?utm_source=tldrnewsletter#typescript-an-introduction) 
- [What is TypeScript?](https://github.com/gibbok/typescript-book?utm_source=tldrnewsletter#what-is-typescript)
- [Why TypeScript?](https://github.com/gibbok/typescript-book?utm_source=tldrnewsletter#why-typescript)
- [TypeScript and JavaScript](https://github.com/gibbok/typescript-book?utm_source=tldrnewsletter#typescript-and-javascript)
- [TypeScript code generation](https://github.com/gibbok/typescript-book?utm_source=tldrnewsletter#typescript-code-generation)
- [Modern JavaScript Now (Downleveling)](https://github.com/gibbok/typescript-book?utm_source=tldrnewsletter#modern-javascript-now-downleveling)
- [Getting Started With TypeScript](https://github.com/gibbok/typescript-book?utm_source=tldrnewsletter#getting-started-with-typescript) 
- [Installation](https://github.com/gibbok/typescript-book?utm_source=tldrnewsletter#installation)
- [Configuration](https://github.com/gibbok/typescript-book?utm_source=tldrnewsletter#configuration)
- [TypeScript configuration file tsconfig.json](https://github.com/gibbok/typescript-book?utm_source=tldrnewsletter#typescript-configuration-file-tsconfigjson) 
- [target](https://github.com/gibbok/typescript-book?utm_source=tldrnewsletter#target)
- [lib](https://github.com/gibbok/typescript-book?utm_source=tldrnewsletter#lib)
- [strict](https://github.com/gibbok/typescript-book?utm_source=tldrnewsletter#strict)
- [module](https://github.com/gibbok/typescript-book?utm_source=tldrnewsletter#module)
- [moduleResolution](https://github.com/gibbok/typescript-book?utm_source=tldrnewsletter#moduleresolution)
- [esModuleInterop](https://github.com/gibbok/typescript-book?utm_source=tldrnewsletter#esmoduleinterop)
- [jsx](https://github.com/gibbok/typescript-book?utm_source=tldrnewsletter#jsx)
- [skipLibCheck](https://github.com/gibbok/typescript-book?utm_source=tldrnewsletter#skiplibcheck)
- [files](https://github.com/gibbok/typescript-book?utm_source=tldrnewsletter#files)
- [include](https://github.com/gibbok/typescript-book?utm_source=tldrnewsletter#include)
- [exclude](https://github.com/gibbok/typescript-book?utm_source=tldrnewsletter#exclude)
- [Migration to TypeScript Advice](https://github.com/gibbok/typescript-book?utm_source=tldrnewsletter#migration-to-typescript-advice)
- [Exploring the Type System](https://github.com/gibbok/typescript-book?utm_source=tldrnewsletter#exploring-the-type-system) 
- [The TypeScript language service](https://github.com/gibbok/typescript-book?utm_source=tldrnewsletter#the-typescript-language-service)
- [Structural Typing](https://github.com/gibbok/typescript-book?utm_source=tldrnewsletter#structural-typing)
- [TypeScript Fundamental Comparison Rules](https://github.com/gibbok/typescript-book?utm_source=tldrnewsletter#typescript-fundamental-comparison-rules)
- [Types as sets](https://github.com/gibbok/typescript-book?utm_source=tldrnewsletter#types-as-sets)
- [Assign a type: Type Declarations and Type Assertions](https://github.com/gibbok/typescript-book?utm_source=tldrnewsletter#assign-a-type-type-declarations-and-type-assertions) 
- [Type Declaration](https://github.com/gibbok/typescript-book?utm_source=tldrnewsletter#type-declaration)
- [Type Assertion](https://github.com/gibbok/typescript-book?utm_source=tldrnewsletter#type-assertion)
- [Non-null assertion](https://github.com/gibbok/typescript-book?utm_source=tldrnewsletter#non-null-assertion)
- [Ambient Declarations](https://github.com/gibbok/typescript-book?utm_source=tldrnewsletter#ambient-declarations)
- [Property Checking and Excess Property Checking](https://github.com/gibbok/typescript-book?utm_source=tldrnewsletter#property-checking-and-excess-property-checking)
- [Weak Types](https://github.com/gibbok/typescript-book?utm_source=tldrnewsletter#weak-types)
- [Strict Object Literal Checking (Freshness)](https://github.com/gibbok/typescript-book?utm_source=tldrnewsletter#strict-object-literal-checking-freshness)
- [Type Inference](https://github.com/gibbok/typescript-book?utm_source=tldrnewsletter#type-inference)
- [More advanced inferences](https://github.com/gibbok/typescript-book?utm_source=tldrnewsletter#more-advanced-inferences)
- [Type Widening](https://github.com/gibbok/typescript-book?utm_source=tldrnewsletter#type-widening)
- [Const](https://github.com/gibbok/typescript-book?utm_source=tldrnewsletter#const) 
- [const modifier on type parameters](https://github.com/gibbok/typescript-book?utm_source=tldrnewsletter#const-modifier-on-type-parameters)
- [Explicit Type Annotation](https://github.com/gibbok/typescript-book?utm_source=tldrnewsletter#explicit-type-annotation)
- [Const assertion](https://github.com/gibbok/typescript-book?utm_source=tldrnewsletter#const-assertion)
- [Type Narrowing](https://github.com/gibbok/typescript-book?utm_source=tldrnewsletter#type-narrowing) 
- [Conditions](https://github.com/gibbok/typescript-book?utm_source=tldrnewsletter#conditions)
- [Throwing or returning](https://github.com/gibbok/typescript-book?utm_source=tldrnewsletter#throwing-or-returning)
- [Discriminated union](https://github.com/gibbok/typescript-book?utm_source=tldrnewsletter#discriminated-union)
- [User-defined type guards](https://github.com/gibbok/typescript-book?utm_source=tldrnewsletter#user-defined-type-guards)
- [Primitive Types](https://github.com/gibbok/typescript-book?utm_source=tldrnewsletter#primitive-types) 
- [string](https://github.com/gibbok/typescript-book?utm_source=tldrnewsletter#string)
- [boolean](https://github.com/gibbok/typescript-book?utm_source=tldrnewsletter#boolean)
- [number](https://github.com/gibbok/typescript-book?utm_source=tldrnewsletter#number)
- [bigInt](https://github.com/gibbok/typescript-book?utm_source=tldrnewsletter#bigint)
- [symbol](https://github.com/gibbok/typescript-book?utm_source=tldrnewsletter#symbol)
- [null and undefined](https://github.com/gibbok/typescript-book?utm_source=tldrnewsletter#null-and-undefined)
- [Array](https://github.com/gibbok/typescript-book?utm_source=tldrnewsletter#array)
- [any](https://github.com/gibbok/typescript-book?utm_source=tldrnewsletter#any)
- [Type Annotations](https://github.com/gibbok/typescript-book?utm_source=tldrnewsletter#type-annotations)
- [Object Types](https://github.com/gibbok/typescript-book?utm_source=tldrnewsletter#object-types)
- [Optional Properties](https://github.com/gibbok/typescript-book?utm_source=tldrnewsletter#optional-properties)
- [Readonly Properties](https://github.com/gibbok/typescript-book?utm_source=tldrnewsletter#readonly-properties)
- [Index Signatures](https://github.com/gibbok/typescript-book?utm_source=tldrnewsletter#index-signatures)
- [Extending Types](https://github.com/gibbok/typescript-book?utm_source=tldrnewsletter#extending-types)
- [Intersection Types](https://github.com/gibbok/typescript-book?utm_source=tldrnewsletter#intersection-types)
- [Literal Types](https://github.com/gibbok/typescript-book?utm_source=tldrnewsletter#literal-types)
- [Literal Inference](https://github.com/gibbok/typescript-book?utm_source=tldrnewsletter#literal-inference)
- [null and undefined](https://github.com/gibbok/typescript-book?utm_source=tldrnewsletter#null-and-undefined-1)
- [strictNullChecks](https://github.com/gibbok/typescript-book?utm_source=tldrnewsletter#strictnullchecks)
- [Non-null Assertion Operator (Postfix !)](https://github.com/gibbok/typescript-book?utm_source=tldrnewsletter#non-null-assertion-operator-postfix-)
- [Enums](https://github.com/gibbok/typescript-book?utm_source=tldrnewsletter#enums) 
- [Numeric enums](https://github.com/gibbok/typescript-book?utm_source=tldrnewsletter#numeric-enums)
- [String enums](https://github.com/gibbok/typescript-book?utm_source=tldrnewsletter#string-enums)
- [Constant enums](https://github.com/gibbok/typescript-book?utm_source=tldrnewsletter#constant-enums)
- [Reverse mapping](https://github.com/gibbok/typescript-book?utm_source=tldrnewsletter#reverse-mapping)
- [Ambient enums](https://github.com/gibbok/typescript-book?utm_source=tldrnewsletter#ambient-enums)
- [Computed and constant members](https://github.com/gibbok/typescript-book?utm_source=tldrnewsletter#computed-and-constant-members)
- [Narrowing](https://github.com/gibbok/typescript-book?utm_source=tldrnewsletter#narrowing) 
- [typeof type guards](https://github.com/gibbok/typescript-book?utm_source=tldrnewsletter#typeof-type-guards)
- [Truthiness narrowing](https://github.com/gibbok/typescript-book?utm_source=tldrnewsletter#truthiness-narrowing)
- [Equality narrowing](https://github.com/gibbok/typescript-book?utm_source=tldrnewsletter#equality-narrowing)
- [In operator narrowing](https://github.com/gibbok/typescript-book?utm_source=tldrnewsletter#in-operator-narrowing)
- [instanceof narrowing](https://github.com/gibbok/typescript-book?utm_source=tldrnewsletter#instanceof-narrowing)
- [Assignments](https://github.com/gibbok/typescript-book?utm_source=tldrnewsletter#assignments)
- [Control flow analysis](https://github.com/gibbok/typescript-book?utm_source=tldrnewsletter#control-flow-analysis)
- [type predicates](https://github.com/gibbok/typescript-book?utm_source=tldrnewsletter#type-predicates)
- [Discriminated unions](https://github.com/gibbok/typescript-book?utm_source=tldrnewsletter#discriminated-unions)
- [The never type](https://github.com/gibbok/typescript-book?utm_source=tldrnewsletter#the-never-type)
- [Exhaustiveness checking](https://github.com/gibbok/typescript-book?utm_source=tldrnewsletter#exhaustiveness-checking)
- [Object Types](https://github.com/gibbok/typescript-book?utm_source=tldrnewsletter#object-types-1)
- [Tuple Type](https://github.com/gibbok/typescript-book?utm_source=tldrnewsletter#tuple-type)
- [Fixed length tuple](https://github.com/gibbok/typescript-book?utm_source=tldrnewsletter#fixed-length-tuple)
- [Union Type](https://github.com/gibbok/typescript-book?utm_source=tldrnewsletter#union-type)
- [Intersection Types](https://github.com/gibbok/typescript-book?utm_source=tldrnewsletter#intersection-types-1)
- [Type Indexing](https://github.com/gibbok/typescript-book?utm_source=tldrnewsletter#type-indexing)
- [Type from Value](https://github.com/gibbok/typescript-book?utm_source=tldrnewsletter#type-from-value)
- [Type from Func Return](https://github.com/gibbok/typescript-book?utm_source=tldrnewsletter#type-from-func-return)
- [Type from Module](https://github.com/gibbok/typescript-book?utm_source=tldrnewsletter#type-from-module)
- [Mapped types](https://github.com/gibbok/typescript-book?utm_source=tldrnewsletter#mapped-types)
- [Conditional Types](https://github.com/gibbok/typescript-book?utm_source=tldrnewsletter#conditional-types)
- [Distributive conditional types](https://github.com/gibbok/typescript-book?utm_source=tldrnewsletter#distributive-conditional-types)
- [“infer” Type inference in conditional types](https://github.com/gibbok/typescript-book?utm_source=tldrnewsletter#infer-type-inference-in-conditional-types)
- [Predefined conditional types](https://github.com/gibbok/typescript-book?utm_source=tldrnewsletter#predefined-conditional-types)
- [Template Union Types](https://github.com/gibbok/typescript-book?utm_source=tldrnewsletter#template-union-types)
- [Any type](https://github.com/gibbok/typescript-book?utm_source=tldrnewsletter#any-type)
- [Unknown type](https://github.com/gibbok/typescript-book?utm_source=tldrnewsletter#unknown-type)
- [Void type](https://github.com/gibbok/typescript-book?utm_source=tldrnewsletter#void-type)
- [Never type](https://github.com/gibbok/typescript-book?utm_source=tldrnewsletter#never-type)
- [Interface and Type](https://github.com/gibbok/typescript-book?utm_source=tldrnewsletter#interface-and-type) 
- [Common Syntax](https://github.com/gibbok/typescript-book?utm_source=tldrnewsletter#common-syntax)
- [Basic types:](https://github.com/gibbok/typescript-book?utm_source=tldrnewsletter#basic-types)
- [Objects and interfaces:](https://github.com/gibbok/typescript-book?utm_source=tldrnewsletter#objects-and-interfaces)
- [Union and intersection types:](https://github.com/gibbok/typescript-book?utm_source=tldrnewsletter#union-and-intersection-types)
- [Built-in Type Primitives](https://github.com/gibbok/typescript-book?utm_source=tldrnewsletter#built-in-type-primitives)
- [Common Built-in JS Objects](https://github.com/gibbok/typescript-book?utm_source=tldrnewsletter#common-built-in-js-objects)
- [Overloads](https://github.com/gibbok/typescript-book?utm_source=tldrnewsletter#overloads)
- [Get & Set](https://github.com/gibbok/typescript-book?utm_source=tldrnewsletter#get--set)
- [Merging and Extension](https://github.com/gibbok/typescript-book?utm_source=tldrnewsletter#merging-and-extension)
- [Differences between Type and Interface](https://github.com/gibbok/typescript-book?utm_source=tldrnewsletter#differences-between-type-and-interface)
- [Class](https://github.com/gibbok/typescript-book?utm_source=tldrnewsletter#class) 
- [Common Syntax](https://github.com/gibbok/typescript-book?utm_source=tldrnewsletter#common-syntax-1)
- [Constructor](https://github.com/gibbok/typescript-book?utm_source=tldrnewsletter#constructor)
- [Private and Protected Constructors](https://github.com/gibbok/typescript-book?utm_source=tldrnewsletter#private-and-protected-constructors)
- [Access modifiers](https://github.com/gibbok/typescript-book?utm_source=tldrnewsletter#access-modifiers)
- [Auto-Accessors in Classes](https://github.com/gibbok/typescript-book?utm_source=tldrnewsletter#auto-accessors-in-classes)
- [this](https://github.com/gibbok/typescript-book?utm_source=tldrnewsletter#this)
- [Parameter Properties](https://github.com/gibbok/typescript-book?utm_source=tldrnewsletter#parameter-properties)
- [Abstract Classes](https://github.com/gibbok/typescript-book?utm_source=tldrnewsletter#abstract-classes)
- [With Generics](https://github.com/gibbok/typescript-book?utm_source=tldrnewsletter#with-generics)
- [Decorators](https://github.com/gibbok/typescript-book?utm_source=tldrnewsletter#decorators) 
- [Class decorators](https://github.com/gibbok/typescript-book?utm_source=tldrnewsletter#class-decorators)
- [Property Decorator](https://github.com/gibbok/typescript-book?utm_source=tldrnewsletter#property-decorator)
- [Method Decorator](https://github.com/gibbok/typescript-book?utm_source=tldrnewsletter#method-decorator)
- [Getter and Setter Decorators](https://github.com/gibbok/typescript-book?utm_source=tldrnewsletter#getter-and-setter-decorators)
- [Inheritance](https://github.com/gibbok/typescript-book?utm_source=tldrnewsletter#inheritance)
- [Statics](https://github.com/gibbok/typescript-book?utm_source=tldrnewsletter#statics)
- [Property initialization](https://github.com/gibbok/typescript-book?utm_source=tldrnewsletter#property-initialization)
- [Method overloading](https://github.com/gibbok/typescript-book?utm_source=tldrnewsletter#method-overloading)
- [Generics](https://github.com/gibbok/typescript-book?utm_source=tldrnewsletter#generics) 
- [Generic Type](https://github.com/gibbok/typescript-book?utm_source=tldrnewsletter#generic-type)
- [Generic Classes](https://github.com/gibbok/typescript-book?utm_source=tldrnewsletter#generic-classes)
- [Generic Constraints](https://github.com/gibbok/typescript-book?utm_source=tldrnewsletter#generic-constraints)
- [Generic contextual narrowing](https://github.com/gibbok/typescript-book?utm_source=tldrnewsletter#generic-contextual-narrowing)
- [Erased Structural Types](https://github.com/gibbok/typescript-book?utm_source=tldrnewsletter#erased-structural-types)
- [Namespacing](https://github.com/gibbok/typescript-book?utm_source=tldrnewsletter#namespacing)
- [Symbols](https://github.com/gibbok/typescript-book?utm_source=tldrnewsletter#symbols)
- [Triple-Slash Directives](https://github.com/gibbok/typescript-book?utm_source=tldrnewsletter#triple-slash-directives)
- [Type Manipulation](https://github.com/gibbok/typescript-book?utm_source=tldrnewsletter#type-manipulation) 
- [Creating Types from Types](https://github.com/gibbok/typescript-book?utm_source=tldrnewsletter#creating-types-from-types)
- [Indexed Access Types](https://github.com/gibbok/typescript-book?utm_source=tldrnewsletter#indexed-access-types)
- [Utility Types](https://github.com/gibbok/typescript-book?utm_source=tldrnewsletter#utility-types) 
- [Awaited](https://github.com/gibbok/typescript-book?utm_source=tldrnewsletter#awaited)
- [Partial](https://github.com/gibbok/typescript-book?utm_source=tldrnewsletter#partial)
- [Required](https://github.com/gibbok/typescript-book?utm_source=tldrnewsletter#required)
- [Readonly](https://github.com/gibbok/typescript-book?utm_source=tldrnewsletter#readonly)
- [Record<K, T>](https://github.com/gibbok/typescript-book?utm_source=tldrnewsletter#recordk-t)
- [Pick<T, K>](https://github.com/gibbok/typescript-book?utm_source=tldrnewsletter#pickt-k)
- [Omit<T, K>](https://github.com/gibbok/typescript-book?utm_source=tldrnewsletter#omitt-k)
- [Exclude<T, U>](https://github.com/gibbok/typescript-book?utm_source=tldrnewsletter#excludet-u)
- [Extract<T, U>](https://github.com/gibbok/typescript-book?utm_source=tldrnewsletter#extractt-u)
- [NonNullable](https://github.com/gibbok/typescript-book?utm_source=tldrnewsletter#nonnullable)
- [Parameters](https://github.com/gibbok/typescript-book?utm_source=tldrnewsletter#parameters)
- [ConstructorParameters](https://github.com/gibbok/typescript-book?utm_source=tldrnewsletter#constructorparameters)
- [ReturnType](https://github.com/gibbok/typescript-book?utm_source=tldrnewsletter#returntype)
- [InstanceType](https://github.com/gibbok/typescript-book?utm_source=tldrnewsletter#instancetype)
- [ThisParameterType](https://github.com/gibbok/typescript-book?utm_source=tldrnewsletter#thisparametertype)
- [OmitThisParameter](https://github.com/gibbok/typescript-book?utm_source=tldrnewsletter#omitthisparameter)
- [ThisType](https://github.com/gibbok/typescript-book?utm_source=tldrnewsletter#thistype)
- [Uppercase](https://github.com/gibbok/typescript-book?utm_source=tldrnewsletter#uppercase)
- [Lowercase](https://github.com/gibbok/typescript-book?utm_source=tldrnewsletter#lowercase)
- [Capitalize](https://github.com/gibbok/typescript-book?utm_source=tldrnewsletter#capitalize)
- [Uncapitalize](https://github.com/gibbok/typescript-book?utm_source=tldrnewsletter#uncapitalize)
- [Others](https://github.com/gibbok/typescript-book?utm_source=tldrnewsletter#others) 
- [Errors and Exception Handling](https://github.com/gibbok/typescript-book?utm_source=tldrnewsletter#errors-and-exception-handling)
- [Mixin Classes](https://github.com/gibbok/typescript-book?utm_source=tldrnewsletter#mixin-classes)
- [Asynchronous Language Features](https://github.com/gibbok/typescript-book?utm_source=tldrnewsletter#asynchronous-language-features)
- [Iterators and Generators](https://github.com/gibbok/typescript-book?utm_source=tldrnewsletter#iterators-and-generators)
- [TsDocs JSDoc Reference](https://github.com/gibbok/typescript-book?utm_source=tldrnewsletter#tsdocs-jsdoc-reference)
- [@types](https://github.com/gibbok/typescript-book?utm_source=tldrnewsletter#types)
- [JSX](https://github.com/gibbok/typescript-book?utm_source=tldrnewsletter#jsx-1)
- [ES6 Modules](https://github.com/gibbok/typescript-book?utm_source=tldrnewsletter#es6-modules)
- [ES7 exponentiation operator](https://github.com/gibbok/typescript-book?utm_source=tldrnewsletter#es7-exponentiation-operator)
- [The for-await-of Statement](https://github.com/gibbok/typescript-book?utm_source=tldrnewsletter#the-for-await-of-statement)
- [New.target](https://github.com/gibbok/typescript-book?utm_source=tldrnewsletter#newtarget)
- [Dynamic Import Expressions](https://github.com/gibbok/typescript-book?utm_source=tldrnewsletter#dynamic-import-expressions)
- [“tsc –watch”](https://github.com/gibbok/typescript-book?utm_source=tldrnewsletter#tsc-watch)
- [Definite Assignment Assertions (!)](https://github.com/gibbok/typescript-book?utm_source=tldrnewsletter#definite-assignment-assertions-)
- [Defaulted declarations](https://github.com/gibbok/typescript-book?utm_source=tldrnewsletter#defaulted-declarations)
- [“const“ assertions](https://github.com/gibbok/typescript-book?utm_source=tldrnewsletter#const-assertions)
- [Optional Chaining](https://github.com/gibbok/typescript-book?utm_source=tldrnewsletter#optional-chaining)
- [Nullish coalescing operator (??)](https://github.com/gibbok/typescript-book?utm_source=tldrnewsletter#nullish-coalescing-operator-)
- [Template Literal Types](https://github.com/gibbok/typescript-book?utm_source=tldrnewsletter#template-literal-types)
- [Function overloading](https://github.com/gibbok/typescript-book?utm_source=tldrnewsletter#function-overloading)
- [Recursive Conditional Types](https://github.com/gibbok/typescript-book?utm_source=tldrnewsletter#recursive-conditional-types)
- [ECMAScript Module Support in Node.js](https://github.com/gibbok/typescript-book?utm_source=tldrnewsletter#ecmascript-module-support-in-nodejs)
- [Assertion Functions](https://github.com/gibbok/typescript-book?utm_source=tldrnewsletter#assertion-functions)
- [Variadic Tuple Types](https://github.com/gibbok/typescript-book?utm_source=tldrnewsletter#variadic-tuple-types)
- [Boxed types](https://github.com/gibbok/typescript-book?utm_source=tldrnewsletter#boxed-types)
- [Key Remapping in Mapped Types](https://github.com/gibbok/typescript-book?utm_source=tldrnewsletter#key-remapping-in-mapped-types)
- [Covariance and Contravariance in TypeScript](https://github.com/gibbok/typescript-book?utm_source=tldrnewsletter#covariance-and-contravariance-in-typescript) 
- [Optional Variance Annotations for Type Parameters](https://github.com/gibbok/typescript-book?utm_source=tldrnewsletter#optional-variance-annotations-for-type-parameters)
- [Symbol and Template String Pattern Index Signatures](https://github.com/gibbok/typescript-book?utm_source=tldrnewsletter#symbol-and-template-string-pattern-index-signatures)
- [The satisfies Operator](https://github.com/gibbok/typescript-book?utm_source=tldrnewsletter#the-satisfies-operator)
...
Here are some of the modern JavaScript features that can be used in TypeScript: _ ECMAScript modules instead of AMD-style "define" callbacks or CommonJS "require" statements. _ Classes instead of prototypes. _ Variables declaration using "let" or "const" instead of "var". _ "for-of" loop or ".forEach" instead of the traditional "for" loop. _ Arrow functions instead of function expressions. _ Destructuring assignment. _ Shorthand property/method names and computed property names. _ Default function parameters.
...
Notes: _ tsconfig.json accepts comments even if it is in json format. _ It is advisable to use this configuration file instead of the command-line options.

At the following link you can find the complete documentation and its schema: [https://www.typescriptlang.org/tsconfig](https://www.typescriptlang.org/tsconfig) [http://json.schemastore.org/tsconfig](http://json.schemastore.org/tsconfig)
...
The "strict" property enables stronger guarantees and enhances type safety. It is advisable to always include this property in your project's tsconfig.json file. Enabling the "strict" property allows TypeScript to: _ Emit code using "use strict" for each source file. _ Consider "null" and "undefined" in the type checking process. _ Disable the usage of the "any" type when no type annotations are present. _ Raise an error on the usage of the "this" expression, which would otherwise imply the "any" type.
...
The `extends` keyword could be considered as a “subset of” in this context. It sets a constraint for a type. The extends used with a generic, take the generic as an infinite set and it will constrain it to a more specific type. Please note that `extends` has nothing to do with hierarchy in a OOP sense (there is no this concept in TypScript). TypeScript works with sets and does not have a strict hierarchy, infact, as in the example below, two types could overlap without either being a subtype of the other type (TypScript considers the structure, shape of the objects).
...
In this example, the type J uses a mapped type with a template literal to remap the keys of Type. It creates new properties with a prefix_ added to each key, and their corresponding values are functions returning the original property values.
...
Many common libraries types can be found at: [https://github.com/DefinitelyTyped/DefinitelyTyped/](https://github.com/DefinitelyTyped/DefinitelyTyped/)
...
TypeScript can infer types when no annotation is provided during: * Variable initialization. * Member initialization. * Setting defaults for parameters. * Function return type.
...
NonNullable: This type removes null and undefined from Type.

ReturnType: This type extracts the return type of a function Type.
...
`interface InterfaceName` or `type TypeName`: Defines the name of the interface. `property1`: `Type1`: Specifies the properties of the interface along with their corresponding types. Multiple properties can be defined, each separated by a semicolon. `method1(arg1: ArgType1, arg2: ArgType2): ReturnType;` method2(): void;: Specifies the methods of the interface. Methods are defined with their names, followed by a parameter list in parentheses and the return type. Multiple methods can be defined, each separated by a semicolon.
...
`number`: Represents numeric values, including integers and floating-point numbers. `string`: Represents textual data `boolean`: Represents logical values, which can be either true or false. `null`: Represents the absence of a value. `undefined`: Represents a value that has not been assigned or has not been defined. `symbol`: Represents a unique identifier. Symbols are typically used as keys for object properties. `bigint`: Represents arbitrary-precision integers. `any`: Represents a dynamic or unknown type. Variables of type any can hold values of any type, and they bypass type checking. `void`: Represents the absence of any type. It is commonly used as the return type of functions that do not return a value. `never`: Represents a type for values that never occur. It is typically used as the return type of functions that throw an error or enter an infinite loop.

## Common Built-in JS Objects

TypeScript is a superset of JavaScript, it includes all the commonly used built-in JavaScript objects. You can find an extensive list of these objects on the Mozilla Developer Network (MDN) documentation website: [https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects)
...
Promises: Promises are a way to handle asynchronous operations and their results using methods like `.then()` and `.catch()` to handle success and error conditions.
...
Async/await: Async/await keywords are a way to provide a more synchronous-looking syntax for working with Promises. The `async` keyword is used to define an asynchronous function, and the `await` keyword is used within an async function to pause execution until a Promise is resolved or rejected.

To learn more: [https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Statements/async_function](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Statements/async_function) [https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Operators/await](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Operators/await)
...
Web Workers [https://developer.mozilla.org/en-US/docs/Web/API/Web_Workers_API](https://developer.mozilla.org/en-US/docs/Web/API/Web_Workers_API)

Shared Workers [https://developer.mozilla.org/en-US/docs/Web/API/SharedWorker](https://developer.mozilla.org/en-US/docs/Web/API/SharedWorker)

WebSocket [https://developer.mozilla.org/en-US/docs/Web/API/WebSockets_API](https://developer.mozilla.org/en-US/docs/Web/API/WebSockets_API)
...
To learn more: [https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/Generator](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/Generator) [https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/Iterator](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/Iterator)
...
Full documentation is provided to this link: [https://www.typescriptlang.org/docs/handbook/jsdoc-supported-types.html](https://www.typescriptlang.org/docs/handbook/jsdoc-supported-types.html)

From version 3.7 it is possible to generate .d.ts type definitions from JavaScript JSDoc syntax. More information can be found here: [https://www.typescriptlang.org/docs/handbook/declaration-files/dts-from-js.html](https://www.typescriptlang.org/docs/handbook/declaration-files/dts-from-js.html)
...
All options are available here: [https://www.typescriptlang.org/tsconfig#jsx](https://www.typescriptlang.org/tsconfig#jsx)
...
With the new variadic tuples we can use: * The spreads in tuple type syntax can now be generic, so we can represent higher-order operation on tuples and arrays even when we do not know the actual types we are operating over. * The rest elements can occur anywhere in a tuple.
