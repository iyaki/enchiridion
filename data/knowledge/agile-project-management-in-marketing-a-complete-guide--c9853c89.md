---
title: "Agile Project Management In Marketing: A Complete Guide"
notion_id: c9853c89-c191-43a1-979f-4d47124d6e1d
...
tags: ["Agile", "Entrepreneurship", "Article", "Guide", "Toggl Blog", "English"]
---
...
In the marketing world too, Agile project management is fast becoming a staple. 41% of marketers [use Agile](https://www.agilesherpas.com/blog/state-of-agile-marketing-2020) marketing practices to manage their teams.

In this blog, you’ll learn about Agile project management in marketing. You’ll also learn about the features your [marketing project management software](https://toggl.com/blog/marketing-project-management-software) needs to support agile methodologies.
...
A group of developers came up with [an agile management manifesto](https://www.planview.com/resources/guide/agile-methodologies-a-beginners-guide/history-of-agile) to tackle this challenge. It had four core principles:

1. Individuals and interactions over processes and tools
2. Working software over comprehensive documentation
3. Customer collaboration over contract negotiation
4. Responding to change instead of following a set plan
...
[Source](https://www.soldevelo.com/blog/is-agile-always-the-best-solution-for-software-development-projects/)
...
Agile is not easy to implement for everyone. To make Agile marketing project management work, [McKinsey found](https://www.mckinsey.com/business-functions/growth-marketing-and-sales/our-insights/agile-marketing-a-step-by-step-guide) you need a few key things:
...
- **A clear **[**project communication plan**](https://toggl.com/blog/project-communication-plan) both within the team and with the rest of the stakeholders
...
Kanban is a [visual project management tool](https://toggl.com/blog/visual-project-management-tools) that uses a board view to capture, organize, and prioritize sprint tasks.

A sample Kanban board. Each column represents the task status. And each card represents a task.
...
_“As a link builder, I would like to learn how to find email addresses, so that I can contact webmasters and send them an email requesting a link back to my website.”_
...
The [marketing project manager](https://toggl.com/blog/marketing-project-manager) adds and prioritizes tasks on the backlog. Here’s an example of project backlog and sprint tasks for a simple web design project.
...
With a [Kanban board tool](https://toggl.com/blog/kanban-board-tools), choosing tasks for a sprint is easy. Just drag and drop a task from the Backlog column to the Sprint column.
...
There are loads of ways to do this, but the simplest (and most fun!) way is with [T-shirt sizing](https://www.netsolutions.com/insights/how-to-estimate-projects-in-agile/).

Yep, you read that correctly. Here’s how it works:

1. You sit down with your full Agile team and review a particular user story or task.
2. Each member of the team writes down on a piece of paper their estimate for how big of an effort this would be, using T-shirt sizes: XS, S, M, L, or XL.
3. Everyone reveals answers at once and discusses the outcome to reach a consensus.
4. The project manager uses this consensus to plan and optimize the next sprint.
...
1. **Sprint planning: **Usually an hour a week for the duration of the sprint, where the product owner presents the backlog to the group and they all collaborate on a forecast for how long each task will take. This is used to create a sprint backlog.
2. **Daily standup**: A 15-minute morning meeting where team members run through what they did yesterday, what they’re working on today, and what their blocks are. We recommend you actually stand up for this—it helps to keep it short!
3. **Iteration review:** A longer meeting at the end of each sprint cycle, intended for demonstration of the work so far, a celebration of achievements, and feedback for improvements.
4. **Retrospective:** This comes at the end of an iteration and is all about feedback. We’ll cover this in more detail below.
...
- **How long did each task take to complete? **You don’t have to rely on just self-reflection here: [time tracking tools](https://toggl.com/track/) can gather this data for you effortlessly as you work on your project. Use this to inform your forecasting.
...
With most Agile marketing projects, you need a [high-level roadmap](https://toggl.com/blog/what-is-a-project-roadmap) of what activities will happen in each sprint.
...
[Toggl Plan](https://toggl.com/plan/index)‘s drag-and-drop timelines make it easy to plan sprint roadmaps.
...
[Toggl Plan](https://toggl.com/plan/index)‘s Kanban boards make it easy to manage your Agile marketing project sprints
...
See your entire team’s schedule in one place with [Toggl Plan](https://toggl.com/plan/index)‘s team timelines
