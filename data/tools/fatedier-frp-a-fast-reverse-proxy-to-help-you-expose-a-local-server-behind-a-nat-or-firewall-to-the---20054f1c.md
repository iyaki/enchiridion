...
notion_id: 20054f1c-7d23-81a0-87b5-ec5ade481a1c
notion_url: https://app.notion.com/p/fatedier-frp-A-fast-reverse-proxy-to-help-you-expose-a-local-server-behind-a-NAT-or-firewall-to-the-20054f1c7d2381a087b5ec5ade481a1c
last_edited: 2025-06-22T02:17:00.000Z
source_url: https://github.com/fatedier/frp
tags: ["Network", "Web Development", "Producer (Individual Contributor)", "Tool", "English"]
---
# frp
...
- [Development Status](https://github.com/fatedier/frp#development-status) 
- [About V2](https://github.com/fatedier/frp#about-v2)
- [Architecture](https://github.com/fatedier/frp#architecture)
- [Example Usage](https://github.com/fatedier/frp#example-usage) 
- [Access your computer in a LAN network via SSH](https://github.com/fatedier/frp#access-your-computer-in-a-lan-network-via-ssh)
- [Multiple SSH services sharing the same port](https://github.com/fatedier/frp#multiple-ssh-services-sharing-the-same-port)
- [Accessing Internal Web Services with Custom Domains in LAN](https://github.com/fatedier/frp#accessing-internal-web-services-with-custom-domains-in-lan)
- [Forward DNS query requests](https://github.com/fatedier/frp#forward-dns-query-requests)
- [Forward Unix Domain Socket](https://github.com/fatedier/frp#forward-unix-domain-socket)
- [Expose a simple HTTP file server](https://github.com/fatedier/frp#expose-a-simple-http-file-server)
- [Enable HTTPS for a local HTTP(S) service](https://github.com/fatedier/frp#enable-https-for-a-local-https-service)
- [Expose your service privately](https://github.com/fatedier/frp#expose-your-service-privately)
- [P2P Mode](https://github.com/fatedier/frp#p2p-mode)
- [Features](https://github.com/fatedier/frp#features) 
- [Configuration Files](https://github.com/fatedier/frp#configuration-files)
- [Using Environment Variables](https://github.com/fatedier/frp#using-environment-variables)
- [Split Configures Into Different Files](https://github.com/fatedier/frp#split-configures-into-different-files)
- [Server Dashboard](https://github.com/fatedier/frp#server-dashboard)
- [Client Admin UI](https://github.com/fatedier/frp#client-admin-ui)
- [Monitor](https://github.com/fatedier/frp#monitor) 
- [Prometheus](https://github.com/fatedier/frp#prometheus)
- [Authenticating the Client](https://github.com/fatedier/frp#authenticating-the-client) 
- [Token Authentication](https://github.com/fatedier/frp#token-authentication)
- [OIDC Authentication](https://github.com/fatedier/frp#oidc-authentication)
- [Encryption and Compression](https://github.com/fatedier/frp#encryption-and-compression) 
- [TLS](https://github.com/fatedier/frp#tls)
- [Hot-Reloading frpc configuration](https://github.com/fatedier/frp#hot-reloading-frpc-configuration)
- [Get proxy status from client](https://github.com/fatedier/frp#get-proxy-status-from-client)
- [Only allowing certain ports on the server](https://github.com/fatedier/frp#only-allowing-certain-ports-on-the-server)
- [Port Reuse](https://github.com/fatedier/frp#port-reuse)
- [Bandwidth Limit](https://github.com/fatedier/frp#bandwidth-limit) 
- [For Each Proxy](https://github.com/fatedier/frp#for-each-proxy)
- [TCP Stream Multiplexing](https://github.com/fatedier/frp#tcp-stream-multiplexing)
- [Support KCP Protocol](https://github.com/fatedier/frp#support-kcp-protocol)
- [Support QUIC Protocol](https://github.com/fatedier/frp#support-quic-protocol)
- [Connection Pooling](https://github.com/fatedier/frp#connection-pooling)
- [Load balancing](https://github.com/fatedier/frp#load-balancing)
- [Service Health Check](https://github.com/fatedier/frp#service-health-check)
- [Rewriting the HTTP Host Header](https://github.com/fatedier/frp#rewriting-the-http-host-header)
- [Setting other HTTP Headers](https://github.com/fatedier/frp#setting-other-http-headers)
- [Get Real IP](https://github.com/fatedier/frp#get-real-ip) 
- [HTTP X-Forwarded-For](https://github.com/fatedier/frp#http-x-forwarded-for)
- [Proxy Protocol](https://github.com/fatedier/frp#proxy-protocol)
- [Require HTTP Basic Auth (Password) for Web Services](https://github.com/fatedier/frp#require-http-basic-auth-password-for-web-services)
- [Custom Subdomain Names](https://github.com/fatedier/frp#custom-subdomain-names)
- [URL Routing](https://github.com/fatedier/frp#url-routing)
- [TCP Port Multiplexing](https://github.com/fatedier/frp#tcp-port-multiplexing)
- [Connecting to frps via PROXY](https://github.com/fatedier/frp#connecting-to-frps-via-proxy)
- [Port range mapping](https://github.com/fatedier/frp#port-range-mapping)
- [Client Plugins](https://github.com/fatedier/frp#client-plugins)
- [Server Manage Plugins](https://github.com/fatedier/frp#server-manage-plugins)
- [SSH Tunnel Gateway](https://github.com/fatedier/frp#ssh-tunnel-gateway)
- [Virtual Network (VirtualNet)](https://github.com/fatedier/frp#virtual-network-virtualnet)
- [Feature Gates](https://github.com/fatedier/frp#feature-gates) 
- [Available Feature Gates](https://github.com/fatedier/frp#available-feature-gates)
- [Enabling Feature Gates](https://github.com/fatedier/frp#enabling-feature-gates)
- [Feature Lifecycle](https://github.com/fatedier/frp#feature-lifecycle)
- [Related Projects](https://github.com/fatedier/frp#related-projects)
- [Contributing](https://github.com/fatedier/frp#contributing)
- [Donation](https://github.com/fatedier/frp#donation) 
- [GitHub Sponsors](https://github.com/fatedier/frp#github-sponsors)
- [PayPal](https://github.com/fatedier/frp#paypal)
...
Map the A record of `www.example.com` to either the public IP of the remote frps server or a CNAME record pointing to your original domain.

1. 

Visit your local web service using url `http://www.example.com:8080`.
...
![image](https://github.com/fatedier/frp/raw/dev/doc/pic/dashboard.png)
...
_Alpha feature added in v0.62.0_
