...
notion_id: eb1a6697-4fdd-4874-b89b-3e576f4888b7
notion_url: https://app.notion.com/p/Mi-c-digo-en-producci-n-ya-es-legacy-eb1a66974fdd4874b89b3e576f4888b7
last_edited: 2022-12-31T22:09:00.000Z
source_url: https://franiglesias.github.io/prod-code-is-legacy/
tags: ["Español", "Programming", "Article", "The Talking Bit - Fran Iglesias"]
---
Artículo que [versiona la charla](https://franiglesias.github.io/peum-conf-2020).

Todo código es _legacy_. Esto no es malo, sino una cuestión de cuán _legacy_ es o le dejamos ser.
...
Así, el código de producción representa la estructura del conocimiento del dominio (conceptos, procesos y reglas de negocio), y el código de producción representa el comportamiento esperado o deseado del software a partir de la observación de sus _outcomes_.

## Legacy

Podemos definir el _legacy_ como el desfase existente entre el conocimiento de dominio y su representación en código.

O bien, decir que tenemos _legacy_ cuando el código ha dejado de representar el conocimiento actual del dominio.
