...
We would jump from reviewing [interview guides](https://www.producttalk.org/2016/03/customer-interview-questions/) one week to discussing [experiment results](https://www.producttalk.org/hypothesis-testing/) the next.
...
My goal as a coach is to get teams doing [continuous discovery](http://svpg.com/continuous-discovery/) on their own as quickly as possible. So I knew something had to change.

I kept asking myself, how do I decide what comes next? And more importantly, how do I teach this to teams?

I started by trying to be more explicit about what modern product discovery is. That led to [this video](https://www.producttalk.org/2016/03/introduction-to-product-discovery/).
...
Fortunately, around this time I was reading [_Peak: Secrets from the New Science of Expertise_](http://amzn.to/2aGgcjj) by [Anders Ericsson](https://psy.fsu.edu/faculty/ericsson.dp.html).

Ericsson has spent his career studying what makes experts stand apart from novices and [_Peak_](http://amzn.to/2aGgcjj) summarizes his perspective on the research today.
...
This line of inquiry reminded me of [Bernie Roth](http://dschool.stanford.edu/bio/bernie-roth/). Bernie is a Professor of Engineering and the Academic Director at the [d.school](http://dschool.stanford.edu/) at Stanford University.
...
Bernie taught a very simple way to [widen your lens](https://www.producttalk.org/2013/07/stop-asking-whether-or-not-questions/), to avoid fixating on a single solution.
...
If we [widen our own lens](https://www.producttalk.org/2013/07/stop-asking-whether-or-not-questions/) from the world of product management to the world of problem solving—[remember, product managers are problem solvers](https://www.producttalk.org/2016/01/product-managers-level-problem-solving-skills/)—we see this mental representation show up again and again.

If you’ve been reading Product Talk since the beginning of the year, you might remember David Jonassen’s work on problem solving. [See this article](https://www.producttalk.org/2016/01/product-managers-level-problem-solving-skills/).
...
[Multitracking](https://www.producttalk.org/2013/08/start-an-idea-journal/) should sound familiar to long-time readers as well.

Chip and Dan Heath talk about the value of multitracking in their book [_Decisive_](http://amzn.to/2aANGQj)—a summary of the research on decision making. I’ve written twelve blog posts about this book—you can [find them here](https://www.producttalk.org/decision-making/).
...
This systematic approach is important. [Remember, John Dewey](https://www.producttalk.org/2016/01/why-you-arent-learning-as-much-as-you-could-from-your-experiments/) in [_How We Think_](http://amzn.to/2aN0E0Y), encourages us “to maintain the state of doubt and to carry on a systematic and protracted inquiry—these are the essentials of thinking.”
...
[An Opportunity Solution Tree](https://www.producttalk.org/wp-content/uploads/2019/02/Opportunity-Solution-Tree.png)
...
If your team uses [OKRs](http://firstround.com/review/How-to-Make-OKRs-Actually-Work-at-Your-Startup/), you might start with one of your Key Results.
...
But there’s plenty of research that shows everyone can and should [contribute to idea generation](https://www.producttalk.org/2014/02/how-we-used-kindling-at-aftercollege-to-engage-everyone-in-idea-generation/).
...
As we make the shift toward autonomous product teams, more of our work is being guided by a clear desired outcome. The recent popularity of [OKRs](http://firstround.com/review/How-to-Make-OKRs-Actually-Work-at-Your-Startup/) is helping to accelerate this.
...
However, don’t take multitracking too far. It’s easy to stay in the problem space for too long, trying to identify every opportunity. Idea generation is fun, but once we have some promising ideas, the return on the investment starts to peter out. We [don’t want to test every idea](https://www.producttalk.org/2014/02/why-testing-everything-doesnt-work/) we have.
...
If you want to follow along as I write this book, [join the Product Talk mailing list](http://eepurl.com/DvaUX).
