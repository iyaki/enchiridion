...
notion_id: 3f0a2210-ffbe-4b86-8d68-049847e5a742
notion_url: https://app.notion.com/p/Declarative-Shadow-DOM-3f0a2210ffbe4b868d68049847e5a742
last_edited: 2023-08-30T13:39:00.000Z
source_url: https://developer.chrome.com/articles/declarative-shadow-dom/
tags: ["Guide", "Chrome Developers", "English", "Español", "Others", "Frontend", "HTML", "Javascript", "CSS"]
---
<!-- image hosted by Notion: its URL expires and is not preserved (ADR-05) -->

A new way to implement and use Shadow DOM directly in HTML.

Translated to: [Español](https://developer.chrome.com/es/articles/declarative-shadow-dom/), [Português](https://developer.chrome.com/pt/articles/declarative-shadow-dom/)



Table of contents

- [Building a Declarative Shadow Root](https://developer.chrome.com/articles/declarative-shadow-dom/#building-a-declarative-shadow-root)
- [Component hydration](https://developer.chrome.com/articles/declarative-shadow-dom/#component-hydration)
- [One shadow per root](https://developer.chrome.com/articles/declarative-shadow-dom/#one-shadow-per-root)
- [Streaming is cool](https://developer.chrome.com/articles/declarative-shadow-dom/#streaming-is-cool)
- [Parser-only](https://developer.chrome.com/articles/declarative-shadow-dom/#parser-only)
- [Server-rendering with style](https://developer.chrome.com/articles/declarative-shadow-dom/#server-rendering-with-style)
- [Avoiding the flash of unstyled content](https://developer.chrome.com/articles/declarative-shadow-dom/#avoiding-the-flash-of-unstyled-content)
...
- [Further reading](https://developer.chrome.com/articles/declarative-shadow-dom/#further-reading)
...
## [#](https://developer.chrome.com/articles/declarative-shadow-dom/#building-a-declarative-shadow-root) Building a Declarative Shadow Root
...
## [#](https://developer.chrome.com/articles/declarative-shadow-dom/#component-hydration) Component hydration
...
## [#](https://developer.chrome.com/articles/declarative-shadow-dom/#one-shadow-per-root) One shadow per root
...
## [#](https://developer.chrome.com/articles/declarative-shadow-dom/#streaming-is-cool) Streaming is cool
...
## [#](https://developer.chrome.com/articles/declarative-shadow-dom/#parser-only) Parser-only
...
## [#](https://developer.chrome.com/articles/declarative-shadow-dom/#server-rendering-with-style) Server-rendering with style
...
## [#](https://developer.chrome.com/articles/declarative-shadow-dom/#avoiding-the-flash-of-unstyled-content) Avoiding the flash of unstyled content
...
## [#](https://developer.chrome.com/articles/declarative-shadow-dom/#feature-detection-and-browser-support) Feature detection and browser support
...
## [#](https://developer.chrome.com/articles/declarative-shadow-dom/#polyfill) Polyfill
...
## [#](https://developer.chrome.com/articles/declarative-shadow-dom/#further-reading) Further reading
