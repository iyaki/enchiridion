---
title: "What is a business roadmap and how to create one with examples"
notion_id: 2f6db8f4-0e3c-4563-9e6e-f51794a5e14f
notion_url: https://app.notion.com/p/What-is-a-business-roadmap-and-how-to-create-one-with-examples-2f6db8f40e3c45639e6ef51794a5e14f
last_edited: 2022-12-19T14:20:00.000Z
source_url: https://blog.logrocket.com/product-management/what-is-business-roadmap-how-to-create-examples/
...
However, although you might have seen a [product roadmap](https://blog.logrocket.com/product-management/how-to-build-product-roadmap-overview-examples/), not every organization has a business roadmap. What is this document, what does it include, and how do you know if you even need a business roadmap?
...
A business roadmap should give the organization and everyone in it a general outline of short- to medium-term business goals. This allows relevant stakeholders to make appropriate business decisions that support the [delivery of items in the roadmap](https://blog.logrocket.com/product-management/product-roadmap-tools-best-features-free-paid/).

## Business plan vs. business roadmap

I know what you’re thinking: isn’t a business roadmap just a [business plan](https://www.investopedia.com/terms/b/business-plan.asp)? The short answer is no.
...
As with any [roadmap](https://blog.logrocket.com/product-management/agile-roadmaps-examples-how-to-create/), there’s a need to understand inputs and priorities from across the organization and bring these together into one coherent vision. This means taking the following steps:

### Develop business objectives

Start at the beginning: what are you looking to achieve?

Your objectives should be [self-contained, achievable goals](https://blog.logrocket.com/product-management/what-are-okrs-how-to-write-templates-examples/) that are clear for everyone across the organization to understand.
...
### Identify activities that facilitate the objectives
...
### Not getting business or customer validation
...
If we look at our [example business roadmap](https://docs.google.com/spreadsheets/d/16fcwJtFr19aBYUYRQSVg-hqX6hv_PpHvdYlmvV3aDiI/edit?usp=sharing) as described above, one of the business objectives in Q3 is to launch our service in the US. This primary goal for the business will drive the business roadmap entries for our various business areas.
...
To access a full version of the business roadmap example described above, [follow this link](https://docs.google.com/spreadsheets/d/16fcwJtFr19aBYUYRQSVg-hqX6hv_PpHvdYlmvV3aDiI/edit#gid=0). If you’d like to use it as a [template](https://docs.google.com/spreadsheets/d/16fcwJtFr19aBYUYRQSVg-hqX6hv_PpHvdYlmvV3aDiI/edit#gid=0) when creating your own business roadmap, click the link to download the file and, from the menu at the top of the spreadsheet, select **File > Make a copy**.
