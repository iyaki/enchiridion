---
title: "The daily scrum meeting: Overview, best practices, anti-patterns"
notion_id: 2c34a7fc-dead-4c0f-9ab7-004bd2e247e2
notion_url: https://app.notion.com/p/The-daily-scrum-meeting-Overview-best-practices-anti-patterns-2c34a7fcdead4c0f9ab7004bd2e247e2
last_edited: 2022-12-19T15:16:00.000Z
source_url: https://blog.logrocket.com/product-management/the-daily-scrum-meeting-overview-best-practices-anti-patterns/
tags: ["Article", "LogRocket Blog", "English", "Agile", "Communication", "Project Management"]
---
<!-- image hosted by Notion: its URL expires and is not preserved (ADR-05) -->

In this guide, we’ll give an overview of the daily scrum meeting, also called the daily standup, which is a scrum ceremony practiced by agile product managers and development teams.
...
In Agile software development, the [daily scrum](https://blog.logrocket.com/product-management/what-are-five-types-of-scrum-meetings/#daily-scrum), also known as the daily standup, is a scrum event that occurs once each day of the sprint.
...
The daily standup is one of several scrum events designed to facilitate the [scrum pillars of transparency, inspection and adaption](https://www.scrum.org/resources/blog/three-pillars-empiricism-scrum): transparency of teams’ progress, inspection of that progress as it pertains to achieving the sprint goal, and adaption where needed.
...
The daily scrum is designed for the team to coordinate and adapt its progress within the sprint. At minimum, the product team should be in attendance. Typically, the invite list should also include the [product manager](https://blog.logrocket.com/product-management/what-does-a-product-manager-do-role-responsibilities/) and [scrum master](https://www.scrum.org/resources/what-is-a-scrum-master) or delivery manager.

Although stakeholders and others outside of the team are generally welcome to attend, the intended audience is the team. Any attendees outside of the team should be observers only.

## Who runs the daily scrum meeting?

There is no set facilitator of the daily scrum. [Experienced teams will typically self-organize](https://blog.logrocket.com/product-management/12-agile-manifesto-principles-how-to-adopt-them/#11-trust-your-team).
...
The most common format for the daily standup is known as the [three questions format](https://www.agilealliance.org/glossary/three-qs/). Each team member takes turns answering the following questions:

1. What did I achieve yesterday?
2. What do I plan to achieve today?
3. Are there any impediments to achieving what I plan?
...
## Walking the wall (aka walking the board)
...
Here’s how walking the wall works: rather than having each team member talk about what they did yesterday and what they plan to do today, you walk through the team’s [k](https://www.atlassian.com/agile/kanban)[anban](https://www.atlassian.com/agile/kanban) or task board and give updates on each item.
...
Anti-patterns are behaviors that act against the original intent of the daily scrum. Without correction, anti-patterns can render the daily scrum ineffective.

Below are some common anti-patterns that could derail your daily scrum meetings:

- Lack of coordination or collaboration
- Team members only communicate during the daily standup
- Team members are working as individuals and not as a team
- Team members tune out when it’s not their update and feel that others’ updates have little to do with them
- Lack of accountability for the work and plans among the team
- Redundant updates day after day
- Vague or evasive updates — e.g., “Today I will continue to work on what I did yesterday”
...
- Hold the daily scrum at the same time and place each day
- Set aside time directly after the daily scrum for offline or urgent discussions that were identified during the meeting
- Rotate the facilitator
- Meet in front of the team’s kanban board
- Ask that any discussions are taken offline and held until the end of the standup
- Set a timer and make it visible
...
Daily standup and daily scrum are often used interchangeably. Technically, as defined in _The Scrum Guide_, the ceremony is called a [daily scrum](https://www.scrum.org/resources/what-is-a-daily-scrum), which is typically held during a 15-minute stand-up meeting. This [distinction](https://www.scrum.org/forum/scrum-forum/38945/daily-scrum-and-daily-standup-same) is important for inclusivity because some team members may be unable to stand.

The term daily scrum was originally inspired by the idea that modern product development should be more like a rugby team, moving in unison across the field, than a relay race. According to “[_The New New Product Development Game_](https://hbr.org/1986/01/the-new-new-product-development-game)_“_:
