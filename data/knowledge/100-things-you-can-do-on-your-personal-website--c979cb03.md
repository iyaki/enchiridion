...
39. Translate a page on your website in another language you know or are learning.
40. Make sure all the links work on your website.
41. Start a blog carnival where you challenge friends to write about a specific topic each month. Pass on the task of choosing a topic to a new person every month.
42. Add [rel=me links](https://microformats.org/wiki/rel-me) to your other profiles on the web. Mastodon shows your website as verified with a green checkmark if your site has a rel=me link to your Mastodon profile.
43. If you want to present your work professionally on your website, add a resume page, written in HTML.
44. Style code snippets in posts on your blog with a syntax highlighter (i.e. Prism.js).
45. Review your `head` tag contents to review scripts and tags you no longer need.
46. Make a search feature for your website.
47. Add a [sparkline](https://indieweb.org/sparkline) that shows your post frequency.
48. Experiment with different fonts.
49. Make sure your heading sizes are not too close together.
50. Add an [asterism](https://en.wikipedia.org/wiki/Asterism_(typography)) or [fleuron](https://en.wikipedia.org/wiki/Fleuron_(typography)) to the end of your blog posts.
51. Use the [lite-youtube](https://www.zachleat.com/web/youtube-embeds/) web component to improve page loading speeds when you have embedded a YouTube video on the page.
52. Try a new colour scheme on your website.
53. Create a style page that shows how every HTML element you use to write content appears. Use this as a reference as you tweak content styles.
54. Write a quiz to share with your friends.
55. Add [Webmention](https://indieweb.org/Webmention) support to your personal website so you can receive notifications when people whose sites support Webmention (like this one!) link to or write a post in response to a blog post on your website.
56. Make a [web component](https://developer.mozilla.org/en-US/docs/Web/API/Web_components) for one of the parts on your website so that others can use that component on their website.
57. Add an effect that changes an image when you hover over it.
58. Add an audio recording of you saying your name or nickname so people know how to pronounce it. [Here's my name pronunciation recording](https://jamesg.blog/assets/pronunciation.m4a).
59. Add a [holiday theme](https://indieweb.org/holiday_theme) for a day of significance for you.
60. Draw a picture and share it on your website.
61. Add an interactive [pixel grid](https://aaronparecki.com/) that people can click on your home page.
62. Add a "[not by AI](https://notbyai.fyi/)" button if your content is all written by you.
63. Share a list of your favourite podcasts.
64. Make a new website for something you are passionate about. Baking? Poetry? Words? Funny charts? Whatever you like!
65. Make a favicon for your website.
66. Write a blog post about the history of your personal website.
67. Make a page that has an audio recording playing in the background (birds chirping? background noise of people chatting?).
68. Make a moodboard.
69. Use the `details` and `summary` HTML elements on a page on your website.
70. Change the default colour that is used to highlight text on your website.
71. Help someone else set up a website.
72. Write a document that describes how your website works, for yourself (so you don't forget!). This is useful if you have made a site with code.
73. Write a review of a piece of art you like. Describe how it makes you feel or what it makes you think about.
74. Write a blog post with a friend about a shared interest.
75. Update an old blog post you wrote that you know needs updated.
...
_Wait... James. That's only ~83 ideas, including the ideas for blog posts? You promised 100 ideas!_
...
- [Website Component Checklist](https://shellsharks.com/notes/2023/08/15/website-component-checklist) by shellsharks.com (written last year, way before I published this piece, but still super relevant!)
