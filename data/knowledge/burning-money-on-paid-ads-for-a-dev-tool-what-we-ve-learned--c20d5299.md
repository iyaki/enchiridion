...
notion_id: c20d5299-c95d-48e8-b974-7f3bcf7d3daa
notion_url: https://app.notion.com/p/Burning-money-on-paid-ads-for-a-dev-tool-what-we-ve-learned-c20d5299c95d48e8b9747f3bcf7d3daa
last_edited: 2023-10-17T12:30:00.000Z
source_url: https://posthog.com/blog/dev-marketing-paid-ads
tags: ["English", "Entrepreneurship", "Marketing", "Article", "PostHog"]
---
<!-- image hosted by Notion: its URL expires and is not preserved (ADR-05) -->

Since starting PostHog in 2020, we’ve learned a bunch about what does and doesn’t work when it comes to [marketing to engineers](https://posthog.com/blog/dev-marketing-for-startups). Paid ads is a slightly scary area because it is _very_ easy to waste a bunch of money doing stuff that doesn't work. And a lot of it doesn't work.
...
- Make sure you're covering [all your marketing bases](https://posthog.com/blog/dev-marketing-for-startups).
- Read about [how our marketing team uses PostHog](https://posthog.com/blog/posthog-marketing).
- Check out [PostHog’s Marketing Handbook](https://posthog.com/handbook/growth/marketing) – and copy it if you want to!

> Hello, Hacker News. If you liked this article, why not subscribe to our newsletter, Product for Engineers? We share more articles like this every two weeks or so.
