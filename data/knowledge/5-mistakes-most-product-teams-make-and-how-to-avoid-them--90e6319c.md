---
title: "5 mistakes most product teams make (and how to avoid them)"
notion_id: 90e6319c-ffc4-4bba-971f-8e8491b67820
notion_url: https://app.notion.com/p/5-mistakes-most-product-teams-make-and-how-to-avoid-them-90e6319cffc44bba971f8e8491b67820
last_edited: 2022-12-19T13:59:00.000Z
source_url: https://blog.logrocket.com/product-management/5-mistakes-product-teams-make-how-to-avoid/
tags: ["English", "Product Management", "Line/People/Team Management", "Article", "LogRocket Blog"]
---
<!-- image hosted by Notion: its URL expires and is not preserved (ADR-05) -->

Almost everything I loved as a kid has been replaced with a subscription service. The world I grew up in is seen as something retro today.
...
## What traps do product teams fall into?
...
Here’s my method: name the anti-patterns you see and ask your colleagues to rate them. You can use any digital board to do this (e.g.,[ Mentimeter](https://www.mentimeter.com/app),[ Miro](https://miro.com/),[ Mural](https://mural.co/), etc.).
...
If you’re like most product teams, [velocity](https://blog.logrocket.com/product-management/agile-product-management-what-does-it-mean/), [features](https://blog.logrocket.com/product-management/what-are-product-features-define-examples/), and deadlines are means to measure success. The problem is that none of them can guarantee you create value for your business.

Maybe you’re lucky and success means [increasing an important KPI](https://blog.logrocket.com/product-management/what-metrics-kpis-product-managers-track/), such as [customer satisfaction](https://blog.logrocket.com/product-management/customer-satisfaction-survey-templates-examples-questions/), return rate, [conversation rate](https://blog.logrocket.com/product-management/what-is-conversion-rate-how-to-calculate/), etc. It doesn’t matter how many features you deliver, but how they change the ultimate result.
...
- **Requests** — Whenever you receive a request, strive to understand the outcome. Don’t get bogged with the solution; your goal is to deliver the result
- **Backlog items** — Write your [backlog items](https://blog.logrocket.com/product-management/product-vs-sprint-vs-release-backlog/) to be focused on outcomes. Measure what to achieve, not what to deliver
...
Product teams face this dilemma every day. Stakeholders want something because they think it’s cool, yet they haven’t talked to any users.[ Developers](https://blog.logrocket.com/product-management/3-scrum-roles-agile/#developers) and[ designers](https://blog.logrocket.com/product-management/product-designer-vs-product-manager/) often get into a dogfight, bring few facts to the table but many opinions.
...
[Good roadmaps](https://blog.logrocket.com/product-management/how-to-build-product-roadmap-overview-examples/) set guardrails and let teams be creative. Bad roadmaps pressure teams to achieve the impossible without knowing why.
...
Let the results talk louder, and make incremental changes to your [roadmapping approach](https://blog.logrocket.com/product-management/product-roadmap-tools-best-features-free-paid/).
...
[What’s the problem with deadlines](https://blog.logrocket.com/product-management/how-to-meet-product-deadlines/)? It’s not the deadlines themselves, but how they’re set. Generally, someone outside the team defines deadlines, then asks for te team’s commitment. Of course, that won’t work. No one commits to something they weren’t part of planing for.
...
For example, if the [customer acquisition cost](https://blog.logrocket.com/product-management/what-is-customer-acquisition-cost-how-to-reduce/) is too high, it needs to improve or increase [customer lifetime value](https://blog.logrocket.com/product-management/what-customer-lifetime-value-clv-how-calculate/). Leadership might be afraid of running out of money, so they want this situation resolved in three months. Sharing that with the team would be enough.
...
In previous decades, the higher your rank was, the more decisions you could make. Traditionally, high-ranking people tend to have [little to no customer contact](https://blog.logrocket.com/product-management/four-agile-manifesto-values-explained/#customer-collaboration-over-contract-negotiation). Things have changed a lot since then.

Good leadership is about creating an environment where [teams can work autonomously](https://blog.logrocket.com/product-management/12-agile-manifesto-principles-how-to-adopt-them/#11-trust-your-team).
...
You’ll inevitably stumble across leaders like that throughout your [career as a product manager](https://blog.logrocket.com/product-management/product-manager-career-path/). You can win this battle not with arguments but with curiosity. Ask questions to understand the problem. For example:

- “Cool idea. Could you help me understand what problem we are solving?”
- “It’d be great to understand the context. Could you share more about it, like how often that happens, how people deal with that, and how much it annoys them?”
- “How will we know we’re successful when we have implemented this solution?”
...
2. Don’t try solving everything at once; choose one problem at a time
