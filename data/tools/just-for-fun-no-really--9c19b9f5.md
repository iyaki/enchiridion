...
notion_id: 9c19b9f5-ba27-487a-a654-372b7a30a59d
...
| [Piko-piko OS](https://github.com/RechieKho/piko-piko) | a x86 16-bit toy OS in assembly, for fun |
| [Folders2kt](https://github.com/Foso/Folders2kt) | an esoteric programming language Folders, for fun |
...
| [PyCraft](https://github.com/shasankp000/PyCraft) | a minecraft launcher built in python, for fun |
...
| [Quark](https://git.sr.ht/~hanna/quark) | An experimental, high performance lisp dialect for fun |
| [Whitecat](https://github.com/Trusted97/whitecat) | a CLI for boring stuff in PHP, for fun |
| [eClient](https://github.com/v-pun215/eClient) | a minecraft launcher for python devs, for fun |
...
1. Add the badge to your project README:

```plain text
[![justforfunnoreally.dev badge](https://img.shields.io/badge/justforfunnoreally-dev-9ff)](https://justforfunnoreally.dev)
```

1. Add your project to [this repo](https://github.com/seven1m/justforfunnoreally.dev).
