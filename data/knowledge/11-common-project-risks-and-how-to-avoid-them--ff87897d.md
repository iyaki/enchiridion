---
title: "11 Common project risks (and how to avoid them)"
notion_id: ff87897d-f2aa-4380-bf24-594c0fea35b4
...
_(particularly if you don’t pay attention)._
...
[68%of poorly managed projects](https://www.pmi.org/-/media/pmi/documents/public/pdf/learning/thought-leadership/pulse/pulse-of-the-profession-2017.pdf) experience scope creep — so there’s a good chance you’ve felt it, too.

[Scope creep](https://toggl.com/blog/project-scope-creep) refers to the tendency for the scope of a project to expand beyond its original objectives and requirements.
...
The cost risk of blowing the [project budget](https://toggl.com/blog/how-to-create-a-project-budget) is all too common when it comes to client work. Having worked for a marketing agency myself — I feel your pain here. 🫂

But it’s usually down to poor [project cost estimating](https://toggl.com/blog/project-cost-estimating) and scoping.
...
[An over-budget project in Toggl Track](https://toggl.com/track/)

**How can you avoid this?**

Create a detailed list of every project task (and what they cost) using a [Work Breakdown Structure](https://toggl.com/blog/work-breakdown-structure). It will help you create a far more accurate [project budget](https://toggl.com/blog/how-to-create-a-project-budget).

Work breakdown structure with cost and time estimates
...
[Source](https://www.reddit.com/r/projectmanagement/comments/b5at2k/how_often_do_projects_get_delayed_and_miss_the/)
...
Here’s what a [free online Gantt chart](https://toggl.com/plan/free-online-gantt-chart) looks like from Toggl Plan:

Project team timeline in Toggl Plan
...
Create a [resource allocation plan](https://toggl.com/blog/resource-planning-guide) which makes the best use of team resources while supporting overall goals.

You may want to consider a project [resource planning template](https://toggl.com/blog/resource-planning-templates).

Resouce planning template by Toggl
...
Consider using a visual resource planning tool such as [Toggl Plan](https://toggl.com/plan/index).

Resource planning using Toggl Plan

Generally, resource planning should be done in the [project planning phase](https://toggl.com/blog/starter-guide-project-planning).
...
And the [statement of work](https://toggl.com/blog/statement-of-work) says nothing but “build landing page.”

The meeting where _that_ gets brought up won’t be comfortable. 😬

**How can you avoid it?**

Double-check all [project requirements](https://toggl.com/blog/requirements-gathering) during the planning stage and create a [statement of work](https://toggl.com/blog/statement-of-work) that your client is happy with.
...
This isn’t _all_ their fault. The leading cause of a “helicopter client” usually is down to the following:
...
1. Your projects are a nightmare to work on
2. Your expectations aren’t clear from the get-go

Plus, some contractors leave mid-project — or drop off the face of the planet.

[Source](https://www.reddit.com/r/freelance/comments/uf3uoh/i_just_dumped_a_client_in_the_middle_of_a_project/)
...
1. Is your project planning up to scratch?
2. Do you fully understand the project’s requirements?
3. Have you accurately estimated what resources you need?
...
We get too optimistic and think work can be done in a flash. It’s called the [human planning fallacy](https://thedecisionlab.com/biases/planning-fallacy), which happens to all of us.

For example, you might tell yourself that a blog post _can_ be completed in three days: one day for drafting, one for editing, and one for shipping.

But you forget that your writer, editor, account manager, and PM are all in four different countries…

**How can you avoid it?**

Make [project time estimation](https://toggl.com/blog/project-time-estimation) a part of your process. Use your historical data from past projects to the fullest, then sprinkle some contingency time on top.

Lay this [time estimate](https://toggl.com/blog/project-time-estimation) in a project management software to visualize the work ahead. Here’s a schedule laid out in [Toggl Plan](https://toggl.com/plan/index).
...
Need help with estimating how long a project will take? Use past historical data to grab a quick [time estimate](https://toggl.com/blog/project-time-estimation). The [Project Dashboard](https://support.toggl.com/en/articles/3167701-project-dashboard) in [Toggl Track](https://toggl.com/track/) will give you instant access to several metrics, including total hours spent on each project!
...
It’s not always easy to identify the _why_ here. But, in my experience, it typically results from poorly [planned projects](https://toggl.com/blog/starter-guide-project-planning) and a lack of consideration regarding [resource planning](https://toggl.com/blog/resource-planning-guide).
...
New team members _lack context_ — maybe this client has a particular way, or your team member just isn’t ready for this huge responsibility.

**How can we avoid it?**

Thoughtful [resource management](https://toggl.com/blog/project-resource-management) will mitigate this risk. Make sure you put experienced team members on your highest-priority tasks.
...
[**27% of failed projects**](https://www.pmi.org/-/media/pmi/documents/public/pdf/learning/thought-leadership/pulse/pulse-of-the-profession-2017.pdf)** cited undefined risks as their primary cause of failure — and that’s just counting the projects surveyed.**
...
Learn how to assess and analyze project risks in our complete [project risk assessment and management](https://toggl.com/blog/how-to-do-project-risk-management) guide.
