...
- [Do](https://www.sqlstyle.guide/#do)
- [Avoid](https://www.sqlstyle.guide/#avoid)
- [Naming conventions](https://www.sqlstyle.guide/#naming-conventions) 
- [General](https://www.sqlstyle.guide/#general-1)
- [Tables](https://www.sqlstyle.guide/#tables)
- [Columns](https://www.sqlstyle.guide/#columns)
- [Aliasing or correlations](https://www.sqlstyle.guide/#aliasing-or-correlations)
- [Stored procedures](https://www.sqlstyle.guide/#stored-procedures)
- [Uniform suffixes](https://www.sqlstyle.guide/#uniform-suffixes)
- [Query syntax](https://www.sqlstyle.guide/#query-syntax) 
- [Reserved words](https://www.sqlstyle.guide/#reserved-words)
- [White space](https://www.sqlstyle.guide/#white-space)
- [Indentation](https://www.sqlstyle.guide/#indentation)
- [Preferred formalisms](https://www.sqlstyle.guide/#preferred-formalisms)
- [Create syntax](https://www.sqlstyle.guide/#create-syntax) 
- [Choosing data types](https://www.sqlstyle.guide/#choosing-data-types)
- [Specifying default values](https://www.sqlstyle.guide/#specifying-default-values)
- [Constraints and keys](https://www.sqlstyle.guide/#constraints-and-keys)
- [Designs to avoid](https://www.sqlstyle.guide/#designs-to-avoid)
- [Appendix](https://www.sqlstyle.guide/#appendix) 
- [Reserved keyword reference](https://www.sqlstyle.guide/#reserved-keyword-reference)
- [Column data types](https://www.sqlstyle.guide/#column-data-types)

## Overview

You can use this set of guidelines, [fork them](https://github.com/treffynnon/sqlstyle.guide/fork) or make your own - the key here is that you pick a style and stick to it. To suggest changes or fix bugs please open an [issue](https://github.com/treffynnon/sqlstyle.guide/issues) or [pull request](https://github.com/treffynnon/sqlstyle.guide/pulls/) on GitHub.

These guidelines are designed to be compatible with Joe Celko’s [SQL Programming Style](https://www.amazon.com/gp/product/0120887975/ref=as_li_ss_tl?ie=UTF8&linkCode=ll1&tag=treffynnon-20&linkId=9c88eac8cd420e979675c815771313d5) book to make adoption for teams who have already read that book easier. This guide is a little more opinionated in some areas and in others a little more relaxed. It is certainly more succinct where [Celko’s book](https://www.amazon.com/gp/product/0120887975/ref=as_li_ss_tl?ie=UTF8&linkCode=ll1&tag=treffynnon-20&linkId=9c88eac8cd420e979675c815771313d5) contains anecdotes and reasoning behind each rule as thoughtful prose.

It is easy to include this guide in [Markdown format](https://raw.githubusercontent.com/treffynnon/sqlstyle.guide/gh-pages/_includes/sqlstyle.guide.md) as a part of a project’s code base or reference it here for anyone on the project to freely read—much harder with a physical book.

SQL style guide by [Simon Holywell](https://www.simonholywell.com/?utm_source=sqlstyle.guide&utm_medium=link&utm_campaign=md-document) is licensed under a [Creative Commons Attribution-ShareAlike 4.0 International License](https://creativecommons.org/licenses/by-sa/4.0/). Based on a work at [https://www.sqlstyle.guide/](https://www.sqlstyle.guide/).
...
- Store [ISO 8601](https://en.wikipedia.org/wiki/ISO_8601) compliant time and date information (`YYYY-MM-DDTHH:MM:SS.SSSSS`).
...
The exception to this is when using just the `JOIN` keyword where it should be before the river.
