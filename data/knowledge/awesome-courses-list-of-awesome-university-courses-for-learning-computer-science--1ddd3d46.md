...
tags: ["Course", "English", "Programming", "Learning"]
---
# Awesome CS Courses
...
- [Algorithms](https://github.com/prakhar1989/awesome-courses#algorithms)
- [Artificial Intelligence](https://github.com/prakhar1989/awesome-courses#artificial-intelligence)
- [Computer Graphics](https://github.com/prakhar1989/awesome-courses#computer-graphics)
- [CS Theory](https://github.com/prakhar1989/awesome-courses#cs-theory)
- [Introduction to CS](https://github.com/prakhar1989/awesome-courses#introduction-to-cs)
- [Machine Learning](https://github.com/prakhar1989/awesome-courses#machine-learning)
- [Misc](https://github.com/prakhar1989/awesome-courses#misc)
- [Programming Languages / Compilers](https://github.com/prakhar1989/awesome-courses#programming-languages--compilers)
- [Security](https://github.com/prakhar1989/awesome-courses#security)
- [Systems](https://github.com/prakhar1989/awesome-courses#systems)
- [Statistics / Regression](https://github.com/prakhar1989/awesome-courses#statistics)
...
- [CS 61C](http://www-inst.eecs.berkeley.edu/~cs61c/sp15/) **Great Ideas in Computer Architecture (Machine Structures)** _UC Berkeley_     
...
- [CS 107](https://courseware.stanford.edu/pg/courses/lectures/371747) **Computer Organization & Systems** _Stanford University_   
...
- [CS 140](http://web.stanford.edu/~ouster/cgi-bin/cs140-spring14/lectures.php) **Operating Systems** _Stanford University_   
...
- [6.004](https://6004.mit.edu/) **Computation Structures** _MIT_    
...
- [CS 162](http://cs162.eecs.berkeley.edu/) **Operating Systems and Systems Programming** _UC Berkeley_     
...
- [CS 168](https://inst.eecs.berkeley.edu/~cs168/fa14/) **Introduction to the Internet: Architecture and Protocols** _UC Berkeley_   
...
- [CS 179](http://courses.cms.caltech.edu/cs179/) **GPU Programming** _Caltech_   
...
- [CS 186](https://sites.google.com/site/cs186spring2015/) **Introduction to Database Systems** _UC Berkeley_     
...
- [CS 241](https://courses.engr.illinois.edu/cs241/sp2016/index.html) **Systems Programming (Spring 2016)** _Univ of Illinois, Urbana-Champaign_   
...
- [CS 452](http://www.cgl.uwaterloo.ca/~wmcowan/teaching/cs452/s12/) **Real-Time Programming** _University of Waterloo_   
...
- [CS 2043](http://www.cs.cornell.edu/courses/CS2043/2014sp/) **Unix Tools & Scripting** _Cornell University_    
...
- [CS 3410](http://www.cs.cornell.edu/courses/cs3410/2016fa/) **Computer System Organization and Programming** _Cornell University_    
...
- [CS 4410](http://www.cs.cornell.edu/courses/CS4410/2014fa/) **Operating Systems** _Cornell University_   
...
- [CS 4414](http://rust-class.org/index.html) **Operating Systems** _University of Virginia_   
...
- [CS 5412](http://www.cs.cornell.edu/Courses/CS5412/2014sp/) **Cloud Computing** _Cornell University_   
...
- [CSCE 3613](http://comp.uark.edu/~wingning/csce3613/csce3613.html) **Operating Systems** _University of Arkansas (Fayetteville)_    - An introduction to operating systems including topics in system structures, process management, storage management, files, distributed systems, and case studies. 
...
- [CSCI-UA.0202: Operating Systems (Undergrad)](http://www.cs.nyu.edu/~mwalfish/classes/15sp/index.html) **Operating Systems** _NYU_    
...
- [CSCI 360](http://compsci.hunter.cuny.edu/~sweiss/course_materials/csci360/csci360_f14.php) **Computer Architecture 3** _CUNY Hunter College_   
...
- [CSCI 493.66](http://compsci.hunter.cuny.edu/~sweiss/course_materials/csci493.66/csci493.66_spr12.php) **UNIX System Programming (formerly UNIX Tools)** _CUNY Hunter College_   
...
- [CSCI 493.75](http://compsci.hunter.cuny.edu/~sweiss/course_materials/csci493.65/csci493.65_spr14.php) **Parallel Computing** _CUNY Hunter College_   
...
- [Hack the Kernel](https://www.ops-class.org/) **Introduction to Operating Systems** _SUNY University at Buffalo, NY_    
...
- [ECE 459](http://patricklam.ca/p4p/) **Programming for Performance** _University of Waterloo_   
...
- [ECGR4101/5101](https://webpages.uncc.edu/~jmconrad/EducationalMaterials/index.html) **Embedded Systems using the Renesas RX63N Processor** _University of North Carolina at Charlotte_   
...
- [PODC](http://dcg.ethz.ch/lectures/podc_allstars/) **Principles of Distributed Computing** _ETH-Zurich_    
...
- [SPAC](http://homes.cs.washington.edu/~djg/teachingMaterials/spac/) **Parallelism and Concurrency** _Univ of Washington_  
...
- [6.824](http://css.csail.mit.edu/6.824/2014/index.html) **Distributed Systems** _MIT_   
...
- [6.828](http://pdos.csail.mit.edu/6.828/2014/) **Operating Systems** _MIT_   
...
- [CSEP 552](http://courses.cs.washington.edu/courses/csep552/16wi/) **Distributed Systems** _University of Washington_    
...
- [15-213](http://www.cs.cmu.edu/~213/) **Introduction to Computer Systems (ICS)** _Carnegie-Mellon University_    
...
- [15-319/619](http://www.cs.cmu.edu/~msakr/15619-s17/recitations.html) **Cloud Computing (ICS)** _Carnegie-Mellon University_   
...
- [15-410](https://www.cs.cmu.edu/~410/) **Operating System Design and Implementation** _Carnegie-Mellon University_   
...
- [15-418](http://15418.courses.cs.cmu.edu/spring2015/) **Parallel Computer Architecture and Programming** _Carnegie-Mellon University_     
...
- [15-440](http://www.cs.cmu.edu/~dga/15-440/F12/index.html) **Distributed Systems** _Carnegie-Mellon University_   
...
- [15-721](http://15721.courses.cs.cmu.edu/spring2016/) **Database Systems** _Carnegie-Mellon University_    
...
- [15-445/645](http://15445.courses.cs.cmu.edu/fall2017/) **Database Systems** _Carnegie-Mellon University_    
...
- [15-749](http://www.andrew.cmu.edu/course/15-749/) **Engineering Distributed Systems** _Carnegie-Mellon University_  
...
- [18-447](http://www.ece.cmu.edu/~ece447/s15/doku.php?id=start) **Introduction to Computer Architecture** _CMU_    
...
- [CS 75](https://www.cs.swarthmore.edu/~jpolitz/cs75/s16/index.html) **Principles of Compiler Design** _Swathmore College_    
...
- [CS 91](https://www.cs.swarthmore.edu/~jpolitz/cs91/s15/index.html) **Introduction to Programming Languages** _Swathmore College_   
...
- [CIS 194](http://www.seas.upenn.edu/~cis194/) **Introduction to Haskell** _Penn Engineering_   
...
- [CIS 198](http://cis198-2016s.github.io/) **Rust Programming** _UPenn_   
...
- [CMSC 430](http://www.cs.umd.edu/class/spring2015/cmsc430/) **Introduction to Compilers** _Univ of Maryland_   
...
- [Corsopl](https://pradella.faculty.polimi.it/PL.html) **Principles of Programming Languages** _Politecnico di Milano_  - Lecture Notes  - Readings 
...
- [COS 326](http://www.cs.princeton.edu/~dpw/courses/cos326-12/info.php) **Functional Programming** _Princeton University_   
...
- [CS 143](https://web.stanford.edu/class/cs143/) **Compiler construction** _Stanford University_   
...
- [CS 164](https://sites.google.com/a/bodik.org/cs164/home) **Hack your language!** _UC Berkeley_    
...
- [CS 173](http://cs.brown.edu/courses/cs173/2014/) **Programming Languages** _Brown University_   
...
- [CS 223](https://www.classes.cs.uchicago.edu/archive/2016/winter/22300-1/) **Purely Functional Data Structures In Elm** _University of Chicago_   
...
- [CS 240h](http://www.scs.stanford.edu/14sp-cs240h/) **Functional Systems in Haskell** _Stanford University_   
...
- [CS 421](https://courses.engr.illinois.edu/cs421/fa2014/) **Programming Languages and Compilers** _Univ of Illinois, Urbana-Champaign_    Course that uses OCaml to teach functional programming and programming language design. 
...
- [CS 3110](http://www.cs.cornell.edu/Courses/cs3110/2014fa/course_info.php) **Data Structures and Functional Programming** _Cornell University_   
...
- [CS 4120](http://www.cs.cornell.edu/courses/CS4120/2013fa/) **Introduction to Compilers** _Cornell University_    
...
- [CS 4400](https://pl.barzilay.org/) **Programming Languages** _Northeastern University_    
...
- [CS 4610](http://www.cs.virginia.edu/~weimer/4610/) **Programming Languages and Compilers** _University of Virginia_   
...
- [CS 5114](http://www.cs.cornell.edu/courses/CS5114/2013sp/index.php) **Network Programming Languages** _Cornell University_   
...
- [CS 5142](http://www.cs.cornell.edu/courses/CS5142/2013fa/) **Scripting Languages** _Cornell University_   
...
- [CS 5470](http://matt.might.net/teaching/compilers/spring-2015/) **Compilers** _University of Utah_    
...
- [CS 6118](http://www.cs.cornell.edu/courses/CS6118/2012fa/) **Types and Semantics** _Cornell University_   
...
- [CSC 253](http://pgbovine.net/cpython-internals.htm) **CPython internals: A ten-hour codewalk through the Python interpreter source code** _University of Rochester_   
- Nine lectures walking through the internals of CPython, the canonical Python interpreter implemented in C. They were from the _Dynamic Languages and Software Development_ course taught in Fall 2014 at the University of Rochester.
- [CSE 341](http://courses.cs.washington.edu/courses/cse341/16sp/) **Programming Languages** _University of Washington_    
...
- [CSE P 501](http://courses.cs.washington.edu/courses/csep501/09au/lectures/video.html) **Compiler Construction** _University of Washington_   
...
- [DMFP](http://cs.wheaton.edu/~tvandrun/dmfp/) **Discrete Mathematics and Functional Programming** _Wheaton College_   
...
- [PCPP](http://www.itu.dk/people/sestoft/itu/PCPP/E2015/) **Practical Concurrent and Parallel Programming** _IT University of Copenhagen_    
...
- [6.945](https://groups.csail.mit.edu/mac/users/gjs/6.945/index.html) **Adventures in Advanced Symbolic Programming** _MIT_    
...
- [CS 696](http://www.eli.sdsu.edu/courses/fall15/cs696/index.html) **Functional Design and Programming** _San Diego State University_    
...
- [L28](https://www.cl.cam.ac.uk/teaching/1516/L28/) **Advanced Functional Programming** _University of Cambridge_    
...
- [CS 61B](http://datastructur.es/sp16/) **Data Structures** _UC Berkeley_     
...
- [CS 97SI](http://web.stanford.edu/class/cs97si/) **Introduction to Competitive Programming** _Stanford University_   
...
- [CS 224](http://people.seas.harvard.edu/~minilek/cs224/fall14/index.html) **Advanced Algorithms** _Harvard University_    
...
- [CS 261](http://theory.stanford.edu/~tim/w16/w16.html) **A Second Course in Algorithms** _Stanford University_    
...
- [CS 473/573](http://jeffe.cs.illinois.edu/teaching/algorithms/) **Fundamental Algorithms** _Univ of Illinois, Urbana-Champaign_   
...
- [CS 2150](https://github.com/aaronbloomfield/pdr) **Program & Data Representation** _University of Virginia_   
...
- [CS 4820](http://www.cs.cornell.edu/courses/CS4820/2015sp/) **Introduction to Analysis of Algorithms** _Cornell University_    
...
- [CSCI 104](http://www-scf.usc.edu/~csci104/20142/lectures/) **Data Structures and Object Oriented Design**   _University of Southern California (USC)_ 
...
- [CSCI 135](http://compsci.hunter.cuny.edu/~sweiss/courses/csci135.php) **Software Design and Analysis I**   _CUNY Hunter College_ 
...
- [CSCI 235](http://compsci.hunter.cuny.edu/~sweiss/courses/csci235.php) **Software Design and Analysis II** _CUNY Hunter College_   
...
- [CSCI 335](http://compsci.hunter.cuny.edu/~sweiss/courses/csci335.php) **Software Design and Analysis III**   _CUNY Hunter College_ 
...
- [CSE 331](http://courses.cs.washington.edu/courses/cse331/15sp/) **Software Design and Implementation** _University of Washington_   
...
- [CSE 373](http://www3.cs.stonybrook.edu/~skiena/373/) **Analysis of Algorithms** _Stony Brook University_     
...
- [ECS 122A](http://web.cs.ucdavis.edu/~gusfield/cs122f10/) **Algorithm Design and Analysis** _UC Davis_    
...
- [ECS 222A](http://web.cs.ucdavis.edu/~gusfield/cs222w11/) **Graduate Level Algorithm Design and Analysis** _UC Davis_    
...
- [6.INT](https://courses.csail.mit.edu/iap/interview/index.php) **Hacking a Google Interview** _MIT_  
...
- [6.006](https://ocw.mit.edu/courses/electrical-engineering-and-computer-science/6-006-introduction-to-algorithms-fall-2011/index.htm) **Introduction to Algorithms** _MIT_    
...
- [6.046J/18.410J](http://ocw.mit.edu/courses/electrical-engineering-and-computer-science/6-046j-design-and-analysis-of-algorithms-spring-2015/index.htm) **Design and Analysis of Algorithms** _MIT_     
...
- [6.851](https://courses.csail.mit.edu/6.851/spring21/index.html) **Advanced Data Structures** _MIT_    
...
- [6.854/18.415J](https://courses.csail.mit.edu/6.854/current/) **Advanced Algorithms** _MIT_    
...
- [6.854J/18.415J](http://ocw.mit.edu/courses/electrical-engineering-and-computer-science/6-854j-advanced-algorithms-fall-2005/index.htm) **Advanced Algorithms** _MIT_    
...
- [15-451/651](http://www.cs.cmu.edu/afs/cs/academic/class/15451-f10/www/) **Algorithms** _Carnegie Mellon University_  
...
- [16s-4102](http://www.cs.virginia.edu/~shelat/16s-4102/) **Algorithms** _University of Virginia_   
...
- [CIS 500](http://www.seas.upenn.edu/~cis500/cis500-f14/index.html) **Software Foundations** _University of Pennsylvania_   
...
- [CS 103](http://web.stanford.edu/class/cs103/) **Mathematical Foundations of Computing** _Stanford University_   
...
- [CS 276](http://www.cs.berkeley.edu/~sanjamg/classes/cs276-fall14/) **Foundations of Cryptography** _UC Berkeley_  
...
- [CS 278](http://www.cs.berkeley.edu/~luca/cs278-08/) **Complexity Theory** _UC Berkeley_  
...
- [CS 3110](http://www.cs.cornell.edu/courses/CS3110/2014fa/) **Data Structures and Functional Programming** _Cornell University_    
...
- [CS 3220](http://www.cs.cornell.edu/~bindel/class/cs3220-s12/) **Introduction to Scientific Computing** _Cornell University_    
...
- [CS 4300](http://www.cs.cornell.edu/courses/CS4300/2013fa/) **Information Retrieval** _Cornell University_    
...
- [CS 4810](https://www.dsteurer.org/toc13/) **Introduction to Theory of Computing** _Cornell University_    
...
- [CS 6810](https://complexity16.dsteurer.org/) **Theory of Computing** _Cornell University_    
...
- [CSCE 3193](http://www.csce.uark.edu/~sgauch/3193/S11/index.html) **Programming Paradigms** _University of Arkansas (Fayetteville)_   
...
- [6.045](https://stellar.mit.edu/S/course/6/sp15/6.045/index.html) **Great Ideas in Theoretical Computer Science** _MIT_    
...
- [CS 10](https://inst.eecs.berkeley.edu/~cs10/fa14/) **The Beauty and Joy of Computing** _UC Berkeley_    
...
- [CS 50](https://cs50.harvard.edu/) **Introduction to Computer Science** _Harvard University_    
...
- [CS 61A](http://cs61a.org/) **Structure and Interpretation of Computer Programs [Python]** _UC Berkeley_    
...
- [CS 61AS](http://berkeley-cs61as.github.io/) **Structure & Interpretation of Computer Programs [Racket]** _UC Berkeley_    
...
- [CS 101](http://online.stanford.edu/course/computer-science-101-self-paced) **Computer Science 101** _Stanford University_    
...
- [CS 106A](https://see.stanford.edu/Course/CS106A) **Programming Methodology** _Stanford University_    
...
- [CS 106B](https://see.stanford.edu/Course/CS106B) **Programming Abstractions** _Stanford University_    
...
- [CS 107](https://see.stanford.edu/Course/CS107) **Programming Paradigms** _Stanford University_    
...
- [CS 109](http://otfried.org/courses/cs109/index.html) **Programming Practice Using Scala** _KAIST_   
...
- [Lectures] ([http://otfried.org/courses/cs109/index.html](http://otfried.org/courses/cs109/index.html))
- [Assignments] ([http://otfried.org/courses/cs109/index.html](http://otfried.org/courses/cs109/index.html))
- [CS 1109](http://www.cs.cornell.edu/courses/CS1109/2013su/) **Fundamental Programming Concepts** _Cornell University_   
...
- [CS 1110](http://www.cs.cornell.edu/courses/CS1110/2014fa/) **Introduction to Computing Using Python** _Cornell University_    
...
- [CS 1112](http://www.cs.cornell.edu/courses/CS1112/2014fa/) **Introduction to Computing Using Matlab** _Cornell University_    
...
- [CS 1115](http://www.cs.cornell.edu/courses/CS1115/2013fa/) **Introduction to Computational Science and Engineering Using Matlab Graphical User Interfaces** _Cornell University_    
- Programming and problem solving using MATLAB. Emphasizes the systematic development of algorithms and programs. Topics include iteration, functions, arrays and vectors, strings, recursion, algorithms, object-oriented programming, and MATLAB graphics. Assignments are designed to build an appreciation for complexity, dimension, fuzzy data, inexact arithmetic, randomness, simulation, and the role of approximation. NO programming experience is necessary; some knowledge of Calculus is required.
...
- [CS 1130](http://www.cs.cornell.edu/courses/CS1130/2014sp/) **Transition to OO Programming** _Cornell University_    
...
- [CS 1133](http://www.cs.cornell.edu/courses/CS1133/2013fa/) **Transition to Python** _Cornell University_    
...
- [CS 1410-2](http://www.eng.utah.edu/~cs1410-20/) and [CS2420-20](http://www.eng.utah.edu/~cs2420-20/) **Computer Science I and II for Hackers** _University of Utah_    
...
- [CS 2110](http://www.cs.cornell.edu/courses/CS2110/2014fa/index.html) **Object-Oriented Programming and Data Structures** _Cornell University_    
...
- [CS 4302](http://courses2.cit.cornell.edu/info4302_2012fa/) **Web Information Systems** _Cornell University_    
...
- [CSCE 2004](http://www.csce.uark.edu/~sgauch/2004/S14/index.html) **Programming Foundations I** _University of Arkansas (Fayetteville)_    
...
- [CSCI E-1](http://cse1.net/lectures) **Understanding Computers and the Internet** _Harvard University Extension College_    
...
- [CS-for-all](http://www.cs.hmc.edu/csforall/) **CS for All** _Harvey Mudd College_    
...
- [6.001](http://ocw.mit.edu/courses/electrical-engineering-and-computer-science/6-001-structure-and-interpretation-of-computer-programs-spring-2005/index.htm) **Structure and Interpretation of Computer Programs** _MIT_    
...
- [6.005](http://web.mit.edu/6.005/www/fa16/) **Software Construction, Fall 2016** _MIT_   
...
- [DEEPNLP](https://github.com/oxford-cs-deepnlp-2017/) **Deep Learning for Natural Language Processing** _University of Oxford_   
...
- [CS20si](http://web.stanford.edu/class/cs20si/index.html) **Tensorflow for Deep Learning Research** _Stanford University_   
...
- [COMS 4771](http://www.cs.columbia.edu/~jebara/4771/index.html) **Machine Learning** _Columbia University_   
...
- [CS 109](http://cs109.github.io/2015/) **Data Science** _Harvard University_    
...
- [2013 Lectures](http://cm.dce.harvard.edu/2014/01/14328/publicationListing.shtml) _(slightly better)_
- [CS 156](https://work.caltech.edu/telecourse.html) **Learning from Data** _Caltech_     
...
- [CS 189](http://www.eecs189.org/) **Introduction To Machine Learning** _UC Berkeley_   
...
- [CS 224d](http://cs224d.stanford.edu/) **Deep Learning for Natural Language Processing** _Stanford University_    
...
- [CS 229r](http://people.seas.harvard.edu/~minilek/cs229r/fall15/index.html) **Algorithms for Big Data** _Harvard University_    
...
- [CS 231n](http://cs231n.stanford.edu/) **Convolutional Neural Networks for Visual Recognition** _Stanford University_    
...
- [CS 287](http://www.cs.berkeley.edu/~pabbeel/cs287-fa13/) **Advanced Robotics** _UC Berkeley_   
...
- [CS 395T](http://www.nr.com/CS395T/) **Statistical and Discrete Methods for Scientific Computing** _University of Texas_    
...
- [CS 4780](http://www.cs.cornell.edu/courses/CS4780/2014fa/) **Machine Learning** _Cornell University_   
- This course will introduce you to technologies for building data-centric information systems on the World Wide Web, show the practical applications of such systems, and discuss their design and their social and policy context by examining cross-cutting issues such as citizen science, data journalism and open government. Course work involves lectures and readings as well as weekly homework assignments, and a semester-long project in which the students demonstrate their expertise in building data-centric Web information systems.
- [Syllabus](http://www.cs.cornell.edu/courses/CS4780/2014fa/)
- [Lectures](http://www.cs.cornell.edu/courses/CS4780/2014fa/)
- [CS 4786](http://www.cs.cornell.edu/courses/CS4786/2015sp/index.htm) **Machine Learning for Data Science** _Cornell University_    
...
- [CVX 101](https://class.stanford.edu/courses/Engineering/CVX101/Winter2014/info) **Convex Optimization** _Stanford University_    
...
- [DS-GA 1008](http://cilvr.cs.nyu.edu/doku.php?id=deeplearning2015%3Aschedule) **Deep Learning** _New York University_    
...
- [Course Page](http://cilvr.cs.nyu.edu/doku.php?id=deeplearning2015%3Aschedule)
- [Recorded Lectures](http://techtalks.tv/deep-learning-nyu-spring-2015/)
- [EECS E6893 & EECS E6895](http://www.ee.columbia.edu/~cylin/course/bigdata/) **Big Data Analytics & Advanced Big Data Analytics** _Columbia University_    
...
- [EECS E6894](http://llcao.net/cu-deeplearning15/index.html) **Deep Learning for Computer Vision and Natural Language Processing** _Columbia University_    
...
- [EE103](http://stanford.edu/class/ee103/) **Introduction to Matrix Methods** _Stanford University_    
...
- [Fast.ai Introduction to Machine Learning for Coders](http://course.fast.ai/ml.html) _Fast.ai / University of San Francisco_     
...
- [Info 290](http://www.ischool.berkeley.edu/courses/i290-abdt) **Analyzing Big Data with Twitter** _UC Berkeley school of information_  
...
- [Machine Learning: 2014-2015](https://www.cs.ox.ac.uk/people/nando.defreitas/machinelearning/) _University of Oxford_    
...
- [StatLearning](https://lagunita.stanford.edu/courses/HumanitiesandScience/StatLearning/Winter2015/about) **Intro to Statistical Learning** _Stanford University_     
...
- [10-601](http://www.cs.cmu.edu/~ninamf/courses/601sp15/) **Machine Learning** _Carnegie Mellon University_     
...
- [10-708](http://www.cs.cmu.edu/~epxing/Class/10708-14/index.html) **Probabilistic Graphical Models** _Carnegie Mellon University_     
...
- [11-785](http://deeplearning.cs.cmu.edu/) **Deep Learning** _Carnegie Mellon University_   
- The course presents the subject through a series of seminars and labs, which will explore it from its early beginnings, and work themselves to some of the state of the art. The seminars will cover the basics of deep learning and the underlying theory, as well as the breadth of application areas to which it has been applied, as well as the latest issues on learning from very large amounts of data. We will concentrate largely, although not entirely, on the connectionist architectures that are most commonly associated with it. _Lectures_ and _Reading Notes_ are available on the page.
- [CS246](http://web.stanford.edu/class/cs246/) **Mining Massive Data Sets** _Stanford University_     
...
- [CS276](http://web.stanford.edu/class/cs276/index.html) **Information Retrieval and Web Search** _Stanford University_   
...
- [Practical_RL](https://github.com/yandexdataschool/Practical_RL) **Reinforcement Learning in the Wild** _Yandex SDA_     
...
- [UvA DEEP LEARNING](http://uvadlc.github.io/) **UvA Deep Learning Course** _University of Amsterdam_     
...
- [CIS 4930 / CIS 5930](http://www.cs.fsu.edu/~redwood/OffensiveComputerSecurity/) **Offensive Computer Security** _Florida State University_    
...
- [CS 155](https://crypto.stanford.edu/cs155/) **Computer and Network Security** _Stanford_   
...
- [CS 161](http://www-inst.eecs.berkeley.edu/~cs161/sp15/) **Computer Security** _UC Berkeley_  
...
- [CS 259](https://courseware.stanford.edu/pg/courses/331628/cs259-winter-2013) **Security Modeling and Analysis** _Stanford_    
...
- [CS 261](http://www.icir.org/vern/cs261n-Sp14/) **Internet/Network Security** _UC Berkeley_   
...
- [CS 5430](http://www.cs.cornell.edu/courses/CS5430/2013sp/) **System Security** _Cornell University_    
...
- [CSCI 4968](https://github.com/RPISEC/MBE) **Modern Binary Exploitation** _Rensselaer Polytechnic Institute_   
...
- [CSCI 4976](https://github.com/RPISEC/Malware) **Malware Analysis** _Rensselaer Polytechnic Institute_   
- This repository contains the materials as developed and used by [RPISEC](http://rpis.ec/) to teach Malware Analysis at [Rensselaer Polytechnic Institute](http://rpi.edu/) in Fall 2015. This was a university course developed and run solely by students, primarily using the
- [EECS 588](https://www.eecs.umich.edu/courses/eecs588/) **Computer & Network Security** _University of Michigan_   
...
- [Readings](https://www.eecs.umich.edu/courses/eecs588/readings.html) [Practical Malware Analysis](http://www.amazon.com/Practical-Malware-Analysis-Dissecting-Malicious/dp/1593272901) book by Michael Sikorski and Andrew Honig, to teach skills in reverse engineering, malicious behaviour, malware, and anti-analysis techniques.
...
- [18-636](https://courseware.stanford.edu/pg/courses/334553/18636-spring-2013) **Browser Security** _Stanford_   
...
- [CS 188](http://ai.berkeley.edu/home.html) **Introduction to Artificial Intelligence** _UC Berkeley_    
...
- [CS 4700](http://www.cs.cornell.edu/courses/CS4700/2014fa/) **Foundations of Artificial Intelligence** _Cornell University_   
...
- [CS 6700](http://www.cs.cornell.edu/courses/CS6700/2013sp/) **Advanced Artificial Intelligence** _Cornell University_   
...
- [6.868J](http://ocw.mit.edu/courses/electrical-engineering-and-computer-science/6-868j-the-society-of-mind-fall-2011/index.htm) **The Society of Mind** _MIT_    
...
- [CAP 5415](http://crcv.ucf.edu/courses/CAP5415/) **Computer Vision** _University of Central Florida_    
...
- [CIS 581](https://alliance.seas.upenn.edu/~cis581/wiki/index.php?title=CIS_581%3A_Computer_Vision_%26_Computational_Photography) **Computer Vision and Computational Photography** _University of Pennsylvania_   
...
- [CMU 462](http://15462.courses.cs.cmu.edu/fall2015) **Computer Graphics** _Carnegie Mellon University_    
...
- [CS 378](https://github.com/ut-cs378-vision-2014fall/course-info) **3D Reconstruction with Computer Vision** _UTexas_   
...
- [CS 4620](http://www.cs.cornell.edu/Courses/CS4620/2014fa/index.shtml#) **Introduction to Computer Graphics** _Cornell University_    
...
- [CS 4670](http://www.cs.cornell.edu/courses/CS4670/2015sp/) **Introduction to Computer Vision** _Cornell University_    
- This course will provide an introduction to computer vision, with topics including image formation, feature detection, motion estimation, image mosaics, 3D shape reconstruction, and object and face detection and recognition. Applications of these techniques include building 3D maps, creating virtual characters, organizing photo and video databases, human computer interaction, video surveillance, automatic vehicle navigation, and mobile computer vision. This is a project-based course, in which you will implement several computer vision algorithms throughout the semester.
...
- [CS 6670](https://canvas.instructure.com/courses/904706) **Computer Vision** _Cornell University_   
...
- [CSCI 1230](http://cs.brown.edu/courses/csci1230/index.html) **Introduction to Computer Graphics** _Brown University_   
...
- [CSCI-GA.2270-001](https://mrl.nyu.edu/~perlin/courses/fall2015/) **Graduate Computer Graphics** _New York University_    
...
- [AM 207](http://am207.github.io/2016/index.html) **Monte Carlo Methods and Stochastic Optimization** _Harvard University_    
...
- [CS 75](http://ocw.tufts.edu/Course/75) **Introduction to Game Development** _Tufts University_   
...
- [CS 50](https://cs50.github.io/games/) **Intro to Game Developement** _Harvard University_    
...
- [CS 100](https://github.com/mikeizbicki/ucr-cs100) **Open Source Software Construction** _UC Riverside_   
...
- [CS 108](http://web.stanford.edu/class/archive/cs/cs108/cs108.1092/) **Object Oriented System Design** _Stanford_   
...
- [CS 168](https://inst.eecs.berkeley.edu/~cs168/fa15/) **Computer Networks** _UC Berkeley_   
...
- [CS 193a](http://web.stanford.edu/class/cs193a/lectures.shtml) **Android App Development, Spring 2016** _Stanford University_    
...
- [CS 193p](https://itunes.apple.com/us/course/developing-ios-7-apps-for/id733644550) **Developing Applications for iOS** _Stanford University_    
...
- [CS 223A](https://see.stanford.edu/Course/CS223A) **Introduction to Robotics** _Stanford University_    
- The purpose of this course is to introduce you to basics of modeling, design, planning, and control of robot systems. In essence, the material treated in this course is a brief survey of relevant results from geometry, kinematics, statics, dynamics, and control.
- [CS 262a](http://www.cs.berkeley.edu/~brewer/cs262/) **Advanced Topics in Computer Systems** _UC Berkeley_   
...
- [CS 294](http://inst.eecs.berkeley.edu/~cs294-101/sp15/) **Cutting-edge Web Technologies** _Berkeley_    
...
- [CS 411](http://video.bilkent.edu.tr/course_videos.php?courseid=10) **Software Architecture Design** _Bilkent University_  
...
- [CS 3152](http://www.cs.cornell.edu/courses/CS3152/2014sp/) **Introduction to Computer Game Development** _Cornell University_    
...
- [CS 4152](http://www.cs.cornell.edu/courses/CS4152/2014sp/) **Advanced Topics in Computer Game Development** _Cornell University_    
...
- [CS 4154](http://www.cs.cornell.edu/courses/CS4154/2014fa/) **Analytics-driven Game Design** _Cornell University_    
...
- [CS 4812](https://courses.cit.cornell.edu/physics4481-7681_2018fa/) **Quantum Information Processing** _Cornell University_   
...
- [CS 4860](http://www.cs.cornell.edu/courses/CS4860/2012fa/) **Applied Logic** _Cornell University_   
...
- [CS 5150](http://www.cs.cornell.edu/courses/CS5150/2014fa/overview.html) **Software Engineering** _Cornell University_    
...
- [CS 5220](http://www.cs.cornell.edu/~bindel/class/cs5220-f11/) **Applications of Parallel Computers** _Cornell University_    
...
- [CS 5540](https://sites.google.com/site/cs5540sp2013/) **Computational Techniques for Analyzing Clinical Data** _Cornell University_    
...
- [CS 5724](http://courses2.cit.cornell.edu/cs5724/) **Evolutionary Computation** _Cornell University_   
...
- [CS 6452](http://www.cs.cornell.edu/courses/CS6452/2012sp/index.php) **Datacenter Networks and Services** _Cornell University_  
...
- [CS 6630](http://www.cs.cornell.edu/courses/CS6630/2012sp/about.stm) **Realistic Image Synthesis** _Cornell University_    
...
- [CS 6640](http://www.cs.cornell.edu/courses/CS6640/2012fa/index.shtml#) **Computational Photography** _Cornell University_   
...
- [CS 6650](http://www.cs.cornell.edu/courses/CS6650/2013fa/) **Computational Motion** _Cornell University_  
...
- [CS 6840](http://www.cs.cornell.edu/courses/CS6840/2014sp/) **Algorithmic Game Theory** _Cornell University_    
...
- [CSE 154](http://courses.cs.washington.edu/courses/cse154/14au/) **Web Programming** _University of Washington_   
...
- [ESM 296-4F](http://ucsb-bren.github.io/esm296-4f/) **GIS & Spatial Analysis** _UC Santa Barbara_   
...
- [ICS 314](http://philipmjohnson.github.io/ics314f13/) **Software Engineering** _University of Hawaii_    
...
- [IGME 582](http://hfoss-fossrit.rhcloud.com/) **Humanitarian Free & Open Source Software Development** _Rochester Institute of Technology_   
...
- [I485 / H400](http://www.informatics.indiana.edu/rocha/i-bic/) **Biologically Inspired Computation** _Indiana University_   
...
- [Open Sourced Elective: Database and Rails](http://www.schneems.com/ut-rails/) **Intro to Ruby on Rails** _University of Texas_    
...
- [SCICOMP](http://mlecture.uni-bremen.de/ml/index.php?option=com_content&view=article&id=233) **An Introduction to Efficient Scientific Computation** _Universität Bremen_  
...
- [14-740](http://www.ini740.rocks/F20) **Fundamentals of Computer Networks** _CMU_     
...
[STAT 340](https://andrewpbray.github.io/reg/index.html) **Applied Regression Methods** _Smith College_
