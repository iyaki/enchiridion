---
title: "addyosmani/gemini-cli-tips: Gemini CLI Tips and Tricks"
notion_id: 2cd54f1c-7d23-818f-b2ca-fc784aa575dc
notion_url: https://app.notion.com/p/addyosmani-gemini-cli-tips-Gemini-CLI-Tips-and-Tricks-2cd54f1c7d23818fb2cafc784aa575dc
last_edited: 2025-12-18T01:22:00.000Z
source_url: https://github.com/addyosmani/gemini-cli-tips?tab=readme-ov-file#additional-fun-corgi-mode-easter-egg-
tags: ["English", "Programming", "DevOps", "Automation", "Tools", "Tool", "Guide", "GitHub"]
---
...
- [Getting Started](https://github.com/addyosmani/gemini-cli-tips?tab=readme-ov-file#getting-started)
- [Tip 1: Use ](https://github.com/addyosmani/gemini-cli-tips?tab=readme-ov-file#tip-1-use-geminimd-for-persistent-context)[`GEMINI.md`](https://github.com/addyosmani/gemini-cli-tips?tab=readme-ov-file#tip-1-use-geminimd-for-persistent-context)[ for Persistent Context](https://github.com/addyosmani/gemini-cli-tips?tab=readme-ov-file#tip-1-use-geminimd-for-persistent-context)
- [Tip 2: Create Custom Slash Commands](https://github.com/addyosmani/gemini-cli-tips?tab=readme-ov-file#tip-2-create-custom-slash-commands)
- [Tip 3: Extend Gemini with Your Own ](https://github.com/addyosmani/gemini-cli-tips?tab=readme-ov-file#tip-3-extend-gemini-with-your-own-mcp-servers)[`MCP`](https://github.com/addyosmani/gemini-cli-tips?tab=readme-ov-file#tip-3-extend-gemini-with-your-own-mcp-servers)[ Servers](https://github.com/addyosmani/gemini-cli-tips?tab=readme-ov-file#tip-3-extend-gemini-with-your-own-mcp-servers)
- [Tip 4: Leverage Memory Addition & Recall](https://github.com/addyosmani/gemini-cli-tips?tab=readme-ov-file#tip-4-leverage-memory-addition--recall)
- [Tip 5: Use Checkpointing and ](https://github.com/addyosmani/gemini-cli-tips?tab=readme-ov-file#tip-5-use-checkpointing-and-restore-as-an-undo-button)[`/restore`](https://github.com/addyosmani/gemini-cli-tips?tab=readme-ov-file#tip-5-use-checkpointing-and-restore-as-an-undo-button)[ as an Undo Button](https://github.com/addyosmani/gemini-cli-tips?tab=readme-ov-file#tip-5-use-checkpointing-and-restore-as-an-undo-button)
- [Tip 6: Read Google Docs, Sheets, and More.](https://github.com/addyosmani/gemini-cli-tips?tab=readme-ov-file#tip-6-read-google-docs-sheets-and-more-with-a-workspace-mcp-server-configured-you-can-paste-a-docssheets-link-and-have-the-mcp-fetch-it-subject-to-permissions)
- [Tip 7: Reference Files and Images with ](https://github.com/addyosmani/gemini-cli-tips?tab=readme-ov-file#tip-7-reference-files-and-images-with--for-explicit-context)[`@`](https://github.com/addyosmani/gemini-cli-tips?tab=readme-ov-file#tip-7-reference-files-and-images-with--for-explicit-context)[ for Explicit Context](https://github.com/addyosmani/gemini-cli-tips?tab=readme-ov-file#tip-7-reference-files-and-images-with--for-explicit-context)
- [Tip 8: On-the-Fly Tool Creation (Have Gemini Build Helpers)](https://github.com/addyosmani/gemini-cli-tips?tab=readme-ov-file#tip-8-on-the-fly-tool-creation-have-gemini-build-helpers)
- [Tip 9: Use Gemini CLI for System Troubleshooting & Configuration](https://github.com/addyosmani/gemini-cli-tips?tab=readme-ov-file#tip-9-use-gemini-cli-for-system-troubleshooting--configuration)
- [Tip 10: YOLO Mode - Auto-Approve Tool Actions (Use with Caution)](https://github.com/addyosmani/gemini-cli-tips?tab=readme-ov-file#tip-10-yolo-mode---auto-approve-tool-actions-use-with-caution)
- [Tip 11: Headless & Scripting Mode (Run Gemini CLI in the Background)](https://github.com/addyosmani/gemini-cli-tips?tab=readme-ov-file#tip-11-headless--scripting-mode-run-gemini-cli-in-the-background)
- [Tip 12: Save and Resume Chat Sessions](https://github.com/addyosmani/gemini-cli-tips?tab=readme-ov-file#tip-12-save-and-resume-chat-sessions)
- [Tip 13: Multi-Directory Workspace - One Gemini, Many Folders](https://github.com/addyosmani/gemini-cli-tips?tab=readme-ov-file#tip-13-multi-directory-workspace---one-gemini-many-folders)
- [Tip 14: Organize and Clean Up Your Files with AI Assistance](https://github.com/addyosmani/gemini-cli-tips?tab=readme-ov-file#tip-14-organize-and-clean-up-your-files-with-ai-assistance)
- [Tip 15: Compress Long Conversations to Stay Within Context](https://github.com/addyosmani/gemini-cli-tips?tab=readme-ov-file#tip-15-compress-long-conversations-to-stay-within-context)
- [Tip 16: Passthrough Shell Commands with ](https://github.com/addyosmani/gemini-cli-tips?tab=readme-ov-file#tip-16-passthrough-shell-commands-with--talk-to-your-terminal)[`!`](https://github.com/addyosmani/gemini-cli-tips?tab=readme-ov-file#tip-16-passthrough-shell-commands-with--talk-to-your-terminal)[ (Talk to Your Terminal)](https://github.com/addyosmani/gemini-cli-tips?tab=readme-ov-file#tip-16-passthrough-shell-commands-with--talk-to-your-terminal)
- [Tip 17: Treat Every CLI Tool as a Potential Gemini Tool](https://github.com/addyosmani/gemini-cli-tips?tab=readme-ov-file#tip-17-treat-every-cli-tool-as-a-potential-gemini-tool)
- [Tip 18: Utilize Multimodal AI - Let Gemini See Images and More](https://github.com/addyosmani/gemini-cli-tips?tab=readme-ov-file#tip-18-utilize-multimodal-ai---let-gemini-see-images-and-more)
- [Tip 19: Customize the ](https://github.com/addyosmani/gemini-cli-tips?tab=readme-ov-file#tip-19-customize-the-path-and-tool-availability-for-stability)[`$PATH`](https://github.com/addyosmani/gemini-cli-tips?tab=readme-ov-file#tip-19-customize-the-path-and-tool-availability-for-stability)[ (and Tool Availability) for Stability](https://github.com/addyosmani/gemini-cli-tips?tab=readme-ov-file#tip-19-customize-the-path-and-tool-availability-for-stability)
- [Tip 20: Track and reduce token spend with token caching and stats](https://github.com/addyosmani/gemini-cli-tips?tab=readme-ov-file#tip-20-track-and-reduce-token-spend-with-token-caching-and-stats)
- [Tip 21: Use ](https://github.com/addyosmani/gemini-cli-tips?tab=readme-ov-file#tip-21-use-copy-for-quick-clipboard-copy)[`/copy`](https://github.com/addyosmani/gemini-cli-tips?tab=readme-ov-file#tip-21-use-copy-for-quick-clipboard-copy)[ for Quick Clipboard Copy](https://github.com/addyosmani/gemini-cli-tips?tab=readme-ov-file#tip-21-use-copy-for-quick-clipboard-copy)
- [Tip 22: Master ](https://github.com/addyosmani/gemini-cli-tips?tab=readme-ov-file#tip-22-master-ctrlc-for-shell-mode-and-exiting)[`Ctrl+C`](https://github.com/addyosmani/gemini-cli-tips?tab=readme-ov-file#tip-22-master-ctrlc-for-shell-mode-and-exiting)[ for Shell Mode and Exiting](https://github.com/addyosmani/gemini-cli-tips?tab=readme-ov-file#tip-22-master-ctrlc-for-shell-mode-and-exiting)
- [Tip 23: Customize Gemini CLI with ](https://github.com/addyosmani/gemini-cli-tips?tab=readme-ov-file#tip-23-customize-gemini-cli-with-settingsjson)[`settings.json`](https://github.com/addyosmani/gemini-cli-tips?tab=readme-ov-file#tip-23-customize-gemini-cli-with-settingsjson)
- [Tip 24: Leverage IDE Integration (VS Code) for Context & Diffs](https://github.com/addyosmani/gemini-cli-tips?tab=readme-ov-file#tip-24-leverage-ide-integration-vs-code-for-context--diffs)
- [Tip 25: Automate Repo Tasks with ](https://github.com/addyosmani/gemini-cli-tips?tab=readme-ov-file#tip-25-automate-repo-tasks-with-gemini-cli-github-action)[`Gemini CLI GitHub Action`](https://github.com/addyosmani/gemini-cli-tips?tab=readme-ov-file#tip-25-automate-repo-tasks-with-gemini-cli-github-action)
- [Tip 26: Enable Telemetry for Insights and Observability](https://github.com/addyosmani/gemini-cli-tips?tab=readme-ov-file#tip-26-enable-telemetry-for-insights-and-observability)
- [Tip 27: Keep an Eye on the Roadmap (Background Agents & More)](https://github.com/addyosmani/gemini-cli-tips?tab=readme-ov-file#tip-27-keep-an-eye-on-the-roadmap-background-agents--more)
- [Tip 28: Extend Gemini CLI with ](https://github.com/addyosmani/gemini-cli-tips?tab=readme-ov-file#tip-28-extend-gemini-cli-with-extensions)[`Extensions`](https://github.com/addyosmani/gemini-cli-tips?tab=readme-ov-file#tip-28-extend-gemini-cli-with-extensions)
- [Tip 29: Corgi Mode Easter Egg 🐕](https://github.com/addyosmani/gemini-cli-tips?tab=readme-ov-file#additional-fun-corgi-mode-easter-egg-)
...
The AI might respond with a plan: e.g., _"Create folders: __`Images/`__, __`Videos/`__, __`Documents/`__, __`Archives/`__. Move __`X.png`__, __`Y.jpg`__ to __`Images/`__; move __`A.mp4`__ to __`Videos/`__; etc. The file __`temp.txt`__ looks unnecessary (maybe a temp file)."_
...
_(Rumor has it there might be other easter eggs or modes - who knows? Perhaps a "/partyparrot" or similar. The cheat sheet or help command lists __`/corgi`__, so it's not a secret, just underused. Now you're in on the joke!)_
