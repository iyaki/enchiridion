---
title: "The hierarchy of competence ・ Hardik Pandya"
notion_id: 3b754f1c-7d23-81f6-870f-c8da563a851a
...
This is where most people actually plateau, not at execution. They meet expectations, then repeat the same method for years, capped on output with no visible reason, because they’re still technically performing. Nobody flags it. There’s nothing to flag.
...
Read the nine stages again as the list of things your manager no longer has to do: check the work, question the method, coordinate the work, track the work, catch future risk, own outcomes, map downstream consequences, sequence effort, and define what matters. By the last one there’s a single item left, which is agreeing on where you’re both pointed.
