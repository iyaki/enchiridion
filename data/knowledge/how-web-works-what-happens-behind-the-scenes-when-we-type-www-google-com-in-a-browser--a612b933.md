---
title: "How web works: What happens behind the scenes when we type www.google.com in a browser?"
notion_id: a612b933-5ec6-46a9-9970-a205ed37abfa
...
tags: ["Web Development", "Network", "Book", "English"]
---
# How Web Works
...
- [Google's 'g' key is pressed](https://github.com/vasanthk/how-web-works/#googles-g-key-is-pressed)
- [When you hit 'Enter'](https://github.com/vasanthk/how-web-works/#when-you-hit-enter)
- [Parse the URL](https://github.com/vasanthk/how-web-works/#parse-the-url)
- [Check HSTS list (deprecated)](https://github.com/vasanthk/how-web-works/#check-hsts-list-deprecated)
- [DNS lookup](https://github.com/vasanthk/how-web-works/#dns-lookup)
- [Opening of a socket + TLS handshake](https://github.com/vasanthk/how-web-works/#opening-of-a-socket--tls-handshake)
- [HTTP protocol](https://github.com/vasanthk/how-web-works/#http-protocol)
- [HTTP Server Request Handle](https://github.com/vasanthk/how-web-works/#http-server-request-handle)
- [Server Response](https://github.com/vasanthk/how-web-works/#server-response)
- [Behind the scenes of the Browser](https://github.com/vasanthk/how-web-works/#behind-the-scenes-of-the-browser)
- [The browser's high level structure](https://github.com/vasanthk/how-web-works/#the-browsers-high-level-structure)
- [Rendering Engine](https://github.com/vasanthk/how-web-works/#rendering-engine)
- [The Main flow](https://github.com/vasanthk/how-web-works/#the-main-flow)
- [Parsing Basics](https://github.com/vasanthk/how-web-works/#parsing-basics)
- [DOM Tree](https://github.com/vasanthk/how-web-works/#dom-tree) 
- [Why is the DOM slow?](https://github.com/vasanthk/how-web-works/#why-is-the-dom-slow)
- [Render Tree](https://github.com/vasanthk/how-web-works/#render-tree)
- [Render tree's relation to the DOM tree](https://github.com/vasanthk/how-web-works/#render-trees-relation-to-the-dom-tree)
- [CSS Parsing](https://github.com/vasanthk/how-web-works/#css-parsing)
- [Layout](https://github.com/vasanthk/how-web-works/#layout)
- [Painting](https://github.com/vasanthk/how-web-works/#painting)
- [Trivia](https://github.com/vasanthk/how-web-works/#trivia) 
- [The birth of the web](https://github.com/vasanthk/how-web-works/#the-birth-of-the-web)
...
**Browser Engine:** [Marshals](http://stackoverflow.com/a/5600887/1672655) actions between the UI and the rendering engine.
...
**Tokenizing:** the browser converts strings of characters into distinct tokens specified by the W3C HTML5 standard - e.g. “”, “” and other strings within the “angle brackets”. Each token has a special meaning and a set of rules.
