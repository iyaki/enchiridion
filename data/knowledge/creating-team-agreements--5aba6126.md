---
title: "Creating Team Agreements"
notion_id: 5aba6126-3ee0-4bea-ac0c-bb41047a09af
...
Team Perspective IssuesManager Perspective IssuesI work from an area with such poor network coverage. How can I be expected to keep my video on?His video is always switched off. I have no idea what you are doing.I didn’t work on that task as I had no access to the data!Team members just grab any task without even informing.If you had told me this was urgent, I would have responded in 1 hour instead of a day!I’d asked for her feedback about an issue over email. They don’t check email! They can’t expect me to write that again on Slack!Oh! I didn’t know there were core working hours for our team!Not everyone is reachable during the core working hours!I wasn’t aware whether you were in the office. How could I be expected to keep track of your timezones?I wasn’t aware whether you were in the office. How could I be expected to keep track of your timezones?

These issues came as no surprise to me. There’s bound to be misalignment – until we do something about it.

The traditional approach:

1. The manager creates a set of rules that the teams must follow.
2. The manager calls a meeting and shares the rules to be followed.
3. The rules are printed and stuck to team members’ desks.
4. The team must now follow the rules.
...
Benefits of having a Team Agreement in place
...
Team Agreements are sometimes calles Team Manifesto or Team Contracts

## How can you create your Team Agreement? A Team Agreement Co-Creation Workshop

### Before the team agreement creation workshop:

1. Introduce the concept of team agreement to all participants.
2. Identify an independent facilitator.

### During the team agreement creation workshop:

1. Check-in with an ice-breaker.
2. Individual brainstorming.
3. Present your responses.
4. Questions meant only to deepen understanding of each other’s responses.
5. Consolidate and group responses.
6. Review final agreement.
7. Sign agreement.

You may want to use this team agreement template:

Discover the Team Agreement Canvas

### After the team agreement creation workshop:

1. Visually radiate the team agreement.
2. Refer back to the team agreement whenever a misunderstanding occurs.
3. If new team members join your team, Introduce them to your team’s way of working using this team agreement, Gather their feedback, Agree to any required updates as a team, Review the updated agreement, Sign the agreement, Visually radiate the updated team agreement.
4. Agree on a regular frequency to revisit your team agreement.

You don’t have to sign your new team agreement with blood, but what about taking a team picture with all thumbs up?
...
## Summing up: Creating a Team Agreement

It takes a lot of effort to create alignment. For teams to be successful, they need to feel accountable. Telling them so is not going to get them to own up to it. Give them the space they need to co-create and continuously evolve their way of working. A team agreement is a great place to start for any team!

> If you want to go fast, go alone. If you want to go far, go together. African Proverb

Team agreements are something that I was introduced to when I first started working with Scrum teams in the early 2000s. We called them the ‘Team’s working agreement.’ I have been coaching teams on the value that Team agreements bring. I continue to meet individuals from other organizations such as Thouhgtworks, Nordea, and Deutsche Bank and work with communities that share with me their perspectives on the value of Team agreements. A special mention to two of my colleagues and friends, Lisette Sutherland from Collaboration Superpowers and Rajesh Tamhane from Thoughtworks, who have inspired me on Team agreements in the remote working context.
