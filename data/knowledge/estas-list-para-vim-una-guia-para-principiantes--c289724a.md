...
notion_id: c289724a-9527-4193-a008-0a60da7c85f4
notion_url: https://app.notion.com/p/Est-s-list-para-Vim-Una-gu-a-para-principiantes-c289724a95274193a0080a60da7c85f4
last_edited: 2023-04-25T14:08:00.000Z
source_url: https://sysarmy.com/blog/posts/vim-para-principiantes/
tags: ["Sysarmy Blog", "Español", "Programming", "Linux", "SysAdmin", "IDE/Extendable Text Editor", "Article"]
---
[https://sysarmy.com/blog/posts/vim-para-principiantes/](https://sysarmy.com/blog/posts/vim-para-principiantes/)

February 1, 2022 — 22 minutos de lectura aprox.
...
> Ayuda en Vim:help helphelp (Ayuda para las páginas de ayuda):help vim-modes (Modos de vim):help insert.txt (Modo insertar):help visual.txt (Modo visual):help cmdline.txt (Modo línea de comandos):help write-quit (Guardar y salir de Vim):help ex-cmd-index (Índice de comandos Ex)
...
> Ayuda en Vim:help search-commands (Patrones de búsqueda):help undo-redo (Ayuda para comandos Deshacer y Rehacer)
...
> Ayuda en Vim:help cursor-motions (Movimientos del cursor):help left-right-motions (Movimientos horizontales):help up-down-motions (Movimientos verticales):help scrolling (Scrollear el documento)
...
> Ayuda en Vim:help operator (Ayuda sobre operadores):help text-objects (Ayuda sobre objetos de texto)
...
> Ayuda en Vim:help options (Ayuda sobre las opciones):help option-list (Listado de opciones)
...
- La versión original de este post se puede encontrar en The Valuable Dev (inglés).
- Traducción por @nachichuri, revisión por @jedux.
