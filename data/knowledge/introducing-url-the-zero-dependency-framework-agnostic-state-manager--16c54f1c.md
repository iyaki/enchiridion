---
title: "Introducing URL: The Zero-Dependency, Framework-Agnostic State Manager"
notion_id: 16c54f1c-7d23-81b6-a6b1-c9359f920b18
notion_url: https://app.notion.com/p/Introducing-URL-The-Zero-Dependency-Framework-Agnostic-State-Manager-16c54f1c7d2381b6a6b1c9359f920b18
last_edited: 2025-02-10T18:23:00.000Z
source_url: https://madewithlove.com/blog/introducing-url-the-zero-dependency-framework-agnostic-state-manager/
tags: ["Web Development", "System Design / Software Architecture", "REST API", "Network", "Article", "madewithlove Blog", "English"]
---
![image](https://madewithlove.com/blog/content/images/size/w2000/2024/12/banner-14.png)

We’re thrilled to announce **URL**, a cutting-edge solution designed to revolutionize state management in modern web development. Offering a **zero-dependency**, **framework-agnostic** approach, URL simplifies state management without the need for complex tools or installations. Say goodbye to keeping the current application state of your product in a global state manager and embrace a streamlined, efficient way to manage your app’s state—whether you’re working with [React](https://madewithlove.com/blog/tag/react/), [Vue](https://madewithlove.com/blog/tag/vue/), Svelte, or anything in between.
...
That’s right—**URL** is a **zero-install**, **zero-dependency** solution supported by all major browsers. No need for downloads, no complicated configuration. It’s ready to use the moment you start building.
