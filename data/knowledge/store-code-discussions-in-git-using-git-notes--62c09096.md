...
notion_id: 62c09096-529d-45a2-b295-c705ad1ce691
notion_url: https://app.notion.com/p/Store-Code-Discussions-in-Git-using-Git-Notes-62c09096529d45a2b295c705ad1ce691
last_edited: 2024-09-10T19:58:00.000Z
source_url: https://wouterj.nl/2024/08/git-notes
tags: ["Article", "Wouter J", "English", "Programming", "Project Management"]
---
...
Meet one of Git’s unknown features: [Git notes](https://git-scm.com/docs/git-notes). They are hard to discover… and hard to use. Yet, they provide an interesting feature: Adding extra information to a commit, after you’ve created it.

Git doesn’t immediately remove objects after a new commit replaced them. Often, you can still find a “deleted” commit as long as you know its hash (even on GitHub/GitLab servers). A separate process, called [garbage collection](https://git-scm.com/docs/git-gc), removes old unused objects. This is often run automatically every once in a while.
...
Git developers use notes to store references to their mailing list like `Message-Id: <1264640755-22447-1-git-send-email-szeder@ira.uka.de>`. 
You can also use notes to store other information, such as who reviewed or tested a commit. [The reviewnotes documentation](https://gerrit.googlesource.com/plugins/reviewnotes/+/refs/heads/master/src/main/resources/Documentation/refs-notes-review.md) shows some examples.
...
First, the tool fetches the pull request comments using the [GitHub API](https://github.com/KnpLabs/php-github-api/) via the [KnpLabs GitHub API package](https://github.com/KnpLabs/php-github-api/):
...
This implementation only distributes the code discussions together with the code. 
Some developers at Google took the concept one level further and created [Git Appraise](https://github.com/google/git-appraise), a distributed code review implementation (including requesting and reviewing itself).
