...
notion_id: 7bbd5a98-b6dd-4eac-ac01-d61626072d9f
notion_url: https://app.notion.com/p/Various-Ways-of-Sending-Mail-via-SMTP-7bbd5a98b6dd4eacac01d61626072d9f
last_edited: 2023-02-01T17:04:00.000Z
source_url: https://blog.bityard.net/articles/2023/January/various-ways-of-sending-mail-via-smtp
tags: ["English", "Network", "Email", "Article", "Tutorial"]
---
...
2. Make sure you start with a "clean" IP address... and keep it that way.
3. Set up user accounts and authentication.
4. Know how to configure the SMTP server.
5. Know how to configure the POP/IMAP server.
6. Oh yes, and most importantly: don't let the mail server become a spammer's playground.
...
2. forward it to another mail server
3. drop it on the floor (unceremoniously delete it)
4. broadcast it into outer space via radio signal to show alien civilizations that there is no intelligent life here
...
Real Mail Servers out there in Cyberspace _may_ try to verify that you are who you say you are with a DNS lookup or two and might close the connection if they think you are lying. But on an internal mail relay or somesuch, you can often get away with some degree of subterfuge. [↩](https://blog.bityard.net/articles/2023/January/various-ways-of-sending-mail-via-smtp#fnref:hostname)

1. 

The more experienced readers among us will note that all modern mail servers these days support [pipelining](https://datatracker.ietf.org/doc/html/rfc2920), but pipelining only helps you blast _some_ commands at a server in rapid-fire fashion, not all. [↩](https://blog.bityard.net/articles/2023/January/various-ways-of-sending-mail-via-smtp#fnref:piplining)
