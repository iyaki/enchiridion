...
notion_id: 38c54f1c-7d23-81d4-b831-da7da4c0a0c6
notion_url: https://app.notion.com/p/How-to-apply-professional-design-principles-in-AI-app-development-38c54f1c7d2381d4b831da7da4c0a0c6
last_edited: 2026-09-18T00:52:00.000Z
source_url: https://expo.dev/blog/how-to-apply-professional-design-principles-in-ai-app-development
tags: ["English", "UI/UX", "Artificial Intelligence (AI)", "Software Development", "Design", "Article", "Guide", "Expo Blog"]
---
[Docs](https://docs.expo.dev/)[Product](https://expo.dev/services)

Solutions

[Enterprise](https://expo.dev/solutions/enterprise)[Pricing](https://expo.dev/pricing)[Blog](https://expo.dev/blog)

[50K](https://github.com/expo/expo)

[Log in](https://expo.dev/login)[Sign up](https://expo.dev/signup)
...
- [Startup](https://expo.dev/solutions/startups)
- [Solo devs](https://expo.dev/solutions/solo-devs)
- [React web devs](https://expo.dev/solutions/expo-for-react-web-devs)
- [E-commerce](https://expo.dev/solutions/ecom)
- [Crypto](https://expo.dev/solutions/crypto)
- [Finserv](https://expo.dev/solutions/financial-services)
- [QSR](https://expo.dev/solutions/qsr)
...
© 2026 650 Industries, Inc.[All Systems Operational](https://status.expo.dev/)
