---
title: "GitHub git guides"
notion_id: 349bf195-be25-44e1-8a1d-abe640858876
notion_url: https://app.notion.com/p/GitHub-git-guides-349bf195be2544e18a1dabe640858876
last_edited: 2023-06-05T00:25:00.000Z
source_url: https://github.com/git-guides
tags: ["Website", "Guide", "English", "Programming"]
---
...
There are _many_ ways to use Git, which doesn't necessarily make it easier! But, the fundamental Git workflow has a few main steps. You can practice all of these in the [Introduction to GitHub course](https://github.com/skills/introduction-to-github).
...
If you're getting started with Git, a great place to start is the [Git Cheat sheet](https://github.github.io/training-kit/). It's translated into many languages, [open source as a part of the ](https://github.com/github/training-kit)[`github/training-kit`](https://github.com/github/training-kit)[ repository](https://github.com/github/training-kit), and a great starting place for the fundamentals on the command line.
...
The best place to practice using Git and GitHub is the [Introduction to GitHub course](https://github.com/skills/introduction-to-github).
