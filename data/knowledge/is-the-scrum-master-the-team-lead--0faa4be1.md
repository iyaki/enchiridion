---
title: "Is the Scrum Master the Team Lead?"
notion_id: 0faa4be1-8158-4897-aca8-26781f8aa11c
...
During these eight incredible years, and after working and collaborating with more than 30 Scrum Masters, alongside promoting different agile communities, this question (which seems pretty simple and obvious at first sight) is still one of the most unclear and controversial ones: _Is the Scrum Master a leader of the team? _Similarly, the Scrum Master can be heard asking: _Am I supposed to lead the team, or just ensure events happen?_
...
When we often hear concepts like [“Servant leader” or “Servant leadership,”](https://management30.com/blog/servant-leadership/) we quickly associate it with the role/accountability of _the Scrum Master_.

The concept of “Servant-leader” was introduced by Robert Greenleaf in his essay_ The Servant as a Leader_ in 1970.

## **What are the Scrum Master’s Responsibilities?**

As per the [official Scrum Guide](https://scrumguides.org/docs/scrumguide/v2020/2020-Scrum-Guide-US.pdf), the Scrum Master is accountable for establishing Scrum as defined in the Scrum Guide. This is done by helping everyone understand Scrum theory and practice, both within the Scrum Team and the organization.
...
Sadly, in many organizations, the role is understood purely as a facilitator, just to schedule meetings, create reports, take meeting notes, control timeboxes and [facilitate fun retrospectives](https://management30.com/blog/retrospective-tools-management30/). These perceptions were common, experienced by myself and many colleagues.

<!-- image hosted by Notion: its URL expires and is not preserved (ADR-05) -->

In response, when Scrum.org released the [latest version of the Official Scrum Guide](https://scrumguides.org/docs/scrumguide/v2020/2020-Scrum-Guide-US.pdf) in 2020, the term “Servant-leader for the Scrum Team” was changed to “True leader who serves the Scrum Team.”
...
One of my favorite Management 3.0 quotes is deeply related to what a Scrum Master _– a true leader – _is and does: _Manage the System, not the People._
...
According to Scrum.org and their [Professional Scrum Competency](https://www.scrum.org/professional-scrum-competencies/developing-people-and-teams), there are certain focus areas through which to develop people and teams. Let’s look into how Scrum Masters can achieve these with the help of Management 3.0:

Key Areas in which the Scrum Master takes the Team Lead

<!-- image hosted by Notion: its URL expires and is not preserved (ADR-05) -->

### **Self-Managing Teams**

“A fundamental foundational element to Scrum; [cross-functional](https://management30.com/blog/cross-functional-team-leadership/), self-managing, and [empowered teams](https://management30.com/empower-teams/) are the engine to delivering value.”
...
Also read: [Living the coach approach](https://management30.com/blog/living-the-coach-approach/).
