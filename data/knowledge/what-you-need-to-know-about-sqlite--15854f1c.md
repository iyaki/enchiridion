...
notion_id: 15854f1c-7d23-812a-9022-f126fb29af71
...
tags: ["English", "Databases", "Programming", "Article", "Joy of Rails"]
---
...
SQLite is already just about [everywhere else](https://www.sqlite.org/mostdeployed.html)—smartphones, TVs, web browsers, desktop applications—why _now_ for web apps? Why now for Rails?
...
[Joy of Rails](https://joyofrails.com/) has run on SQLite since launch and I have been very happy with my choice—I plan to keep it that way. But SQLite isn’t for everyone.
...
![image](https://joyofrails.com/assets/articles/what-you-need-to-know-about-sqlite/scaling-5b57e20c.jpg)
...
The best post I’ve come across that touches on SQLite performance characteristics in terms of sca lability and reliability is [Consider SQLite](https://blog.wesleyac.com/posts/consider-sqlite) by Wesley Aptekar-Cassels. A quote describing one of his perf tests:
...
[config/database.yml](https://github.com/joyofrails/joyofrails.com/blob/10dc6292/config/database.yml)
...
_Thanks to _[_Brandon Zylstra_](https://github.com/brandondrew)_, _[_Stephen Margheim_](https://github.com/fractaledmind)_, and Christopher B. for their feedback and edits on this post._

If you liked this article, please feel free to share it and [subscribe](https://joyofrails.com/articles/what-you-need-to-know-about-sqlite#newsletter-signup) to hear more from me and get notified of new articles by email.
...
![image](https://joyofrails.com/assets/articles/what-you-need-to-know-about-sqlite/feather-c0043142.jpg)

Feather

[#ruby-on-rails](https://joyofrails.com/topics/ruby-on-rails) [#sqlite](https://joyofrails.com/topics/sqlite)

### More articles to enjoy

- [Introducing Joy of RailsJoy of Rails is a Rails application dedicated to teaching and showing programmers how to use Ruby on Rails and highlighting news, notes, and contributions relevant to the broader Ruby on Rails community. It is open sourced on Github.](https://joyofrails.com/articles/introducing-joy-of-rails)
- [Add your Rails app to the Home Screen - the Ultimate GuideRails 8 will support Progressive Web Apps (PWA) out-of-the-box but you have all the tools you need to make your Rails app installable today.](https://joyofrails.com/articles/add-your-rails-app-to-the-home-screen)
- [Custom Color Schemes with Ruby on RailsYou can edit the color scheme of this website right in content of this blog post. Play with the controls while we highlight the benefits of Rails, Hotwire, and CSS variables.](https://joyofrails.com/articles/custom-color-schemes-with-ruby-on-rails)
