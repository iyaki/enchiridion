...
notion_id: 38d54f1c-7d23-81dc-9af0-f00d7c563191
...
tags: ["Tool", "Article", "parksb.github.io", "English", "Web Development", "Programming", "Tool", "Learning", "Documentation"]
---
## The joy of building from scratch 2019.07.31

[KO](https://parksb.github.io/article/32.html) | EN

![image](https://parksb.github.io/images/60662976-d78bed00-9e98-11e9-9832-908c731a6989.jpg)
...
TeX, too, was born from shaving a yak. TeX is a typesetting system created by Stanford professor Donald Knuth; the name covers the whole system that runs the program, including the typesetting language and the compiler that processes it.[[4]](https://parksb.github.io/en/article/32.html?utm_source=tldrdev%2F#fn4) Because it makes formulas easy to enter, it’s widely used in the social sciences and in science and engineering. ([LaTeX](https://www.latex-project.org/), a set of macros for using TeX more easily, is what most people use.)
...
Of course, this is an extreme success story; most yak shaving fails. You’re supposed to stop at the right point,[[8]](https://parksb.github.io/en/article/32.html?utm_source=tldrdev%2F#fn8) but once you start shaving, it’s hard to quit, whether because the time you’ve already sunk in feels too precious to waste or because the shaving itself is fun. Or you really do need to see it through, but you end up quitting anyway, either when the thought “what am I even doing right now?” creeps in and your interest fades, or when the resources allotted to the project run dry.
