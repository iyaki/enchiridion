---
title: "Becoming a good engineer"
notion_id: 1b254f1c-7d23-81f1-9ca7-cee076f62fa7
notion_url: https://app.notion.com/p/Becoming-a-good-engineer-1b254f1c7d2381f19ca7cee076f62fa7
last_edited: 2025-04-19T23:29:00.000Z
source_url: https://0x0001.cc/blog/good-engineer.md
tags: ["Producer (Individual Contributor)", "Career Growth", "Article", "Madmeg's Blog"]
---
## Introduction
...
" **Engineers** _apply scientific principles to analyze, design, invent, code, build, and create to solve all sorts of problems and make the world a better place_ "
...
## Understanding the floors in a tool or a technology
...
It's good to know all the theory but if you can't accumulate that knowledge into a project or proof of concept then it's useless.
...
Here is a good resource if you want to learn how to critically think: [Critical Thinking: Where to Begin](https://www.criticalthinking.org/pages/critical-thinking-where-to-begin/796)
...
- [@gizmobly reading list](https://deplet.ing/#/post/3)
- [@ludwigABAP reading list](https://ludwigabap.bearblog.dev/resources-for-cs/)
- [@seatedro reading list](https://seated.ro/log)

## Apply the knowledge you gain to a project
...
- **Build small prototypes** - If you’re learning a new framework, language, or concept, create a small proof-of-concept project. For example, if you're studying database indexing, implement a simple search system and compare the performance of different indexing strategies.
- **Solve real-world problems** - Identify a small problem in your workflow or daily life and try to solve it using the knowledge you’ve gained.
- **Teach what you learn** - One of the best ways to solidify your understanding is to explain it to someone else. Write a blog post, write a twitter thread, or even just discuss the topic with a colleague or friend.
...
It's easy to get lost on what to start on and what to read, here is a list of _my recommendations_
...
- Elements of Information Theory (Math Heavy)

## Projects

- Compiler - Write a compiler for a language of your chose, Check out LLVM or JVM.
- Emulator - Write a CPU emulator, start with a simple cpu such as 8086 (recommendation from [@gizmobly](https://x.com/gizmobly))
- Render Engine/Game Engine - Write a graphical programme using OpenGL or Vulkan.
- Memory Viewer & Editor - Write a programme that interfaces with another programmes memory.
- Http Server - Write a http server ideally in a low level language.
