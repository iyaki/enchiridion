...
notion_id: 6abd2707-fb45-436d-8a5a-2641b342052b
notion_url: https://app.notion.com/p/El-dilema-del-ingeniero-de-software-6abd2707fb45436d8a5a2641b342052b
last_edited: 2026-09-21T17:39:00.000Z
source_url: https://olano.dev/blog/el-dilema-del-ingeniero-de-software/
tags: ["Article", "Apuntes inchequeables (Facundo Olano)", "Español", "System Design / Software Architecture", "Producer (Individual Contributor)"]
---
[https://facundoolano.github.io/2022-04-11-el-dilema-del-ingeniero-de-software/](https://facundoolano.github.io/2022-04-11-el-dilema-del-ingeniero-de-software/)

¿Qué tienen en común Los Venture Capitalists (VCs) y Andrés Calamaro? Calamaro compone profusamente; siete de cada diez de sus canciones son descartables; graba material para cinco discos y, si no tiene a Joe Blaney —ese mitológico productor yanqui que solamente es conocido en Argentina— respirándole en la nuca, publica los cinco discos enteros y después, por separado, edita una selección de quince canciones sólidas que incluye algún hit. El VC sigue el mismo modus operandi porque, con toda la información y el asesoramiento que el dinero puede comprar, identificar a una startup ganadora es una tarea improbable1. Es más realista diversificar: apostar a veinte o cien y, cuando una es un hit, recuperar toda la inversión.
