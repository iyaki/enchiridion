---
title: "A Guide to Public Speaking for Software Engineers"
notion_id: ff4b2545-c1a0-4427-956a-87f8c170147d
...
source_url: https://read.highgrowthengineer.com/p/a-guide-to-public-speaking-for-software
tags: ["High Growth Engineer Substack", "English", "Communication", "Article"]
---
“Your technical skills are where they need to be, but you need to improve your communication.” - Your manager.

This is one of the hardest pieces of feedback to hear as a software engineer.

Why?

Because you probably thought as a software engineer you can just speak code.

But no.

Only focusing on code can lead to a ceiling in your potential for growth and promotions.
...
_**⚠ Disclaimer: My advice is based on what has worked for me, but there are certainly exceptions. It will not apply to 100% of situations.**_
...
1. Staring at one person in the audience
2. Staring at the slides
3. Looking down
...
As software engineers, we have a tendency to hunch from sitting at the desk all day.

To fix this you can try this before your presentation:
...
One of the most difficult pieces to get down is what to do with your arms and hands.

**The good news is there’s only 1 thing you need to remember: Keep them open.**

Our most natural tendency due to nervousness is to close them off, interlock, rub them together, put them in our pockets, etc.

**They are all closed body language behaviors.**
...
Examples from Steve Jobs on what you can do with your hands during a talk.

<!-- image hosted by Notion: its URL expires and is not preserved (ADR-05) -->

If you’re interested in more, check out this [communication experts’ top body language mistakes to avoid](https://www.youtube.com/watch?v=-4GpHVeET8E).

## 🗣️ Your words

If you only take one thing from this section, it’s to **project confidence**.

To this day, I still get nervous before presentations. I do at least 1 warm-up technique which helps ease my nerves and primes myself for speaking confidently though.
...
**Pro tip:** Another thing I’d do the day of the presentation is talk to more people.

When you exercise without stretching, what happens? You strain yourself.

**So if you have a presentation that day, **_**“stretch”**_** by talking to people.** If you’ve spent most of the day talking to people, the presentation won’t feel so different. Compare that to if you spent the whole day without talking to anyone, doing a presentation in front of an audience will be a big 0 → 100 jump.

### (2) Rhythm

Avoid speaking too quickly, too slowly, **or at the same pace permanently**.

Be dynamic. If you stick to just one pace, you become monotone, which leads to your audience opening Slack, opening their phone, or sleeping 😴.
...
It’s common for engineers to speak too quietly or mumble.

A tip here is to think of top speakers you look up to and how they sound:

- Tony Robbins
- Michelle Obama
- Steve Jobs

You don’t need to be as good as they are, but at least match their volume.

You can even have a go-to speech of theirs you watch beforehand to prime yourself.

### (4) Practice

This is well-known so I won’t focus on it too much, but **practice**.

For big presentations, you can also record yourself or practice in front of a friend.

It helps you with slight wording tweaks and most importantly, **your confidence.**

Before your presentation, if you know you just need to repeat what you did while practicing yesterday, you’ll be much **less nervous**.

## 🎞️ Your content

[I have a guide on this already](https://careercutler.substack.com/p/how-to-give-presentations-and-demos), but I’ll provide a summary of the key points here.
...
**Personal example:** One way I added interactivity to a presentation was by asking everyone to close their eyes while I played an audio clip. It helped put them in the shoes of the people I wanted them to build more empathy for—customers who were blind and using a [screen reader](https://www.afb.org/blindness-and-low-vision/using-technology/assistive-technology-products/screen-readers).

### (2) Images > words

Go through every slide with words and ask if it can be replaced with an image.

It’s true. Not every slide should be an image. In my experience, the best ones have been about 75% images and 25% words.

When you do use words on your slides, follow these rules:

1. If it’s bulleted, try to use 3 or 5 bullets. Using 2 or 4 bullets doesn’t read as well.
2. Consider making it a slide with just a single, big, centered sentence.
3. Your bullets should be 1 line at most, 2 lines only sometimes, and never 3+ lines.

### (3) How to structure the content

You might still be wondering how you put all of this together.

There are a few popular frameworks you can follow as a software engineer:
...
1. **Topic-Why it matters-Information-Recap**

This framework is best for informative presentations. You say your topic, tell the audience why it matters to them, tell them the information they need to know, then give a recap.

**It’s actually the same format I use for this newsletter. **[See my LinkedIn explainer](https://www.linkedin.com/posts/jordancutler1_100-paid-subscribers-my-newsletter-stats-activity-7125501784357249024-QzWf?utm_source=share&utm_medium=member_desktop).

I also used it for my presentation on accessibility and inclusivity at Gusto during our all-hands to 200+ people. Do this in combination with the interactive elements above and you’re set up for success.
...
## 💭 Closing thoughts and announcement ❗️
...
Part of the reason I wrote on this topic this week is to give myself a refresher because I’ll be an emcee at the [Plato Elevate conference](https://www.platohq.com/events/elevate-2023) this Tuesday and Wednesday!

It’s an amazing opportunity I’m incredibly excited (and nervous) about.

If you’re able to come or you will be there, I’d love to meet you. You can get [40% off tickets with the code ELEVATE2023-JORDAN](https://www.platohq.com/events/elevate-2023).

## 📣 Shout-outs of the week

- [From Microsoft Intern to Meta Staff](https://www.developing.dev/p/from-microsoft-intern-to-meta-staff) on [The Developing Dev](https://open.substack.com/pub/ryanlpeterman)
- [Software eng guide to say “no”](https://www.thecaringtechie.com/p/software-eng-guide-to-saying-no) on [Musings Of A Caring Techie](https://open.substack.com/pub/thecaringtechie)
- [The 1 trait of the most valuable software engineers](https://engineercodex.substack.com/p/the-1-trait-of-the-most-valuable) on [Engineer’s Codex](https://open.substack.com/pub/engineercodex)

_As always, thank you for reading and for the growth to 25k+ subscribers._

- Jordan

_P.S. If you’re interested, I’m accepting the following:_

1. _Waitlist spots for my upcoming _[_Mid-level to Senior course_](https://maven.com/forms/02f7d3)_ (Early December)_
2. _New coaching clients: See _[_Mentorcruise for rates_](https://mentorcruise.com/mentor/jordancutler/)_ (I have just 2 spots left)_
...
Join 25,000+ engineers growing every Sunday with real-world, actionable, advice.
