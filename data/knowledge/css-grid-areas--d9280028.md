...
notion_id: d9280028-3649-48a0-b8ef-97c7baa11d5d
...
tags: ["Ahmad Shadeed's Blog", "English", "CSS", "Guide"]
---
...
## [Introduction](https://ishadeed.com/article/css-grid-area/?utm_source=tldrwebdev#introduction)
...
## [CSS named grid areas](https://ishadeed.com/article/css-grid-area/?utm_source=tldrwebdev#css-named-grid-areas)

In CSS grid, we can name each grid area and reference it throughout the CSS. Let’s take the following basic example.

### [Example 1: Basic problem](https://ishadeed.com/article/css-grid-area/?utm_source=tldrwebdev#example-1-basic-problem)
...
![image](https://ishadeed.com/_astro/grid-area-mapping.CzqJmd_C_1Jp2ST.png)

### [Example 2: Card layout](https://ishadeed.com/article/css-grid-area/?utm_source=tldrwebdev#example-2-card-layout)
...
## [Grid template area rules](https://ishadeed.com/article/css-grid-area/?utm_source=tldrwebdev#grid-template-area-rules)

### [The defined area should be like a rectangle](https://ishadeed.com/article/css-grid-area/?utm_source=tldrwebdev#the-defined-area-should-be-like-a-rectangle)
...
![image](https://ishadeed.com/_astro/grid-areas-shape.DKYasFas_27iOAR.png)

### [All areas must be defined](https://ishadeed.com/article/css-grid-area/?utm_source=tldrwebdev#all-areas-must-be-defined)
...
## [Grid template syntax](https://ishadeed.com/article/css-grid-area/?utm_source=tldrwebdev#grid-template-syntax)
...
### [Grid area syntax, example 1](https://ishadeed.com/article/css-grid-area/?utm_source=tldrwebdev#grid-area-syntax-example-1)
...
![image](https://ishadeed.com/_astro/grid-area-mapping-2.CSBgyYJV_1prVFl.png)
...
### [Grid area syntax, example 2](https://ishadeed.com/article/css-grid-area/?utm_source=tldrwebdev#grid-area-syntax-example-2)
...
### [Grid area syntax, example 3](https://ishadeed.com/article/css-grid-area/?utm_source=tldrwebdev#grid-area-syntax-example-3)
...
```plain text
.page {grid-template-areas:"aside main""footer footer";}
```
...
### [Empty grid cells](https://ishadeed.com/article/css-grid-area/?utm_source=tldrwebdev#empty-grid-cells)
...
## [CSS grid named grid lines](https://ishadeed.com/article/css-grid-area/?utm_source=tldrwebdev#css-grid-named-grid-lines)

### [Intro](https://ishadeed.com/article/css-grid-area/?utm_source=tldrwebdev#intro)
...
### [Grid tracks](https://ishadeed.com/article/css-grid-area/?utm_source=tldrwebdev#grid-tracks)
...
![image](https://ishadeed.com/_astro/named-grid-lines-tracks-1.BgbxLpfM_1cO1tG.png)
...
![image](https://ishadeed.com/_astro/named-grid-lines-tracks-2.CcBJqr7g_1fjc3j.png)
...
![image](https://ishadeed.com/_astro/named-grid-lines-tracks-3.ClT-4BSJ_2fn0rs.png)
...
### [Named grid lines are optional](https://ishadeed.com/article/css-grid-area/?utm_source=tldrwebdev#named-grid-lines-are-optional)
...
### [Mixing line numbers and names](https://ishadeed.com/article/css-grid-area/?utm_source=tldrwebdev#mixing-line-numbers-and-names)
...
## [Use cases for grid template areas](https://ishadeed.com/article/css-grid-area/?utm_source=tldrwebdev#use-cases-for-grid-template-areas)

### [Reversing Grid Direction](https://ishadeed.com/article/css-grid-area/?utm_source=tldrwebdev#reversing-grid-direction)
...
![image](https://ishadeed.com/assets/grid-named-areas/shawarma.jpg)
...
### [Header layout](https://ishadeed.com/article/css-grid-area/?utm_source=tldrwebdev#header-layout)
...
![image](https://ishadeed.com/_astro/header-layout-1.C0A_BFo3_Z7lbPE.png)
...
[Profile](https://ishadeed.com/article/css-grid-area/?utm_source=tldrwebdev#)
...
```plain text
grid-template-areas:"logo nav nav""logo actions action";
```
...
### [Editorial layout: example 1](https://ishadeed.com/article/css-grid-area/?utm_source=tldrwebdev#editorial-layout-example-1)
...
### [Editorial layout: example 2](https://ishadeed.com/article/css-grid-area/?utm_source=tldrwebdev#editorial-layout-example-2)
...
![image](https://ishadeed.com/_astro/editorial-2-1.Gl1dO1cd_Vhrb9.png)
...
### [Threads app post](https://ishadeed.com/article/css-grid-area/?utm_source=tldrwebdev#threads-app-post)
...
### [Overlapping items with grid areas](https://ishadeed.com/article/css-grid-area/?utm_source=tldrwebdev#overlapping-items-with-grid-areas)
...
## [Conditional layouts with CSS :has()](https://ishadeed.com/article/css-grid-area/?utm_source=tldrwebdev#conditional-layouts-with-css-has)
...
![image](https://ishadeed.com/assets/grid-named-areas/bread.jpg)

A photo showing the best bread in town. Taken by Ahmad Shadeed.

```plain text
.card:has(figcaption) {grid-template-areas:"img img caption""img img .";}
```
...
## [Multilingual support (LTR/RTL)](https://ishadeed.com/article/css-grid-area/?utm_source=tldrwebdev#multilingual-support-ltrrtl)
...
## [Grid areas and DevTools](https://ishadeed.com/article/css-grid-area/?utm_source=tldrwebdev#grid-areas-and-devtools)

All the major browsers have good tooling for grid areas (Chrome, Safari, and Firefox). Here is a preview of each browser:

### [Chrome](https://ishadeed.com/article/css-grid-area/?utm_source=tldrwebdev#chrome)
...
![image](https://ishadeed.com/_astro/devtools-chrome.CFnyGMhy_K4GS2.png)

### [Safari](https://ishadeed.com/article/css-grid-area/?utm_source=tldrwebdev#safari)
...
![image](https://ishadeed.com/_astro/devtools-safari.aJEvlZm7_2rH5cK.png)
...
![image](https://ishadeed.com/_astro/safari-line-names.58Jkc5Rv_2cOA78.png)

### [Firefox](https://ishadeed.com/article/css-grid-area/?utm_source=tldrwebdev#firefox)
...
![image](https://ishadeed.com/_astro/devtools-firefox.ByluX823_Z2pwMPS.png)
...
![image](https://ishadeed.com/_astro/firefox-hints.D5xlHt5Y_PxDt0.png)

## [Outro](https://ishadeed.com/article/css-grid-area/?utm_source=tldrwebdev#outro)
...
### [Resources](https://ishadeed.com/article/css-grid-area/?utm_source=tldrwebdev#resources)
...
### [Credits](https://ishadeed.com/article/css-grid-area/?utm_source=tldrwebdev#credits)
...
Enjoyed the read? If you'd like to support my work, consider buying me a coffee. Each article takes about 15 cups to create. Thanks a latte!
