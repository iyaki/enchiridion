---
title: "Wireframe vs. mockup vs. prototype: How are they different?"
notion_id: 9e990ab6-1675-4aa6-bfd0-3c7adb22d9c5
...
tags: ["LogRocket Blog", "English", "Product Management", "UI/UX", "Article"]
---
<!-- image hosted by Notion: its URL expires and is not preserved (ADR-05) -->

Building products is a risky and resource-consuming endeavor. Luckily, there are tools designed to help us de-risk the whole process.
...
That’s why designers employ various techniques, such as [wireframing](https://blog.logrocket.com/product-management/wireframe-vs-mockup-vs-prototype/#what-is-a-wireframe), creating [mockups](https://blog.logrocket.com/product-management/wireframe-vs-mockup-vs-prototype/#what-is-a-mockup), and [prototyping](https://blog.logrocket.com/product-management/wireframe-vs-mockup-vs-prototype/#mockup-vs-prototype), to test ideas quickly before building an actual product. But what’s the difference between a wireframe, a mockup, and a prototype?
...
1. **It helps us visualize our thinking** — As they say, a picture is worth 1,000 words. Some things are just significantly easier to show than to describe
2. **It aligns people** — Wireframes give teams something specific to refer to. It mitigates the risk of people visualizing completely different things and gets everyone on the same page
3. **It structures discussions **_—_ The ability to point to a specific design element is a game-changer
...
A low-fidelity mockup is a digitalized, more thought-through version of the wireframe. A UX designer or [product manager](https://blog.logrocket.com/product-management/product-managers-role-each-product-lifecycle-stage/) usually does these.
...
Medium-fidelity mockups are born when we take our low-fidelity mockups and start adding colors and branding.
...
Different levels of fidelity not only serve different purposes, but are also additive. We use a low-fidelity mockup as a basis for a medium-fidelity one, which then is turned into a high-fidelity end-product.

<!-- image hosted by Notion: its URL expires and is not preserved (ADR-05) -->

It might be tempting to jump into high-fidelity mockups immediately, but it’s rarely worth it.

First, any changes to hi-fi mockups are more expensive than changes to lo-fi mockups or even wireframes.

It’s also hard to focus on the big picture when evaluating hi-fi mockups. It’s easy to get fixated on the shade around the CTA button, even if we’re not yet sure if we want to have a CTA there. That’s one of the reasons lo-fi mockups are colorless and straightforward: to promote a focus on the big picture vs. irrelevant details.
...
_An example of a paper prototype._
...
Wireframes help us visualize our thinking and improve collaboration. Mockups then allow us to assess and collect feedback on information architecture, look and feel, and intrinsic details. We can support the process with prototypes to gather even more detailed feedback.

<!-- image hosted by Notion: its URL expires and is not preserved (ADR-05) -->

In a perfect world, where time and money are no object, you should take all of the following steps:

1. Start with wireframes to create understanding
2. Build a low-fidelity mockup to assess the high-level structure
3. Confirm with a paper prototype
4. Build a medium-fidelity mockup to determine the overall look and feel
5. Confirm with a digital prototype
6. Build a high-fidelity mockup to evaluate the results
7. Simulate a real app experience with a detailed prototype
8. Build an app
