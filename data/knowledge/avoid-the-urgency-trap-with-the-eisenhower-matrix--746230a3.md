...
notion_id: 746230a3-3742-4b6c-894a-0da7dfb00bea
notion_url: https://app.notion.com/p/Avoid-the-Urgency-Trap-with-the-Eisenhower-Matrix-746230a337424b6c894a0da7dfb00bea
last_edited: 2022-12-30T13:01:00.000Z
source_url: https://todoist.com/es/productivity-methods/eisenhower-matrix
tags: ["English", "Project Management", "Line/People/Team Management", "Producer (Individual Contributor)", "Productivity", "Article", "Todoist"]
---
...
Over 3 decades later in his best-selling book [The 7 Habits of Highly Effective People](https://www.franklincovey.com/the-7-habits.html), Stephen Covey repackaged Eisenhower’s insights into a simple tool to prioritize tasks, now known as the Eisenhower Matrix (also known as The Time Management Matrix, The Eisenhower Box, The Eisenhower Method, and The Urgent-Important Matrix). This framework for prioritization helps you combat the “mere-urgency” effect (more on that later), eliminate time-wasters in your life, and create more mental space to make progress on your goals.
...
This article will walk you through why distinguishing between the Urgent and the Important is so critical, how the Eisenhower Matrix helps you do it, and how to apply the matrix to both your big-picture projects and everyday tasks using [Todoist](https://todoist.com/?itm_campaign=eisenhower_matrix&itm_medium=referral&itm_source=productivity_methods_guides).
...
Covey cautions that spending too much time on Quadrant 1 tasks can lead to increased stress, [burn out](https://doist.com/blog/burnout-life-reset-start-here/?itm_campaign=eisenhower_matrix&itm_medium=referral&itm_source=productivity_methods_guides), and the sense that your days are out of your control. Spending all day putting out fires will quickly rob you of energy and passion for your work, and may make it easier to settle into mindless escapism found in Quadrant 4.
...
To evaluate where you currently are on the matrix, start [tracking your time](https://doist.com/blog/quantified-self-apps/?itm_campaign=eisenhower_matrix&itm_medium=referral&itm_source=productivity_methods_guides) and tasks. If you use Todoist for task management, you can easily get a [list of all the tasks you completed](https://get.todoist.help/hc/en-us/articles/205847912-View-completed-tasks?itm_campaign=eisenhower_matrix&itm_medium=referral&itm_source=productivity_methods_guides) and when you completed them. When you have a few days worth of data, sit down and organize your tasks into quadrants by asking the following questions:
...
- **Next step: **Organize a weekly or even monthly plan around your current goals and deadlines. At the end of each week, [do a weekly review](https://todoist.com/productivity-methods/weekly-review). Reflect on how well your plan worked and adjust for the next week. If most of your Q1 tasks come from external sources, strategize on how you can better plan and anticipate them. You may need to develop a more proactive workflow with a colleague or client, or talk to your boss about rebalancing an excessive workload. If there’s a particular client who’s creating a lot of Q1 tasks, the work may not be worth the stress.

**If you spend your time in Q3, delegate, eliminate, or limit the amount of time you spend on these tasks:**

- **Next Step: **Strategize and write out specific steps on how you’ll limit these tasks. Can you delegate them? Can you just say no? Can you [batch these types of tasks together ](https://todoist.com/productivity-methods/time-blocking#task-batching)in a single afternoon during your week? Can you have an open discussion with your boss about just how much time you’re spending on “busywork”? Schedule time in your week to take these steps.

**If you spend your time in Q4, you may be stuck in a rut, stressed, or avoiding a problem:**

- **Next Step: **Use your time tracking to identify the biggest time wasters and strategize on how to avoid or limit them. [Develop a plan to overcome procrastination before](https://doist.com/blog/overcome-procrastination/?itm_campaign=eisenhower_matrix&itm_medium=referral&itm_source=productivity_methods_guides) you're tempted to procrastinate. Remember, it’s ok to just relax sometimes, but activities in this quadrant have diminishing returns when used excessively.
...
In Todoist, labels and filters work together to help you organize and sort your task list. For this setup, first [create these two labels](https://get.todoist.help/hc/en-us/articles/205195042-Labels?itm_campaign=eisenhower_matrix&itm_medium=referral&itm_source=productivity_methods_guides):
...
Once all of your urgent and/or important tasks are labeled, [create four new filters](https://get.todoist.help/hc/en-us/articles/205248842?itm_campaign=eisenhower_matrix&itm_medium=referral&itm_source=productivity_methods_guides) to correspond with each quadrant:
...
Instead of using labels to sort your tasks, you can use Todoist’s four [priority](https://get.todoist.help/hc/en-us/articles/205873321-Priorities?itm_campaign=eisenhower_matrix&itm_medium=referral&itm_source=productivity_methods_guides) levels. Each priority level will map onto a corresponding quadrant of the Eisenhower matrix:
...
- Review [your upcoming tasks](https://doist.com/blog/todoist-upcoming-view/?itm_campaign=eisenhower_matrix&itm_medium=referral&itm_source=productivity_methods_guides) and make a plan to complete these items first.

**For Q2: Important & Not Urgent, p2:**

- Set a reasonable [due date](https://get.todoist.help/hc/en-us/articles/205325931?itm_campaign=eisenhower_matrix&itm_medium=referral&itm_source=productivity_methods_guides) for the next steps on each task. Get ahead of your planning by using [comments](https://get.todoist.help/hc/en-us/articles/205348311-Comments-File-Uploads?itm_campaign=eisenhower_matrix&itm_medium=referral&itm_source=productivity_methods_guides) to attach reference materials or add notes to your task.

**For Q3: Unimportant & Urgent, p3:**

- Delegate as many tasks as you possible. To delegate these in Todoist, you can [share projects](https://get.todoist.help/hc/en-us/articles/360000031079-How-to-collaborate-with-others?itm_campaign=eisenhower_matrix&itm_medium=referral&itm_source=productivity_methods_guides) with anyone, [assign tasks](https://get.todoist.help/hc/en-us/articles/213640389?itm_campaign=eisenhower_matrix&itm_medium=referral&itm_source=productivity_methods_guides), set deadlines, upload files, and discuss task details with collaborators in the comments.
