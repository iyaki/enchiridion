---
title: "Writebook"
notion_id: 03afa988-89bd-4d62-a592-6732af908b39
notion_url: https://app.notion.com/p/Writebook-03afa98889bd4d62a5926732af908b39
last_edited: 2024-09-17T16:35:00.000Z
source_url: https://once.com/writebook
tags: ["English", "Writting", "Blogging/Content Creation", "Tool"]
---
...
### [Make a book, give it a title, upload a cover.](https://once.com/writebook#make)

![image](https://once.com/assets/images/writebook-01.png)

### [Add text, images, and sections to your book.](https://once.com/writebook#add)

![image](https://once.com/assets/images/writebook-02.png)

![image](https://once.com/assets/images/writebook-03.png)

### [Drag pages to reorganize as you flesh things out.](https://once.com/writebook#organize)

![image](https://once.com/assets/images/writebook-04.png)

### [Invite as many co-authors as you’d like. Let some just read, let others write too.](https://once.com/writebook#invite)

![image](https://once.com/assets/images/writebook-05.png)

### [When done, just flip the switch and instantly publish your book live on the web for everyone.](https://once.com/writebook#publish)

![image](https://once.com/assets/images/writebook-06.png)

### [All your Writebooks show up together in your library. Make as many as you’d like.](https://once.com/writebook#library)

![image](https://once.com/assets/images/writebook-07.png)

### [What kind of books can I publish?](https://once.com/writebook#kinds-of-books)
...
### [System requirements & installation](https://once.com/writebook#requirements)
...
And, here’s a video showing how easy it is to install Campfire, the other product we make that works the same way. Installing Writebook follows the same process as Campfire.

### [FAQs](https://once.com/writebook#faqs)

### [Is it really free? No catch?](https://once.com/writebook#free-really)
...
### [What do you mean I have to host Writebook?](https://once.com/writebook#install-host)

Writebook isn’t an app or service someone else runs. It’s a fully independent system that [you run and host yourself](https://once.com/writebook#requirements). That means you install it on a server you own (or rent) and control. It requires some technical knowledge, but all-in-all it’s quite easy. If you can register a domain name, and change the DNS for that domain name, you can almost certainly handle the install and hosting process for Writebook.

### [Can we write private books too?](https://once.com/writebook#private-books)
...
### [How do I get updates to Writebook software?](https://once.com/writebook#updates)
...
### [Are native iOS and Android apps available?](https://once.com/writebook#mobile-apps)

No, Writebook is web-based software. Books will automatically be nicely formatted for reading on the web on mobile devices.

### [Can we white label or resell Writebook?](https://once.com/writebook#white-label-or-resell)

No. Please be sure to review the [license agreement](https://once.com/license) for further details.

### [Can we reuse any of the code in another product?](https://once.com/writebook#use-code)

No. While you are free to review the code and make modifications to Writebook for your own use, you can not use or repurpose the code for your own purposes outside Writebook. Please be sure to review the [license agreement](https://once.com/license) for further details.

### [Can we modify Writebook for our own purposes?](https://once.com/writebook#modify-for-own)
...
### [Can we import existing books into Writebook?](https://once.com/writebook#import-from)
...
### [How is Writebook packaged up and distributed?](https://once.com/writebook#distribution)
...
### [Can I export Kindle, PDF, ePUB, or other formats from Writebook?](https://once.com/writebook#exporting)

Not currently, no. Writebook purely publishes web-based books. We may add other export formats down the road.

[ONCE](https://once.com/)™ products are designed, built, and backed by [37signals](https://37signals.com/)™. Copyright © 37signals LLC. All rights reserved.

Anyone buying, using, or receiving a [ONCE](https://once.com/)™ product is subject to our [software license agreement](https://once.com/license).

Writebook 100% Free

### Includes everything you need

You’ll get the software (including the Rails code), free updates to any 1.x version, and [instructions for installing it on your own server](https://once.com/writebook#requirements). We’ve made it super easy, even for non-technical people.

### How do I get it?

Click the button below, enter your email, and we’ll send you a private download link to get it set up. It just takes a minute.

[Get it for free](https://pay.once.com/cart/43719879852208:1)

Please [review the software license](https://once.com/license), [the FAQs](https://once.com/writebook#faqs) and [explore the simple manual](https://books.37signals.com/2/the-writebook-manual) prior to downloading.
