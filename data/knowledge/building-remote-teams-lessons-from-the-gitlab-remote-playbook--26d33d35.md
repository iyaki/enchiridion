---
title: "Building Remote Teams: Lessons From The Gitlab Remote Playbook"
notion_id: 26d33d35-8a3b-40a4-a2d0-c6728149a229
notion_url: https://app.notion.com/p/Building-Remote-Teams-Lessons-From-The-Gitlab-Remote-Playbook-26d33d358a3b40a4a2d0c6728149a229
last_edited: 2023-02-16T13:48:00.000Z
source_url: https://hackernoon.com/building-remote-teams-lessons-from-the-gitlab-remote-playbook
tags: ["Article", "Hackernoon", "English", "Line/People/Team Management", "Entrepreneurship", "Communication"]
---
## Too Long; Didn't Read

DevOps giant GitLab are one of the leading fully remote tech companies. They have produced a ‘Remote Playbook’ to guide companies looking to adopt remote working, or refresh their current approach. The playbook is a bible on how to run a remote team successfully, efficiently, and mindfully. There is no one-size-fits-all remote model, but GitLab recommend a fully remote model. Some companies have seen hybrid models as a good ‘next step’ in their remote journey.

<!-- image hosted by Notion: its URL expires and is not preserved (ADR-05) -->

_**“The path forward requires you to rethink your processes, norms, and culture in a way that will serve a diverse and dynamic workforce, no matter where they choose to open their laptop.” –**_ [_GitLab Remote Playbook 2022_](https://learn.gitlab.com/allremote/remote-playbook?ref=hackernoon.com)

**TL;DR**

- DevOps giant [GitLab](https://gitlab.com/users/sign_in?ref=hackernoon.com) is one of the leading fully remote tech companies, and has produced a ‘Remote Playbook’ to guide companies looking to adopt remote working, or refresh their current approach.
...
If you are working in a tech company in 2022, chances are pretty good that your model of work has changed significantly from the office-centric culture of pre-2020. Unless that is, you work at [**GitLab**](https://about.gitlab.com/?ref=hackernoon.com).
...
If you are drowning in questions and concerns as to how to move to a remote model of work, the [**GitLab Remote Playbook**](https://learn.gitlab.com/allremote/remote-playbook?ref=hackernoon.com) is the rescue boat. Chock full of hints, tips, and advice – all backed up by years of experience – this is your bible on how to run an all-remote team successfully, fairly, and sustainably, straight from the horse’s mouth (or the [Tanuki’s](https://www.linkedin.com/pulse/how-gitlab-logo-relates-software-development-joel-krooswyk/?ref=hackernoon.com) mouth, in this case).
...
- **Hire a Head of Remote**: Pioneered by GitLab, this full-time role can be essential in ensuring that transitioning to remote work becomes a strategic advantage rather than a headache. Not sure what the role entails? [There’s a guide for that.](https://about.gitlab.com/company/culture/all-remote/head-of-remote/?ref=hackernoon.com)
...
- **Start to document** _**everything**_*****:** Remote work depends on a culture of strong, consistent, and accessible documentation.
