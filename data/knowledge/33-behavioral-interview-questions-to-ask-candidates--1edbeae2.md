---
title: "33 Behavioral Interview Questions to Ask Candidates"
notion_id: 1edbeae2-71ae-4459-a484-1440141c549b
notion_url: https://app.notion.com/p/33-Behavioral-Interview-Questions-to-Ask-Candidates-1edbeae271ae4459a4841440141c549b
last_edited: 2023-03-30T13:47:00.000Z
source_url: https://toggl.com/blog/behavioral-interview-questions
...
Getting candidates to explain their thought process, talk about a time they failed a project, or share their approach to prioritizing tasks is eye-opening – and every interviewer wants in on this well-known _hack_.

While we don’t think interviews are the most important stage in the hiring workflow (we’re big on [skills-based hiring](https://toggl.com/blog/skills-based-hiring)), asking behavioral interview questions is a surefire way to understand candidates’ strengths, weaknesses, and quirks.
...
You will find that many candidates will answer questions in a similar fashion. They will use the STAR method, which stands for **s**ituation, **t**ask, **a**ction, and **r**esult. It’s a framework for answering behavioral questions in an easy-to-understand way. The STAR method is a handy tool for anyone on a job search.

The STAR structure makes answering behavioral interview questions a lot easier.

[Source](https://www.linkedin.com/posts/aoiferedmondrecruit_interview-interviewprep-star-activity-6988786705751232512-yvqF?utm_source=share&utm_medium=member_desktop)
...
1. Talk about a time when you made a mistake and how you overcame it.
2. What is your thought process when tackling a new task or project?
3. Tell me about a time when you didn’t meet a deadline and how you presented it to your team and supervisor.
4. How do you deal with difficult co-workers, and what steps did you take during one of those instances?
5. How do you prioritize and organize your workload when there are multiple projects?
6. Describe a time when you were assigned a task you weren’t familiar with.
7. What is your approach to learning new skills?
8. Describe a time when you negotiated a win-win situation for a previous client and company.
9. What is the most challenging situation you have been in?
10. Give an example of a time when you had to pitch an idea to someone in a more senior position.
11. Tell me about a time you were under a lot of pressure. What was going on, and how did you get through it?
12. How do you handle roadblocks or obstacles?
13. Talk about a time when you raised the bar.
14. Tell me about a decision you made based on your instincts.
15. Tell me about a time you handled a difficult stakeholder.
16. Tell me about a tough decision you made during a project.
17. Talk about a time when you had to convince your manager or team members about something you proposed.
...
1. Tell me about a time when you created a solution to a complex problem.
2. Describe a situation at your past workplace where you wish you’d handled it differently.
3. Describe a time when you set a goal for yourself and achieved it.
4. Tell me about a time when you were dissatisfied with the status quo.
5. Tell me about a skill you recently learned.

### Teamwork Behavioral Interview Questions

1. How do you motivate team members?
2. How do you handle a co-worker that has a gripe against a manager or the company?
3. Describe your conflict resolution process when it comes to team members.
4. Tell me about a time when you fired someone.
5. As a manager, how do you handle tradeoffs?

### Communication Behavioral interview questions

1. How do you overcome conflict in the workplace?
2. Give me an example of how you handle stress as well as failure.
3. Give me an example of a time when your behavior was out of line, and had to rectify your behavior.
4. Tell me about a time when you had a disagreement with your manager.
5. Describe a challenging project you worked on and why it was challenging.
6. Give me an example of a time when you successfully persuaded someone to see things your way at work.

Further Reading:

[100 Soft Skills Assessment and Interview Questions](https://toggl.com/blog/100-soft-skills-questions-to-help-you-hire-top-talent)
...
In our experience, the best interviews are preceded by [skills screening tests](https://toggl.com/hire/test-library). Instead of jumping right into live interviews to assess technical fit, hiring teams can use test scores to [identify the most qualified candidates and shortlist](https://toggl.com/blog/candidate-shortlisting) them for a call.

A product engineering studio, Producement, has [flipped its hiring process on its head](https://toggl.com/hire/customer-story/producement-find-top-remote-product-engineers-with-toggl-hire) by introducing pre-screening technical tests. After adding Toggl Hire to their recruitment stack, Producement has put the first few steps of the hiring process on autopilot.

Once the skills test is set up, candidates start rolling in and are automatically sorted into tiers based on their test scores. Candidates that don’t pass the threshold get instant feedback, while top performers are zipped through the [screening process](https://toggl.com/blog/screening-process-for-hiring) to maintain high interest.
...
By using our [pre-built test library](https://toggl.com/hire/test-library) as part of your screening process, you can efficiently qualify applicants for the interview and focus only on the best-fit candidates.

Our built-in video interviewing capability helps remote hiring teams screen candidates efficiently and asynchronously. Pick up to 3 questions from our library, invite candidates to answer on video, and review recordings at your convenience.
...
A popular screening approach combines a basic skills assessment with a video screening test. Introducing [pre-recorded video interviews](https://toggl.com/blog/pre-recorded-video-interviews) allows the hiring team to evaluate more elusive match factors like work ethic, motivation drivers, and cultural fit – but at scale.
...
To assist with setting up a pre-recorded interview workflow, we have built a pool of behavioral interview questions and soft-skills-focused questions into the platform. Simply pick your question set, invite the candidates, and evaluate answers [at your convenience with asynchronous videos](https://toggl.com/hire/video-intros).
