---
title: "How to write an SOP that doesn't suck"
notion_id: 86a08864-b94e-4906-a69a-c3f2c4574e67
notion_url: https://app.notion.com/p/How-to-write-an-SOP-that-doesn-t-suck-86a08864b94e4906a69ac3f2c4574e67
last_edited: 2023-02-20T01:29:00.000Z
source_url: https://toggl.com/blog/how-to-write-a-standard-operating-procedure
tags: ["Article", "Guide", "Toggl Blog", "English", "Communication", "Documentation", "DevOps", "Programming", "Productivity"]
---
...
SOPs are one of the _best_ strategies to help you scale your business.
...
_But_ SOPs are becoming more common in the agency and professional services space.

[Source](https://www.linkedin.com/posts/maevaeverywhere_we-create-and-publish-70-100-articles-a-month-activity-7026942544114503680-NF9M/)
...
[Scribe SOP example](https://scribehow.com/shared/How_to_add_Zoom_to_Calendly__PNpK2qW0RlO_JknvsU8mTw)
...
[Source](https://ahrefs.com/blog/content-creation/)
...
[McDonald’s sells more than 75 hamburgers per second](https://www.thefiscaltimes.com/Articles/2012/04/30/13-Disturbing-Facts-About-McDonalds), every minute, every hour, every day of the year.

How?

They have _mastered_ standardization.

SOPs are one of the _best_ strategies to claw back your time and help you scale…

### They help you scale

Ask any successful business owner what helped them to scale, and they’ll mention SOPs in some way or another.

I recently contacted a bunch of agency owners with a [survey](https://forms.gle/QWu2VRJoMMeBiik66) asking them how they simultaneously kept on top of multiple client projects.

One answer that kept popping up?

_Processes_ — aka SOPs.

Check out this answer from self-proclaimed “process nerd” [Ryan Stewart](https://rsc.llc/)…

Processes helped Ryan’s digital agency, Webris, [generate millions of dollars for his clients](https://rsc.llc/about/).

By providing clear, step-by-step instructions for performing tasks, SOPs can help ensure that client work is performed to the same standard every time _and _help you scale at breakneck speed! 💰
...
[Source](https://www.reddit.com/r/advertising/comments/su9tj6/turnover_whats_it_like_at_your_agencies/)
...
They provide a set of clear rules so that _anyone_ can deliver work that meets your business’s standards.
...
[Source](https://twitter.com/linkedin_king/status/1375182994785374210)
...
[Source](https://twitter.com/polak_jasper/status/1622210435867987970)
...
Look at this [SOP template](https://www.notion.so/templates/standard-operating-procedure) from Notion — it’s pretty comprehensive!

[Source](https://www.notion.so/templates/standard-operating-procedure)
...
You can use our free [Process Prioritization Worksheet](https://docs.google.com/spreadsheets/d/1tnHPVkvgqCUSDEBtsWj_MRvJD23EWb2XA-A_IAURS_w/) to do this.

[Process prioritization worksheet by Toggl](https://docs.google.com/spreadsheets/d/1tnHPVkvgqCUSDEBtsWj_MRvJD23EWb2XA-A_IAURS_w/edit?usp=sharing)
...
Or, if you want to be smarter with this process, you can also use [time tracking software](https://toggl.com/) to identify your most significant time drainers.

Using a tool like [Toggl Track](https://toggl.com/track/), you can quickly see how long your team spends on project tasks.

Project Dashboard in Toggl Track

You may spot a few tasks that seem to have taken a little longer than usual — which gives you a chance to uncover _why_ and potentially create an SOP to make the task more efficient (profitable). 🤑
...
Flat-rate work _rewards_ you for being _efficient_.
...
Do you charge per hour? You may want to check out our ‘[Flat Rate vs. Hourly](https://toggl.com/blog/flat-rate-vs-hourly)‘ guide.
...
[Source](https://giphy.com/gifs/parksandrec-season-6-parks-and-recreation-rec-um5zgB7txzYeBPZnPZ)

For instance, if a graphic [designer](https://toggl.com/blog/how-to-hire-a-product-designer) makes an infographic, the project manager needs to do a quality check.
...
Any good SOP needs _clear _step-by-step instructions telling your team what to do.

So list a fully _detailed breakdown_ of your chosen task.
...
[Backward planning](https://contentfolks.substack.com/p/backward-planning) helps you break down your usual thought patterns and makes creating your SOPs easier.
...
Here’s an example from [Fio of Contentfolks](https://contentfolks.com/) (click to expand):

[Source](https://contentfolks.substack.com/p/backward-planning)
...
Once you know _what’s_ involved in the process, it’s time to determine_ who’s_ involved.

You need to indicate _who_ does _what_.

Note: simple step-by-step SOPs won’t require multiple stakeholders to be involved. But multiple stakeholders _will_ be involved if you create a more complicated hierarchal SOP.
...
Once you know the _why_, _what_, and _who_ behind your SOP, it’s time to figure out the _how_.

_How_ you create your SOP is entirely up to you.
...
[Notion SOP template](https://www.notion.so/Standard-operating-procedure-a8709e0f96b548868f2222ff6fe375d7)
...
You can track the time the team spends on each task for accurate results using [time tracking software](https://toggl.com/).

Your team can get started tracking time spent on tasks in a few clicks with [Toggl Track](https://toggl.com/track/).

This will give you access to data you can act on inside the [Project Dashboard](https://support.toggl.com/en/articles/3167701-project-dashboard).

Tracking their work like this helped increase [Sweat+Co’s profitability by 20%](https://toggl.com/track/customers/mister-sweat/)
...
**Business Consultant with Sweat+Co**
...
You can download our [free template here](https://docs.google.com/document/d/1avRJOxA7M_ByCqIwVTgA8tF-cMezEijyMaURNzDRVG0/edit?usp=sharing) if you want to stick with Google Docs to create your SOPs.
...
[Scribe](https://scribehow.com/) helps you to turn any process into a step-by-step guide instantly.
...
[Source](https://trainual.com/processes)
