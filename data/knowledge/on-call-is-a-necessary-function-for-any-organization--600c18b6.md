---
title: "On-call is a necessary function for any organization"
notion_id: 600c18b6-7984-4dac-9f44-040970d1190d
...
source_url: https://leaddev.com/technical-direction/call-necessary-function-any-organization
tags: ["On Call", "Change Management", "Line/People/Team Management", "Jobs", "Article", "LeadDev", "English"]
---
...
Having people around to [respond to incidents](https://incident.io/) during off-hours in an appropriate time frame can gain companies a lot of trust from customers and prospects. This is exactly why it’s critical to treat on-call like the lifeline it is by flipping the Three P’s on their head:
...
People need to feel like they are compensated fairly for their time on-call. There’s many different ways people are[ compensated for on-call](https://incident.io/guide/on-call/on-call-compensation/), and while there’s no one-size-fits-all approach, it’s important that folks don’t feel they’re being short-changed for their valuable personal time.
...
- Ensuring folks know the steps to take when something goes wrong. That might be written checklists for every step of the[ incident lifecycle](https://incident.io/guide/response/the-lifecycle-of-an-incident), runbooks, tools or other people engineers can defer to to run the process while they’re fixing
