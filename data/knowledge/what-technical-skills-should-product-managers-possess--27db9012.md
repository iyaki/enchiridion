---
title: "What technical skills should product managers possess?"
notion_id: 27db9012-7bf7-4335-a012-23a032f7edd5
notion_url: https://app.notion.com/p/What-technical-skills-should-product-managers-possess-27db90127bf74335a01223a032f7edd5
last_edited: 2022-12-19T14:20:00.000Z
source_url: https://blog.logrocket.com/product-management/technical-skills-product-managers-should-possess/
tags: ["English", "Product Management", "Career Growth", "Article", "LogRocket Blog"]
---
<!-- image hosted by Notion: its URL expires and is not preserved (ADR-05) -->

“Do I need to know how to code?” is probably one of the most common questions aspiring product managers ask. People wonder how technical they need to be to [crack their next PM interview](https://blog.logrocket.com/product-management/product-manager-interview-questions-how-to-answer/).
...
But what for those aiming for a more [general PM role](https://blog.logrocket.com/product-management/what-does-a-product-manager-do-role-responsibilities/)? Is it time to sign up for a bootcamp? Let’s find out.

## Table of contents

- [Technical skills product managers should have](https://blog.logrocket.com/product-management/technical-skills-product-managers-should-possess/#technical-skills-product-managers-should-have)
...
After all, product managers operate at the [intersection of business, user experience, and technology](https://blog.logrocket.com/product-management/product-marketing-manager-job-description-role-skills/#product-manager-job-description). Not understanding one of those elements would make being a product manager quite difficult.
...
The [software development lifecycle (SDLC)](https://blog.logrocket.com/product-management/what-is-product-development-lifecycle-stages-examples/#pdlc-vs-sdlc-whats-the-difference) is the most important technical concept for product managers to learn. You must understand how the software is actually made; you can’t treat the development process as some sort of a black box where you give the ticket to the team and get back a [done feature](https://blog.logrocket.com/product-management/what-is-definition-of-done-agile-examples/).
...
To learn more, take this [one-hour course](https://www.udemy.com/course/sdlc-phases/) on the phases of the software development lifecycle from Udemy.
...
- How APIs work
- What’s a programming language? How do they differ?
...
As a PM, other skills and competencies have a higher impact on your [performance and career](https://blog.logrocket.com/product-management/product-manager-career-path/) than your ability to code.

### Resources

If you want to hone your programming skills without plunging into the deep end, check out this [“pre-programming” course from Udemy](https://www.udemy.com/course/pre-programming-everything-you-need-to-know-before-you-code/).

### Git workflow

Ever wonder how it’s possible for hundreds of people to work on a single product without interrupting each other?

It’s all thanks to [Git, a distributed version control system](https://blog.logrocket.com/git-workflow-strategies-multiple-teams-single-repository/). Git allows developers to create endless “copies” of the main codebase, work on those copies, and then combine these copies with the original code or even other copies.
...
Atlassian has a robust collection of [Git tutorials](https://www.atlassian.com/git/tutorials) if you’d like to learn more about workflow management using this powerful tool.

### SQL

[SQL](https://blog.logrocket.com/detailed-look-basic-sqljs-features/) stands for Structured Query Language, although I’ve yet to hear someone use the full name. In simple terms, SQL allows you to talk with a database.
...
Understanding SQL allows you to easily filter through the whole database, pull the data that meets your specific criteria, and analyze it. It’s a fundamental skill for [data-driven product management](https://blog.logrocket.com/product-management/how-to-communicate-product-strategy/).
...
Looking to brush up on your SQL skills? Try this [complete SQL bootcamp from Udemy](https://www.udemy.com/course/the-complete-sql-bootcamp/). Or, if you’re just beginning your SQL journey, this [introductory course from W3Schools](https://www.w3schools.com/sql/sql_intro.asp) is a great place to start for PMs.

### DevOps/cloud basics

Understanding [DevOps](https://blog.logrocket.com/from-front-end-developer-to-a-devops-an-intro-to-ci-cd-7a8a8713fb34/) — and, specifically, cloud — helps you see the bigger picture behind the software.
...
If you want to become more proficient in the area of cloud/DevOps, Amazon has you covered. Check out its [cloud practitioner certification](https://aws.amazon.com/certification/certified-cloud-practitioner/?ch=tile&tile=getstarted) program.

### Quality assurance (QA)

Quality assurance (QA) is a more sophisticated practice than you might expect. After all, QAs aren’t paid [$60–80K per year](https://www.salary.com/research/salary/benchmark/quality-assurance-specialist-i-salary) just to randomly click through the app and hunt for bugs.
...
The [International Software Testing Qualifications Board (ISTQB)](https://www.istqb.org/certifications/certified-tester-foundation-level) offers a great QA tester certification program. Udemy also has a [software testing bootcamp](https://www.udemy.com/course/testerbootcamp/) that covers QA testing.
