...
notion_id: 6b48e22e-0de9-42e2-86ff-c6e460f1b6ab
notion_url: https://app.notion.com/p/Notes-on-implementing-dark-mode-6b48e22e0de942e286ffc6e460f1b6ab
last_edited: 2024-06-05T18:35:00.000Z
source_url: https://brandur.org/fragments/dark-mode-notes
tags: ["English", "CSS", "UI/UX", "Article", "Brandur"]
---
...
## [Frontend basics for backend people](https://brandur.org/fragments/dark-mode-notes#frontend-basics)

First, a couple core concepts that’ll be referenced below.

If you’re not a frontend programmer, then you should be aware of the existence of the [`prefers-color-scheme`](https://developer.mozilla.org/en-US/docs/Web/CSS/@media/prefers-color-scheme)[ CSS media selector](https://developer.mozilla.org/en-US/docs/Web/CSS/@media/prefers-color-scheme) which lets a web page react to an OS-level light/dark mode setting:
...
## [Tri-state](https://brandur.org/fragments/dark-mode-notes#tri-state)
...
## [Avoiding theme flicker on load](https://brandur.org/fragments/dark-mode-notes#flicker)
...
## [Theme changes in other tabs](https://brandur.org/fragments/dark-mode-notes#theme-other-tabs)
...
## [Theme changes from the OS](https://brandur.org/fragments/dark-mode-notes#theme-os)

The page should respond to OS-level changes in theme, which is easy via the [`matchMedia()`](https://developer.mozilla.org/en-US/docs/Web/API/Window/matchMedia)[ API](https://developer.mozilla.org/en-US/docs/Web/API/Window/matchMedia):
...
## [Syntax highlighting with Shiki](https://brandur.org/fragments/dark-mode-notes#shiki)
