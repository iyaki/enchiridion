...
notion_id: 17454f1c-7d23-8175-bb46-c13e1de0c4f3
...
source_url: https://refactoringenglish.com/excerpts/rules-for-software-tutorials/
...
8. [Use unambiguous example values](https://refactoringenglish.com/chapters/rules-for-software-tutorials/#use-unambiguous-example-values)
9. [Spare the reader from mindless tasks](https://refactoringenglish.com/chapters/rules-for-software-tutorials/#spare-the-reader-from-mindless-tasks)
...
![image](https://refactoringenglish.com/chapters/rules-for-software-tutorials/beginner-school.png)
...
![image](https://refactoringenglish.com/chapters/rules-for-software-tutorials/fuzz-nix-solution.png)
...
![image](https://refactoringenglish.com/chapters/rules-for-software-tutorials/gcloud-copy.webp)
...
![image](https://refactoringenglish.com/chapters/rules-for-software-tutorials/social-sharing-card.webp)

Here’s how you might show code for cropping an image to fit social media cards:

**Bad: Make the reader guess which numbers are changeable**
...
## **Use unambiguous example values**[**🔗**](https://refactoringenglish.com/chapters/rules-for-software-tutorials/#use-unambiguous-example-values)
...
-- and favorite foods.
CREATE TABLE pets ( pet_name TEXT NOT NULL, favorite_food TEXT NOT NULL
);
...
### **Use example values that looks like real-world data**[**🔗**](https://refactoringenglish.com/chapters/rules-for-software-tutorials/#use-example-values-that-looks-like-real-world-data)
...
Software blogger Thorsten Ball calls this technique ["[using] data that looks like data."](https://registerspill.thorstenball.com/p/use-data-that-looks-like-data)

It’s fine to theme your examples to a TV show or movie, but consider whether it will confuse readers unfamiliar with what you’re referencing. Any reader can recognize `"Jim Halpert"` as a person’s name even if they haven’t seen _The Office_. But if you’re a _Star Trek_ fan, please don’t use `"Data"` as an example name, as it’s quite confusing to people who don’t know the show.
...
1. 1. Why Choose Go?
2. 2. Install Go 1.23
3. 3. Create a Basic “Hello, World” Go App
4. 4. Deploy Your App to the Web
...
1. 1. How I Installed Go 1.23
2. 2. Step 2: Your First App
3. 3. How I package Go apps
4. 4. Part D: How you’ll deploy your App
...
1. 1. Why Go?
2. 1. The history of nginx
3. 2. Configuring nginx for local access
4. 
5. 
6. 2. Creating your First Go app
7. 1. Why Go is better than Perl
8. 
9. 3. Serve a basic page
...
![image](https://refactoringenglish.com/chapters/rules-for-software-tutorials/nginx-success.webp)
