---
title: "UptimeRobot - Website Monitoring"
notion_id: acb41bf4-987b-4e98-8f39-361f2e6cb4cb
...
7. Sign up and create a free UptimeRobot account
8. Create your first monitor (so there's something to display)
9. Go to Status Pages and click Create Status Page
10. Select the monitors (or tags) you want to show, then name the page
11. Publish your status page
12. Optionally: customize the design, set a custom domain, password-protect it, opt out of search engine indexing, and use announcements for incident/maintenance updates (users can subscribe with email right on your status page).
