...
notion_id: 2081dede-ba79-4264-bc42-0b646b7362a5
notion_url: https://app.notion.com/p/HTML-The-Bad-Parts-2081dedeba794264bc420b646b7362a5
last_edited: 2023-12-19T14:00:00.000Z
source_url: https://www.htmhell.dev/adventcalendar/2023/13/
tags: ["Article", "HTMHell - Advent Calendar", "English", "Web Development", "HTML"]
---
...
**Further reading**: [`<select>`](https://www.24a11y.com/2019/select-your-poison-part-2)[ your poison part 2: test all the things](https://www.24a11y.com/2019/select-your-poison-part-2) (article by Sarah Higley).
...
At first, the [`datalist`](https://developer.mozilla.org/en-US/docs/Web/HTML/Element/datalist)[ element](https://developer.mozilla.org/en-US/docs/Web/HTML/Element/datalist) sounds like a promising alternative to custom comboboxes. The more you use it though, the more disappointed you'll find yourself.
...
- Chrome/Blink: [https://bugs.chromium.org/p/chromium/](https://bugs.chromium.org/p/chromium/)
- Firefox/Gecko: [https://bugzilla.mozilla.org/](https://bugzilla.mozilla.org/)
- Safari/WebKit: [https://bugs.webkit.org/](https://bugs.webkit.org/)
...
Website/Blog: [mayank.co](https://www.mayank.co/)
