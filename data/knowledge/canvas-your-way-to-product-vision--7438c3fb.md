...
Your workshop can be run in person, using a huge wall, washi tape, and some post-it notes, or online using a virtual whiteboard tool like Miro or Mural _(_[_get the Miro template_](https://miro.com/miroverse/product-vision-canvas/)_)_. I like to block 4- or 6-hours so that the activity doesn’t feel rushed. This will provide plenty of time for working in small groups, discussing, sharing back, affinity mapping, and then coming to alignment. Additionally, I like to combine this workshop with other activities to create a perfect kickoff week _(there’s a list of ideas at the end of this article)_.
...
These are solutions and not problems. A [problem statement](https://www.toptal.com/designers/product-design/design-problem-statement) is not a solution phrased another way. The more specific your problem statement, the better.
...
## [Stanford’s d. School](https://www.interaction-design.org/literature/article/stage-2-in-the-design-thinking-process-define-the-problem-and-interpret-the-results) says that a **good** problem statement:
...
- I am (_persona_) trying to (_complete X JTBD_) but (_X is in persona’s way_) because (_reason_), which makes me feel (_emotion_).
- (_Persona_) needs a way to (_solve X need_) because (_pain point_).
...
Once the main prompts of the board are filled in, it’s time to come up with your [experience principles](https://archive.substantial.com/blog/2018/4/30/you-need-experience-principles). **Experience principles**, sometimes called design principles, reflect your product’s core values and priorities.
...
And last, it’s time for your **product vision statement**. A good product vision is both aspirational and actionable. It should describe the _why_ behind your product and illustrate the _value_ your product brings to your users.
...
You _can_ use a [templated approach](http://burozeven.nl/robbinschuurman/wp-content/uploads/2017/11/Screen-Shot-2014-11-24-at-12.36.14-1024x448.png) for your product vision statement. But, I would advocate for something shorter and therefore easier to remember, like this one: “Our vision is to burst filter bubbles with equal, unbiased access to news.” A great vision statement can be recalled by every member of your extended team.
...
- [https://medium.com/the-heroic/why-your-product-vision-might-be-more-critical-than-your-company-mission-ac29dc44e15c](https://medium.com/the-heroic/why-your-product-vision-might-be-more-critical-than-your-company-mission-ac29dc44e15c)
- [https://www.productplan.com/glossary/product-vision/](https://www.productplan.com/glossary/product-vision/)
- [https://www.clearvoice.com/blog/difference-between-mission-vision-statement-examples/](https://www.clearvoice.com/blog/difference-between-mission-vision-statement-examples/)
- [https://www.scrum.org/resources/blog/10-tips-product-owners-product-vision](https://www.scrum.org/resources/blog/10-tips-product-owners-product-vision)
...
The reason is simple — it’s _hard_ to get all of the ideas into a single page, even if you cheat a bit by reducing the font size. Summarizing the content for the canvas will help you prioritize and form a point of view about your product, feature, or company vision.
...
If you’re interested in running the product vision workshop as part of [inception](https://medium.com/agile-outside-the-box/inception-getting-to-rapid-alignment-on-team-vision-and-goals-47cc60b0cb9) or similar project/feature kickoff, I recommend combining with these activities:

- Analysis of product analytics, customer support/success insights, user research, market research, etc.
- Get everyone in the right headspace by going over these [brainstorming rules from IDEO](http://www.designkit.org/methods/28)
- [Empathy mapping for key personas](https://cdn-images-1.medium.com/max/2600/1*I1ffOWdPWQva3dCMQE-TAQ.png) (max 2–3)
- Brainstorm: Problem and opportunity space
- Brainstorm: JTBD with pains and gains
- Brainstorm additional statements to support your product vision statement, including: customer opportunity statement, customer value proposition, business opportunity statement, business value proposition _(These extra statements are particularly helpful when user opportunities might differ from business opportunities)_
...
- [Trade-off sliders](https://www.atlassian.com/team-playbook/plays/trade-offs)
- Brainstorm: Looking ahead to your go-to-market plans, you can run the [Product in a box](https://gamestorming.com/design-the-box/#:~:text=In%20this%20exercise%2C%20teams%20create,are%20more%20difficult%20to%20articulate.), [Project poster](https://www.atlassian.com/team-playbook/plays/project-poster), or [Amazon’s press release](https://andreamarchiotto.medium.com/amazon-press-release-how-to-55d61188ecdd) activities
