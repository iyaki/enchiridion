---
title: "How to break the cycle of firefighting"
notion_id: 16754f1c-7d23-81ec-bff9-ff2e6095ba84
notion_url: https://app.notion.com/p/How-to-break-the-cycle-of-firefighting-16754f1c7d2381ecbff9ff2e6095ba84
last_edited: 2025-02-10T18:18:00.000Z
source_url: https://leaddev.com/management/how-break-cycle-firefighting
tags: ["LeadDev", "English", "Help Desk", "Line/People/Team Management", "Entrepreneurship", "Decision Making", "Change Management", "Article"]
---
![image](https://res.cloudinary.com/leaddev/image/upload/f_auto/q_auto/dpr_auto/c_limit,h_2048,w_2048/next/2024/12/2-1.png)





If you find yourself fighting fires all day, losing time on strategic elements of your role, take a step back to assess the patterns and beliefs that got you there.
...
![image](https://res.cloudinary.com/leaddev/image/upload/f_auto/q_auto/dpr_auto/c_limit,h_1024,w_1024/next/2024/12/Screenshot-2024-12-24-at-11.19.01.png)
...
- **Inefficient resource allocation**: teams are understaffed during critical periods, [leading to burnout](https://leaddev.com/culture/four-ways-protect-yourself-burnout) and mistakes.
...
- **Communication silos**: [departments not sharing information effectively](https://leaddev.com/communication/want-promote-knowledge-sharing-your-teams-standardize-way-you-take), causing misalignment and delays.
...
- **Underestimating the importance of communication**: not valuing [cross-department collaboration](https://leaddev.com/communication/leaders-guide-fostering-effective-cross-team-collaboration), leading to isolated teams.
...
[Addressing and reshaping underlying beliefs](https://leaddev.com/management/how-bring-about-positive-cultural-change-your-team) is crucial for sustainable change. If there’s a “speed over quality” mindset leading to product defects:
...
Establishing clear organizational structure and team interactions forms the foundation of effective systems. While no longer current practice at Spotify,[ Henrik Kniberg’s influential 2012 model of scaling agile organizations](https://blog.crisp.se/wp-content/uploads/2012/11/SpotifyScaling.pdf) demonstrates this through several key concepts.

The model organizes autonomous, cross-functional squads that operate like mini-startups, each owning a specific part of the product lifecycle. It scales collaboration through [tribes](https://www.wrike.com/agile-guide/squads-tribes-guilds/) – collections of squads working in related areas – to maintain coordination without sacrificing autonomy.

The model also builds expertise through [chapters](https://www.adaptovate.com/agile/what-are-chapters-in-an-agile-operating-model/#:~:text=Chapters%20are%20a%20way%20of,information%2C%20technologies%2C%20and%20methodologies.), where specialists across different squads share knowledge and practices. This structure exemplifies how clear roles and responsibilities can create self-sustaining systems that balance autonomy with collaboration.

### **2. Knowledge and skills**

[Developing a learning culture](https://leaddev.com/culture/beginners-guide-building-sustainable-learning-culture) enables organizations to adapt and innovate continuously. Microsoft’s transformation under Satya Nadella, chronicled in his[ 2017 book “Hit Refresh](https://news.microsoft.com/hitrefresh/),” showcases how even large enterprises can fundamentally reshape their culture:
...
Microsoft also prioritized psychological safety which encouraged questioning, learning, and challenging the status quo. Leaders achieved this by actively soliciting diverse viewpoints in meetings, responding positively to challenges of their own ideas, and establishing[ “no-blame” policies](https://leaddev.com/culture/5-takeaways-running-50-postmortems) for raising concerns. They created formal channels for anonymous feedback and suggestions, while also training managers to respond constructively to new ideas and concerns. Regular town halls and open forums were established where employees at all levels could question existing practices and propose alternatives without fear of negative consequences.

### **3. Processes and rituals**

Establishing consistent operational practices ensures reliability and enables innovation. Drawing from their extensive experience operating large-scale systems,[ Google’s Site Reliability Engineering teams](https://sre.google/sre-book/) have pioneered practices that demonstrate this.

Their teams implement [error budgets](https://cloud.google.com/blog/products/management-tools/sre-error-budgets-and-maintenance-windows) – a concept that gives teams a specific allowance for acceptable system failures. They define clear service level objectives (SLOs) that ensure technical decisions directly connect to customer impact.

Their teams also follow a structured [post-incident analysis process](https://sre.google/workbook/incident-response/) that goes beyond just fixing immediate problems. Each incident triggers a formal review with a standardized template covering what happened, why it happened, its impact, and the broader systematic improvements needed. This systematic approach has helped Google build institutional memory and continuously improve their operational practices

### **4. Tools and equipment**

Building and maintaining the right tooling infrastructure enables teams to work effectively.[ Netflix’s engineering organization](https://netflixtechblog.com/), renowned for its open-source contributions and innovative practices, demonstrates this through several groundbreaking approaches.

Netflix pioneered chaos engineering through tools like Chaos Monkey, which randomly terminates instances in production to ensure systems can handle unexpected failures. [This tool simulates real-world failures by deliberately causing outages](https://netflixtechblog.com/netflix-chaos-monkey-upgraded-1d679429be5d) during business hours when engineers are available to respond. This forces teams to build resilient systems that can handle failures gracefully. Netflix has built deployment pipelines that automate the process of moving code from development to production. These pipelines include automated testing, security scanning, canary deployments (rolling out changes to a small subset of users first), and one-click rollbacks if issues are detected.

For custom testing tools, Netflix developed and open-sourced several frameworks that others can learn from. [The failure injection testing (FIT) framework](https://netflixtechblog.com/fit-failure-injection-testing-35d8e2a9bb2) allows teams to inject failures at the application level rather than the infrastructure level. For organizations looking to develop their own testing tools, [Netflix’s engineering blog](https://netflixtechblog.com/tagged/testing) provides examples of their approach to testing distributed systems..

**5. Observability and metrics**

Creating comprehensive system visibility enables data-driven operations.[ AWS’s Well-Architected Framework](https://docs.aws.amazon.com/wellarchitected/), demonstrates effective observability through several key practices that have transformed how organizations monitor and respond to system behavior.
...
Implementing a performance management system fosters a culture of accountability and continuous improvement. Netflix’s widely studied high-performance culture, recently reaffirmed in their[ 2024 culture memo](https://jobs.netflix.com/culture), demonstrates this.
