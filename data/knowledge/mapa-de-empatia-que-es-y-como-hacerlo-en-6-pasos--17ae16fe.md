...
Imagina entrar en la mente de tu [público objetivo](https://www.rdstation.com/es/blog/publicos-objetivos-en-marketing-y-publicidad/), comprender lo que él desea y así, ofrecer productos, servicios y atención más adecuados.
...
Ahora, imagina retirar esos sentimientos del [plano de las ideas](https://www.rdstation.com/es/blog/lluvia-de-ideas-5-tecnicas-efectivas/) y colocarlos sobre el papel, dividiéndolos en categorías como dolores, necesidades y sentimientos, en cuadrantes que facilitan la visualización. Es así que funciona el mapa de empatía. Como su nombre lo dice,** la idea es detallar la personalidad del cliente para comprenderlo.**

_Tal vez quieras aprender sobre: _[_**«Lluvia de ideas: 5 técnicas efectivas para estimular la creatividad».**_](https://www.rdstation.com/es/blog/lluvia-de-ideas-5-tecnicas-efectivas/)
...
- Clasificar y dar sentido a la investigación cualitativa, como notas de investigación, respuestas a encuestas, entrevistas, entre otros.
...
El mapa de empatía puede ser diseñado en una pizarra, _flip chart_, papel o en computador. Cuando es hecho en papel, es común que sea completado con post-its. Independiente del soporte elegido, este debe ser dividido de la siguiente manera:
...
Antes de eso, una etapa que sería la número cero es la de estudiar previamente el [comportamiento de tus clientes ideales](https://www.rdstation.com/es/blog/publicos-objetivos-en-marketing-y-publicidad/) es crear una persona — un personaje ficticio construído a partir de etnografía de personas reales, con características sicológicas, que representa un grupo con cualidades y comportamientos parecidos.

Para esto, lo ideal es que tengas una audiencia mínima: personas que siguen tu empresa en [redes sociales](https://www.rdstation.com/es/redes-sociales), que les gusta lo que es publicado e incluso quienes ya son clientes.

A partir de esto, puedes compartir tus resultados con otras personas del equipo y hacer un [brainstorming](https://www.rdstation.com/es/blog/brainstorming-que-es/) para presentar ideas y recibir sugerencias de los colegas, que pueden caracterizar los segmentos de clientes. Además de eso, debes otorgar un nombre y edad, que ayudará a dar una noción de quién se trata.

_Puede interesarte leer el Blog: _[_**«Qué es un brainstorming y cómo ayuda a tu negocio».**_](https://www.rdstation.com/es/blog/brainstorming-que-es/)
...
Tiene relación con lo que puedes colocar en práctica para sorprender a tu [público objetivo](https://www.rdstation.com/es/blog/publico-objetivo-cliente-ideal-buyer-persona/), mostrándote posibilidades. Cuestiona sobre:
...
El mapa de empatía abajo tiene por objetivo describir el [cliente ideal](https://www.rdstation.com/es/blog/como-atraer-buenos-clientes-agencia/) de una empresa de cursos de especialización a distancia, pero puede servir de inspiración para crear el tuyo, independiente del segmento de tu negocio.
...
Tiene 2 hijos y divide las tareas con su marido, además de tener una gran colaboración de sus padres en la crianza de ellos. Siempre que lo necesita, los abuelos cuidan de los nietos. Le gusta ir al restaurante con su marido y amigas para tener un tiempo para sí misma, tomar su vino favorito en el restaurante que sea tendencia en el momento.
...
Está en la búsqueda de nuevos conocimientos como gestión, metodologías ágiles, [Marketing Digital](http://www.rdstation.com/es/marketing-digital/) y otros que puedan agregar a su currículo y en el día a día en la empresas para mejorar su desempeño y ser más reconocida, pues sueña con llegar a ser la directoria de la empresa.
...
¿Quieres aprovechar una herramienta que te ayude a sacarle provecho a toda tu estrategia y optimizar tu generación de oportunidades reales? Llena el formulario abajo y comienza a usar** RD Station Marketing** gratis ahora.
...
RD Station Marketing es un software para que tu empresa realice mejores campañas, nutra Leads, genere oportunidades de negocio calificadas y logre más resultados. De las redes sociales al email, de las Landing Pages a los pop-ups, desde la automatización hasta el análisis de tus resultados. Prueba Gratis por 10 dias.

¡Hasta la próxima!

_Este artículo fue publicado el 7 de diciembre de 2017 y actualizado el 22 de febrero de 2021._
