---
title: "I finally understand Cloudflare Zero Trust tunnels | David Mohl"
notion_id: 2b754f1c-7d23-812f-b6dd-efcc729df5d9
notion_url: https://app.notion.com/p/I-finally-understand-Cloudflare-Zero-Trust-tunnels-David-Mohl-2b754f1c7d23812fb6ddefcc729df5d9
last_edited: 2025-11-26T19:10:00.000Z
source_url: https://david.coffee/cloudflare-zero-trust-tunnels
tags: ["English", "DevOps", "Cloud", "Networking", "Software Architecture", "Article", "David Mohl"]
---
![image](https://david.coffee/cloudflare-zero-trust-tunnels/banner.jpeg)
...
![image](https://david.coffee/cloudflare-zero-trust-tunnels/routes-configure.png)

Configuring a route in Zero Trust
...
_If the Warp client is __**not**__ connected, 192.168.1.3 will just resolve in your current local network. If connected, it will resolve to the tunnel._
...
![image](https://david.coffee/cloudflare-zero-trust-tunnels/targets-config-screen.png)

Configuring a target in Zero Trust
...
![image](https://david.coffee/cloudflare-zero-trust-tunnels/policy-github-emails.png)

Configuring an Access Policy with GitHub and email
...
In **Enrollment Permissions**, we specify the same policies for who can enroll. For example, “foo.bar@domain.com” when authenticated through GitHub is allowed to enroll. In the _Login Methods_ we can specify what login methods are available when someone tries to enroll into our Zero Trust org.

![image](https://david.coffee/cloudflare-zero-trust-tunnels/enrollment-policy-login-methods.png)

Login methods enroll policies
