...
notion_id: a16d5ccc-0417-4954-b89f-56d258396870
notion_url: https://app.notion.com/p/Web-security-demystified-WASEC-a16d5ccc04174954b89f56d258396870
last_edited: 2023-02-22T19:14:00.000Z
source_url: https://odino.org/web-security-demistified/
tags: ["Book", "Article", "English", "Information Security", "Web Development"]
---
This post is part of the ”[**WASEC: Web Application SECurity**](https://odino.org/categories/wasec/)” series, which is a portion of the content of [WASEC](https://leanpub.com/wasec), an e-book on web application security I’ve written.

Here is a list of all the articles in this series:

If you’ve enjoyed the content of this article, consider buying the complete ebook on either the [Kindle store](https://www.amazon.com/WASEC-Application-Everything-developer-application-ebook/dp/B081Z7SD48) or [Leanpub](https://leanpub.com/wasec).

I’ve been thinking of writing a long article around _everything a web developer should know about application security_ for quite some time, and it’s clear to me that this mastodontic exercise is never going to take place all at once.
...
It’s been a while I’ve been thinking of _writing_ something meaningful: not that I think my previous articles are terrible, but I always wanted to try to make something more “durable” — if you get what I mean.
...
Not at all, that’s why I’d like to emphasize that **this is content for the everyday software engineer** that writes web applications: I’ve made a living of writing web apps for [various employers](https://www.linkedin.com/in/alessandronadalin/), and have seen things going south as well as strong, solid approaches to security — with this, I’m simply trying to share my experience and what I like to keep in mind when trying to secure web applications.
...
If you have followed me throughout the years, you surely noticed how I like to open-source as much as possible: helping the community comes first, the same way it helped me — if it wasn’t for the first conference I attended, I would have never become the kind of software engineer I am today (hint: _a very bad one!_).
