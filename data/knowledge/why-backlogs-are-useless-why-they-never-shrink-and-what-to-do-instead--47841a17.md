...
notion_id: 47841a17-e530-4f9f-8e4b-d1bf5609ae0b
notion_url: https://app.notion.com/p/Why-backlogs-are-useless-why-they-never-shrink-and-what-to-do-instead-47841a17e5304f9f8e4bd1bf5609ae0b
last_edited: 2023-02-16T19:57:00.000Z
source_url: https://lucasfcosta.com/2023/02/07/backlogs-are-useless.html
tags: ["English", "Agile", "Project Management", "Product Management", "Productivity", "Article", "Lucas F. Costa Blog"]
---
Do you remember your backlog ever shrinking? Of course you don’t. Backlogs _never_ shrink.

Backlogs never shrink because the list of things we’d _eventually_ like to do never shrinks, and **that’s what backlogs are: a bunch of unimportant tasks that we’ll **_**eventually**_** get to, but not today.**
...
As the backlog grows, cycle-times elongate, increasing the chance that an engineer will pick-up a "rotten" task unless a product manager has spent significant time keeping that task up-to-date.
...
Whenever product allows any task to go into the backlog, they ensure engineering will be a bottleneck. Besides being an expensive resource, processing tasks at a lower level of abstraction is slower.
...
By adding a buffer in front of the teams "task list", teams move the bottleneck to where it's cheaper. That's because refusing tasks at a higher level of abstraction is quicker and easier than implementing them.
...
**If you’d like to have a chat, **[**you can book a slot with me here**](https://calendly.com/lucasfcosta/1-1-with-lucas). I’d love to talk about ephemeral environments, what we’re building at [Ergomake](https://www.ergomake.dev/), or simply Agile in general.
