...
tags: ["Article", "Lucas F. Costa Blog", "English", "Product Management", "Project Management"]
---
...
3. Can compare the product’s benefit to its cost
...
2. The automatable agency — Selling consulting engagements which you can gradually automate
...
The Minimum Viable Nothing for a CLI-based CI service
...
The original mechanical Turk: a fraudulent chess-playing machine in which a human would control the "robotic" Turk against which people would play
