---
title: "A step-by-step breakdown of the UX design process"
notion_id: 46a9cb83-3338-4955-8728-718bf9d4d524
notion_url: https://app.notion.com/p/A-step-by-step-breakdown-of-the-UX-design-process-46a9cb83333849558728718bf9d4d524
last_edited: 2023-05-18T11:26:00.000Z
source_url: https://blog.logrocket.com/ux-design/step-by-step-breakdown-ux-design-process/
tags: ["English", "UI/UX", "Product Management", "Article", "LogRocket Blog"]
---
...
- [Phases of the UX design process](https://blog.logrocket.com/ux-design/step-by-step-breakdown-ux-design-process/#phases-of-the-ux-design-process) 
- [User research](https://blog.logrocket.com/ux-design/step-by-step-breakdown-ux-design-process/#user-research) 
- [Techniques involved in user research](https://blog.logrocket.com/ux-design/step-by-step-breakdown-ux-design-process/#techniques-involved-in-user-research)
- [Methods of analyzing user research](https://blog.logrocket.com/ux-design/step-by-step-breakdown-ux-design-process/#methods-of-analyzing-user-research)
- [Design](https://blog.logrocket.com/ux-design/step-by-step-breakdown-ux-design-process/#design) 
- [Methods of generating and evaluating the design](https://blog.logrocket.com/ux-design/step-by-step-breakdown-ux-design-process/#methods-of-generating-and-evaluating-the-design)
- [Test](https://blog.logrocket.com/ux-design/step-by-step-breakdown-ux-design-process/#test) 
- [Importance of user testing](https://blog.logrocket.com/ux-design/step-by-step-breakdown-ux-design-process/#importance-of-user-testing)
- [Techniques involved in the testing phase](https://blog.logrocket.com/ux-design/step-by-step-breakdown-ux-design-process/#techniques-involved-in-the-testing-phase)
- [Develop](https://blog.logrocket.com/ux-design/step-by-step-breakdown-ux-design-process/#develop) 
- [Techniques involved in the development phase](https://blog.logrocket.com/ux-design/step-by-step-breakdown-ux-design-process/#techniques-involved-in-the-development-phase)
...
[Learn more →](https://lp.logrocket.com/blg/pm-demo-signup)
...
The research method also affects the tools for data collection, time allocated to the research, and so on. You have several research methods to choose from. We have a [guide that covers the main UX research methods](https://blog.logrocket.com/ux-design/ux-research-methods/), but we’ll also go over the two that will come up again and again in the UX profession:

- [**Interviews**](https://blog.logrocket.com/ux-design/mastering-ux-user-interviews/)**:** Interviews are one of the primary ways of collecting data from target users. This is usually done one on one or over the phone. It is an in-depth discussion between an interviewer and a user or target user. Interviews are designed to help the interviewer or user experience designer identify user needs and wants. They can be done in person at the office or remotely over a Zoom call. Tools like recorders and notepads are essential during interviews to retain information. An advantage of this is that the designer can ask follow-up questions on any answer that is not clear; also, they get to watch the user as they answer and take notes on body language.
- [**Online surveys**](https://blog.logrocket.com/ux-design/design-conduct-ux-survey/)**:** Surveys are usually online forms with questions regarding the product. Researchers use them to get user perspectives on a launched or a budding product.Design teams collect and compile the gathered data in a database to review.A couple popular, easy-to-use tools for online surveys are [Google Forms](https://docs.google.com/forms/) and [SurveyMonkey](https://www.surveymonkey.com/). These tools keep the responses from users intact and easily accessible. The pro of this method is that it can be used to reach a wider and more diverse range of users. Cons include users may not be completely honest and expressive compared to one-on-one interviews.
...
- [**Persona**](https://blog.logrocket.com/product-management/user-persona-template-examples/)**:** Personas are fictional characters with real-life characteristics and experiences. They are needed to create a sense of empathy among team members and communicate user needs to stakeholders. They visually represent user needs and expectations that can be discussed with the team and stakeholders.
...
## [LogRocket](https://lp.logrocket.com/blg/pm-demo-signup): Analytics that give you UX insights without the need for interviews

[LogRocket](https://lp.logrocket.com/blg/pm-demo-signup) lets you replay users' product experiences to visualize struggle, see issues affecting adoption, and combine qualitative and quantitative data so you can create amazing digital experiences.

See how design choices, interactions, and issues affect your users — [try LogRocket today](https://lp.logrocket.com/blg/pm-demo-signup).
