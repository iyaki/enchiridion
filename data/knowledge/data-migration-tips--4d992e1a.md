...
notion_id: 4d992e1a-2210-425e-aec0-c7890b9b8661
notion_url: https://app.notion.com/p/Data-Migration-Tips-4d992e1a2210425eaec0c7890b9b8661
last_edited: 2023-02-16T19:38:00.000Z
source_url: https://www.endpointdev.com/blog/2023/02/migration-tips-and-tricks/
tags: ["English", "Databases", "DevOps", "Programming", "SysAdmin", "Article"]
---
<!-- image hosted by Notion: its URL expires and is not preserved (ADR-05) -->

When you’re in the business of selling software to people, you tend to get a few chances to migrate data from their legacy software to your shiny new system. Most recently for me that has involved public health data exported from legacy disease surveillance systems into [PostgreSQL databases](https://www.endpointdev.com/expertise/postgresql/) for use by the open source [EpiTrax system](https://www.endpointdev.com/expertise/epitrax/) and its companion [EMSA](https://www.endpointdev.com/expertise/emsa/).
...
Speaking of working out solutions together, I’d love your help improving this list. What keys have you found are important for data migration projects? I welcome your comments. And if you’re looking for someone to handle a data migration project for you, [give us a call](https://www.endpointdev.com/contact/)!

## Comments

Visit the [**GitHub Issue**](https://github.com/EndPointCorp/end-point-blog/issues/1936) to comment on this post.
...
- As early in the project as possible, give us a copy of _all_ the data as it is now, complete, unmodified, in its messy actual state in the standard export format for the database it lives in.
