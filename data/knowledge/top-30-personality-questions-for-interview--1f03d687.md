---
title: "Top 30 Personality Questions for Interview"
notion_id: 1f03d687-d3ea-44f8-ace5-c1b0313fd6e2
notion_url: https://app.notion.com/p/Top-30-Personality-Questions-for-Interview-1f03d687d3ea44f8ace5c1b0313fd6e2
last_edited: 2023-04-18T12:42:00.000Z
source_url: https://toggl.com/blog/personality-questions-for-interview
tags: ["Article", "Toggl Blog", "English", "Human Resources (HH.RR.)"]
---
<!-- image hosted by Notion: its URL expires and is not preserved (ADR-05) -->

**The interview process isn’t just about understanding the technical strengths and weaknesses of a candidate, it’s also about getting to know their **_**personality**_**.**
...
_Tip!_ If you already know the difference between good and bad personality traits, and why you should ask personality questions in interviews, skip straight to the part with the questions!
...
- Although there is no right or wrong answer to these types of questions, candidates can reveal a lot about themselves by answering personality interview questions. However, keep in mind that personality tests and interviews **do not **[**predict future job performance**](https://toggl.com/blog/what-is-pre-employment-skills-testing)!
- **Combine personality interview questions** from the list below [**with job-specific skills assessments**](https://toggl.com/hire/test-library) to evaluate candidates’ soft skills and personality traits without any bias.

## Why ask personality questions in an interview?

Asking personal interview questions will help you to understand the job seeker’s personal and professional life. They’re also a great way to compare candidates with similar [hard skills](https://toggl.com/blog/testing-hard-skills) and select those who are a **better fit for your company culture**.
...
- Evaluate critical **soft skills**, such as teamwork, [communication](https://toggl.com/blog/communication-skills-assessment), and presentation.
- Understand how the [potential candidate might ](https://toggl.com/blog/the-5-communication-styles-every-manager-needs-to-know)[**interact**](https://toggl.com/blog/the-5-communication-styles-every-manager-needs-to-know) with internal (colleagues, managers) and external (customers, suppliers) peers and stakeholders.
- See whether they are [a fit for the team](https://toggl.com/blog/organizational-culture-fit), company culture, mission, and values.
...
## Should you assess for _good_ and _bad_ personalities?

Job seekers are only human, each naturally possessing a unique mix of “good” and “bad” personality traits. When [assessing personality](https://toggl.com/blog/personality-types-hiring-process), hiring managers look for self-awareness, as well as those traits that are unique to them. For example:
...
In sum, hiring managers use personality questions to help them **discover the mix of positive and negative personality traits** of a potential candidate, to ensure they have the right level of [emotional intelligence](https://toggl.com/blog/emotional-intelligence-test), social skills, and attitude for the role.

## 9 examples of positive personality traits

Examples of ‘good’ or positive personality traits | [Source](https://www.indeed.com/career-advice/career-development/character-traits-definition-and-examples)
...
1. **Integrity** — Demonstrates honesty, accountability, and responsibility in both their professional and personal life. Important for roles with a lot of responsibility.
2. **Passion** — Exhibits excitement, ambition, and commitment to their work and team. Especially relevant for roles that require a lot of energy and dedication.
3. **Humor** — Possesses a great sense of humor that uplifts the atmosphere. And understands when it is appropriate, and when is is not.
4. **Leadership** — Can motivate and direct teams. Of course, important for manager and leadership roles, but also team leads, and candidates with high potential.
5. **Organization** — Possesses excellent organizational skills and consistently meets deadlines. Essential for managerial and administrator type roles.
6. **Communication** — Expresses ideas and concerns clearly. Necessary for most roles, and critical for positions that require strategic planning or persuasion.
7. **Optimistic** — Possesses an optimistic attitude. And a winning combination with natural problem-solvers and perseverance to find solutions where others cannot.
8. **Honest** — Is honest and transparent with themselves and others. Not to be mistaken with bluntness, honesty is important for roles that have a high level of accountability.
9. **Respectful **— Shows courtesy and respect to all. A trait that is important for people and customer-facing roles.

## 6 examples of negative personality traits

How is the Dark Triad Personality measured? | [Source](https://www.thehumancapitalhub.com/articles/dark-triad-of-personality-everything-you-need-to-know)

We all have our share of [negative personality traits](https://toggl.com/blog/dark-triad-in-the-workplace). But sometimes, they can have harmful effects on a person’s relationships and work. When evaluating candidates for a role, gaining an understanding of their negative traits can make all the difference in who gets the job.

1. **Tardiness** — Poor time management when it comes to working hours and deadlines. But often tolerated for creative types or roles where the individual can work to their own schedule.
2. **Short temper** — A person who is easily angered and will only see the negatives of their coworkers. Common amongst leaders under pressure, but usually a poor fit for roles that require a cohesive team to succeed.
3. **Unorganized** — Poor prioritization and disorganization in filing or managing daily tasks. Lack of organization can be inconsequential for certain roles, and inexcusable for others!
4. **Arrogance** — Thinking they know it all and are unwilling to listen to the advice of others. Often confused with confidence, some finance professions are famous for this trait, while it wouldn’t take you far in others.
5. **Selfishness** — Always looking out for their own interests at the expense of others. Undesirable for roles that require empathy, teamwork, and strong collaboration.
6. **Manipulative** — Using people and their emotions to their advantage. Probably the hardest trait to detect, but one that can have huge consequences when combined with roles of power.

The best way to unearth a candidate’s negative personality traits is by [**asking behavioural questions**](https://toggl.com/blog/behavioral-interview-questions)** **along with personality interview questions.
...
As we’ve already touched upon, different occupations demand different personality traits, as well as [diverse soft skills for success](https://toggl.com/blog/soft-skills-assessment-test).
...
- **Developers** must be analytical with high [attention to detail](https://toggl.com/blog/how-to-assess-attention-to-detail-in-job-applicants) to test and troubleshoot software programs.
...
Companies use Toggl Hire skills tests to find the best candidates with the skills to match.
...
Try to see the real person behind the interviewing skills.

**Here are 10 personality interview questions you can use (**_**and remember, there are no right or wrong answers**_**):**
...
Generic answers won’t help when it comes to work/life balance.
...
Don’t make the mistake – hiring for a culture fit doesn’t mean you should look for ‘clones’.
...
Look out for answers that show the candidate’s values and how they fit with the company culture, as well as their communication and [problem-solving skills](https://toggl.com/blog/problem-solving-skills-at-work).
...
At Toggl Hire, we offer [skills assessments](https://toggl.com/blog/competency-skills-assessments) that include a comprehensive list of **personality-based interview questions** to help you assess soft skills and make better hiring decisions, so you can focus on what you do best.
