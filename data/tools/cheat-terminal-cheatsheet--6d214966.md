---
title: "cheat - terminal cheatsheet"
notion_id: 6d214966-a1f8-4d89-9820-8f5df2b9b91e
notion_url: https://app.notion.com/p/cheat-terminal-cheatsheet-6d214966a1f84d8998208f5df2b9b91e
last_edited: 2022-12-21T14:00:00.000Z
source_url: https://github.com/cheat/cheat
tags: ["Tool", "CheatSheet", "English", "Linux", "Untried"]
---
...
```plain text
--- syntax: javascript tags: [ array, map ] --- // To map over an array: const squares = [1, 2, 3, 4].map(x => x * x);
```
...
```plain text
# bash (user-local) mkdir -p ~/.local/share/bash-completion/completions cheat --completion bash > ~/.local/share/bash-completion/completions/cheat # bash (system-wide) cheat --completion bash > /etc/bash_completion.d/cheat # zsh (ensure the directory is on your fpath) cheat --completion zsh > "${fpath[1]}/_cheat" # fish cheat --completion fish > ~/.config/fish/completions/cheat.fish
```
