...
Esto es lo que intenta capturar la métrica de la [Complejidad Cognitiva](https://www.sonarsource.com/resources/cognitive-complexity/), introducida por Ann Campbell en 2018[2](https://franiglesias.github.io/metric-driven-refactoring/#fn:2).
...
Estas métricas fueron introducidas por Maurice H. Halstead en 1977[3](https://franiglesias.github.io/metric-driven-refactoring/#fn:3). En lugar de fijarse en el flujo de control del código, Halstead se centró en la cantidad de símbolos que aparecen en el mismo, como una forma de valorar su dificultad de mantenimiento.
...
Estas métricas nacen de la crítica a las anteriores, consideradas demasiado procedimentales por Chidamber & Kemerer[5](https://franiglesias.github.io/metric-driven-refactoring/#fn:5). Según estos autores, serían necesarias métricas específicas capaces de capturar elementos como herencia, encapsulación, polimorfismo y paso de mensajes.
...
```plain text
t refund = this.paymentGateway.refund(user.card, order.total)
        if (!refund.success) {
...
Brian Henderson-Sellers propuso en 1996 una nueva versión de LCOM que se conoce como LCOM-HS (o también LCOM3)[6](https://franiglesias.github.io/metric-driven-refactoring/#fn:8)[7](https://franiglesias.github.io/metric-driven-refactoring/#fn:9). Esta nueva métrica se propone superar las limitaciones de LCOM y obtener un resultado más preciso e interpretable, comparable entre clases y con un buen fundamento matemático.
...
Esta métrica agrega otras para producir un valor único que permita caracterizar la dificultad de mantener un código. Fue propuesta por Paul Oman y Jack Hagemeister en 1992[8](https://franiglesias.github.io/metric-driven-refactoring/#fn:6) (revisada en 1994[9](https://franiglesias.github.io/metric-driven-refactoring/#fn:7)) obtenida empíricamente del análisis de diversos proyectos de software, cuya mantenibilidad fue evaluada por expertos.
