---
title: "What is the definition of done? Guide for agile teams with examples"
notion_id: 56e5d001-e897-4c63-9512-dc658c4c6fde
notion_url: https://app.notion.com/p/What-is-the-definition-of-done-Guide-for-agile-teams-with-examples-56e5d001e8974c639512dc658c4c6fde
last_edited: 2022-12-19T14:28:00.000Z
source_url: https://blog.logrocket.com/product-management/what-is-definition-of-done-agile-examples/
tags: ["LogRocket Blog", "English", "Agile", "Project Management", "Product Management", "Article"]
---
...
An agile product development team comprises experts in various domains: [software engineers](https://blog.logrocket.com/product-management/3-scrum-roles-agile/#developers), quality assurance experts, [scrum masters](https://blog.logrocket.com/product-management/scrum-master-job-description-certifications/), user experience designers, [product owners](https://blog.logrocket.com/product-management/3-scrum-roles-agile/#product-owner), and more. Everyone contributes to product development in different stages with their expertise. Hence, there is a need to create a shared understanding of expectations around the development and deliver of the product.
...
According to [The Scrum Guide](https://www.agile-academy.com/en/scrum-master/what-is-the-definition-of-done-dod-in-agile/):

> “The Definition of Done creates transparency by providing everyone a shared understanding of what work was completed as part of the increment. If a Product Backlog item does not meet the Definition of Done, it cannot be released or even presented at the Sprint Review. Instead, it returns to the Product Backlog for future consideration.”

## What is the purpose of creating a definition of done?

The primary purpose of the definition of done is to build consensus and allocate accountability to the appropriate stations so that the team can deliver quality products consistently. A clear definition of done is crucial not only for execution, but also for [planning and estimation](https://blog.logrocket.com/product-management/planning-poker-agile-estimation-scrum/) across all levels in the product organization.

Initially, the [scrum framework](https://blog.logrocket.com/product-management/what-are-five-types-of-scrum-meetings/) established a definition of done for [scrum teams](https://blog.logrocket.com/product-management/3-scrum-roles-agile/) during the development phase. Since then, it has been extended to all levels of the product organization.

For example, there are DoDs for themes, initiatives, and [epics](https://blog.logrocket.com/product-management/what-is-an-epic-in-agile-guide-examples/), which enable the organization to understand the [product lifecycle](https://blog.logrocket.com/product-management/product-managers-role-each-product-lifecycle-stage/), create relevant [marketing plans](https://blog.logrocket.com/product-management/what-is-a-product-launch-plan-how-to-create/#branding-and-marketing), help with budget allocations, and evaluate the milestones and [roadmap](https://blog.logrocket.com/product-management/product-roadmap-tools-best-features-free-paid/). In addition, an operating agreement benefits cross-functional team collaboration and the onboarding of any new team member.

## Why is the definition of done important for agile teams?

When adopting [agile ways of working](https://blog.logrocket.com/product-management/four-agile-manifesto-values-explained/), every process should add value to the organization. The definition of done follows and implements the core [agile principles](https://blog.logrocket.com/product-management/12-agile-manifesto-principles-how-to-adopt-them/) in product development.

### Transparency

Creating a [clear understanding across the organization](https://blog.logrocket.com/product-management/12-agile-manifesto-principles-how-to-adopt-them/#4-work-together-daily) promotes transparency. It helps avoid unnecessary conflict and misunderstandings due to differences of opinion or perspective on the matter.

### Learning

[Continuous evaluation at each step](https://blog.logrocket.com/product-management/12-agile-manifesto-principles-how-to-adopt-them/#3-deliver-working-software-frequently) following the DoD checklist enables thorough oversight before releasing a product to end users and acts as a security gate. It allows the team to focus on speed and delivery, encouraging self-driven innovation without hesitation.

### Iteration

Delivering features that can be implemented quickly with the appropriate levels of quality assurance and delivered to end users is another [key agile principle](https://blog.logrocket.com/product-management/12-agile-manifesto-principles-how-to-adopt-them/#8-maintain-a-constant-pace-indefinitely). Quick learning and iteration also foster confidence within the product development teams to create innovation while maintaining quality assurance during delivery.
...
### User stories (scrum team)

The widely known definition of done is for [user stories](https://blog.logrocket.com/product-management/what-is-an-epic-in-agile-guide-examples/#epics-vs-user-stories-vs-initiatives) at the scrum team level.
...
- User story approved by the PO

### Who creates the definition of done for user stories?
...
The product manager can rely on the DoD for quality assurance before release if all the agreed-upon tasks are performed and checked by their respective accountable roles. The impact of the inventory can be incomplete user stories ending up in [sprint backlog](https://blog.logrocket.com/product-management/why-you-need-perfectly-groomed-backlog-sprint-planning/), which throws a wrench into [planning for the next sprint](https://blog.logrocket.com/product-management/what-is-sprint-planning-guide-meeting-agenda-cheat-sheet/) and, ultimately, delays production.

### Features/epics (enterprise/product management)
...
### Who creates the definition of done for features/epics?

The DoD may affect your priorities and roadmap based on new discoveries and learnings. Items that do not fulfill the DoD can go back to the [product backlog](https://blog.logrocket.com/product-management/product-vs-sprint-vs-release-backlog/) for the next increment.
...
### Who creates the definition of done for themes/initiatives?
...
The [product manager](https://blog.logrocket.com/product-management/what-does-a-product-manager-do-role-responsibilities/) is responsible for committing and fulfilling the checklist defined for their product, and management is required to carry out the necessary actions after the DoD is executed.
