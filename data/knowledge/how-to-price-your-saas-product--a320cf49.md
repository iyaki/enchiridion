...
notion_id: a320cf49-529f-4000-b69b-06caebdef35b
notion_url: https://app.notion.com/p/How-To-Price-Your-SaaS-Product-a320cf49529f4000b69b06caebdef35b
last_edited: 2023-01-13T00:57:00.000Z
source_url: https://hackernoon.com/how-to-price-your-saas-product-e65135rv?source=rss
tags: ["Entrepreneurship", "Product Management", "Article", "Hackernoon", "English"]
---
<!-- image hosted by Notion: its URL expires and is not preserved (ADR-05) -->

## **Don't fool yourself: SaaS pricing estimations aren't simple.**
...
## The Complexity of Product Pricing
...
## **Product pricing is a complicated and paralyzing experience.**

You can’t decide the price of a product just by running some numbers. You must also consider buyer psychology. Why is this important? Because no matter how much business sense a price makes, that same price may not make _any _sense to your potential customer.

But there’s another bigger reason you should consider buyer psychology. A customer doesn’t buy based on _price _alone. A customer buys when he or she recognizes the value of the product, independent of its price.
...
3. **A buyer doesn’t need pricing comparisons. She needs feature comparisons**. Customers don’t buy solutions. They buy features. Many of the price comparison charts used as marketing persuasion will fail. Why? Because according to Stanford researchers, they may introduce thought patterns that sway a customer’s choice _away _from you and onto your competitor. Instead of focusing on the price, focus on what the customer truly wants — features. Why? Because features add _value, _and that’s what the whole issue of pricing boils down to.
...
## What’s the biggest pricing challenge? Price level
...
Taken together, it’s obvious that more than **75% of respondents’ challenge has to do with **_**how to price their product.**_

The _how_ involves both method and amount. If a SaaS business could successfully solve this conundrum, they could improve profitability, grow, and deliver more value to their customers.
...
## What’s the solution? Raise your price

All you want to do in order to get closer to the right level is make your price _higher_ than you think it ought to be.
...
## **How a Higher Price Overcomes the Major Pricing Challenges**
...
Of course, people don’t _want_ to pay you more. We’re loath to part with extra money. But when a customer realizes the _value_ of your product in comparison to your price, it should be a no-brainer.

This takes us back to the root cause of the required _value_. Customers aren’t buying a commodity. They’re buying value. [Lincoln Murphy helps to qualify Graham’s quotation by writing](https://web.archive.org/web/20210209195641/https://web.archive.org/web/20150316210713/http:/sixteenventures.com/pricing-value-metrics?ref=hackernoon.com), “Your price [must be] tied to value perceived at every tier.”

## **Talk about the value. Don’t talk about the price**

When you elevate your price, it’s not that big of a deal for customers. Why? Because the main thing in customer’s minds is the _value,_ not the price.
...
> Rechocheting a price to a service that is congruent with the value derived from the services’s

_use rather than the underlying cost to create and deliver the SaaS, market prices, specific margins, etc._
...
**As per the research in the **_**Journal of Retailing**_**, customers have four drives that influence their perception:**

1. The emotional value of the product
2. The social cachet that comes with having the product
3. The quality/performance derived from the product
4. The price vs. value of the product.

Notice how the first three features have _nothing _to do with the actual price. They have _everything_ to do with perception. Only in the fourth — price vs. value — does the customer weigh the question of price.
...
The technique is particularly effective in the SaaS space, because software has “a large intangible component,” as Nagasimha Kanagal explained in the _Journal of Management and Marketing Research_.

You can make your product better by making it more expensive. In this way, you define the product’s value.

## Conclusion

I love it when a customer is glad to hand over their money. Why Because _I _know that _they_ know that they’re getting a good deal.
...
## _**What's your experience with raising the price of your SaaS?**_
