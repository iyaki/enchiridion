...
notion_id: cc38e2d6-ecb6-40e6-8717-7fc3fbd96db3
...
- [A few assumptions](https://rednafi.com/misc/on_rebasing/#a-few-assumptions)
- [Rebasing a feature branch onto the main branch](https://rednafi.com/misc/on_rebasing/#rebasing-a-feature-branch-onto-the-main-branch)
- [Rebasing interactively on the feature branch](https://rednafi.com/misc/on_rebasing/#rebasing-interactively-on-the-feature-branch)
...
- Usually doesn’t care for keeping atomic commits. [1](https://rednafi.com/misc/on_rebasing/#fn:1)
...
Julia Evans explores the pros and cons of rebasing in detail here[2](https://rednafi.com/misc/on_rebasing/#fn:2). Also, squashing commits is just one of the many things that you can do with the rebase command. Here, I just wanted to document my daily rebasing workflow where I mostly rename, squash, or fixup commits.
...
1. [Atomic commits](https://suchdevblog.com/lessons/AtomicGitCommits.html#why-should-you-write-atomic-git-commits) [↩︎](https://rednafi.com/misc/on_rebasing/#fnref:1)
2. [Git rebase: what can go wrong?](https://jvns.ca/blog/2023/11/06/rebasing-what-can-go-wrong-/) [↩︎](https://rednafi.com/misc/on_rebasing/#fnref:2)
