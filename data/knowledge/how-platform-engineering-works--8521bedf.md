...
notion_id: 8521bedf-c624-40cd-a7c6-9066d87bdf5f
...
## [Introduction](https://chadxz.dev/platform/#introduction)
...
## [Velocity and Stability are the Core Outcomes of Platform Engineering](https://chadxz.dev/platform/#velocity-and-stability-are-the-core-outcomes-of-platform-engineering)
...
You may recognize the metrics referred to here as the DORA "[4 key metrics](https://dora.dev/quickcheck/)".

The DORA State of DevOps Report has proven year after year that maintaining both velocity and stability is key to sustaining a high-performing software delivery organization. This is _WHY_ it is so important to have a Platform Engineering discipline in your organization. Attention to maintaining these characteristics can slip as teams focus on delivering the company's core value. Having a Platform Engineering team supports our organization's ability to focus on delivering its value, while enabling a continuously improving delivery velocity and system stability for all teams.
...
## [Adopting a Product Mindset is how Platform Engineering Works](https://chadxz.dev/platform/#adopting-a-product-mindset-is-how-platform-engineering-works)
...
Much of the buzz around Platform Engineering suggests we think of "Platform as a Product", as if we are building what amounts to an internal SaaS product like Heroku. While this may be what some organizations' platforms look like, the deeper meaning here is that we think about our Platform through the lens of a Product Manager. This means we need to _slow down_ and _think holistically_ about how to deliver value to our customers - the software engineers within the organization, but more broadly, all our colleagues and the customers our company is striving to serve. This results in better outcomes because it keeps the focus on solving the problems your organization is experiencing _right now_.
...
## [Lesson 1: Set Goals on Outcomes, Not Outputs](https://chadxz.dev/platform/#lesson-1%3A-set-goals-on-outcomes%2C-not-outputs)
...
### [Use OKRs for Strategic Planning](https://chadxz.dev/platform/#use-okrs-for-strategic-planning)
...
### [Perform Quarterly Tactical Planning](https://chadxz.dev/platform/#perform-quarterly-tactical-planning)
...
### [Use Story Kickoffs for Alignment](https://chadxz.dev/platform/#use-story-kickoffs-for-alignment)
...
## [Lesson 2: Truly Know Your Customer](https://chadxz.dev/platform/#lesson-2%3A-truly-know-your-customer)
...
### [Support Engineers on Slack](https://chadxz.dev/platform/#support-engineers-on-slack)
...
### [Consult, for a White-Glove Approach](https://chadxz.dev/platform/#consult%2C-for-a-white-glove-approach)
...
### [Survey for a Broad Perspective](https://chadxz.dev/platform/#survey-for-a-broad-perspective)
...
## [Lesson 3: Don't Just Respond, Invent](https://chadxz.dev/platform/#lesson-3%3A-don%27t-just-respond%2C-invent)
...
### [Iterate on Existing Solutions](https://chadxz.dev/platform/#iterate-on-existing-solutions)
...
## [Lesson 4: Scale Your Impact](https://chadxz.dev/platform/#lesson-4%3A-scale-your-impact)
...
### [Make Good Build vs Buy Choices](https://chadxz.dev/platform/#make-good-build-vs-buy-choices)
...
### [Avoid Interrupt Overload](https://chadxz.dev/platform/#avoid-interrupt-overload)
...
## [Summary](https://chadxz.dev/platform/#summary)
...
After all this talk about the importance of a product mindset, I wouldn't fault you for thinking I'm a product manager in engineer's clothing 😅. But really, I just want to make sure what I'm working on is _impactful_. The results are worth the effort.
