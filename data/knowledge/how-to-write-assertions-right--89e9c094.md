...
notion_id: 89e9c094-31bc-4dd9-baf9-2f2eaa7c7b11
notion_url: https://app.notion.com/p/How-to-Write-Assertions-Right-89e9c09431bc4dd9baf92f2eaa7c7b11
last_edited: 2023-02-16T13:35:00.000Z
source_url: https://lucasfcosta.com/2017/01/02/How-to-Write-Assertions-Right.html
tags: ["English", "Programming", "Testing", "Article", "Lucas F. Costa Blog"]
---
...
By asserting on a single subject per test you will usually have more informative tests since you will be able to know exactly which requirements were met and which were not. If you want to know more about this I highly recommend you to do a Google search on [`BDD`](https://dannorth.net/introducing-bdd/)[ (Behavior Driven Development)](https://dannorth.net/introducing-bdd/).
...
And [this is the reason why ](https://github.com/chaijs/chai/issues/620)[`Chai`](https://github.com/chaijs/chai/issues/620)[ does not implement ](https://github.com/chaijs/chai/issues/620)[`either`](https://github.com/chaijs/chai/issues/620)[ and ](https://github.com/chaijs/chai/issues/620)[`or`](https://github.com/chaijs/chai/issues/620)[ assertion chains in its code](https://github.com/chaijs/chai/issues/620).
...
Let’s use some simple logic here. **Whenever you say that you want ****`object`**** to **_**not**_** be ****`something`**** you are saying that ****`object`**** can be any other thing, except ****`something`****. This virtually creates ****`infinite - 1`**** logical **_**or**_** conditions in our assertion.**
