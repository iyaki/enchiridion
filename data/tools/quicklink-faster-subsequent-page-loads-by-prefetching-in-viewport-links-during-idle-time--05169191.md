---
title: "quicklink - Faster subsequent page-loads by prefetching in-viewport links during idle time"
notion_id: 05169191-adb6-43f4-8d4d-d1bc226376c2
notion_url: https://app.notion.com/p/quicklink-Faster-subsequent-page-loads-by-prefetching-in-viewport-links-during-idle-time-05169191adb643f48d4dd1bc226376c2
last_edited: 2023-11-28T18:17:00.000Z
source_url: https://github.com/GoogleChromeLabs/quicklink/
tags: ["Web Development", "HTML", "Javascript", "Framework/Library"]
---
...
Then, configure Webpack route manifest into your project, as explained [here](https://github.com/lukeed/webpack-route-manifest). This will generate a map of routes and chunks called `rmanifest.json`. It can be obtained at:
...
**Important:** An empty array (`[]`) allows _**all origins**_ to be prefetched.
...
- [Using Quicklink to prefetch API calls instead of ](https://github.com/GoogleChromeLabs/quicklink/tree/main/demos/hrefFn)[`href`](https://github.com/GoogleChromeLabs/quicklink/tree/main/demos/hrefFn)[ attribute](https://github.com/GoogleChromeLabs/quicklink/tree/main/demos/hrefFn)
...
For demo purposes, we deployed a version of the [Google Blog](https://blog.google/) on Firebase hosting. We then deployed another version of it, adding quicklink to the homepage and benchmarked navigating from the homepage to an article that was automatically prefetched. The prefetched version loaded faster.
...
Licensed under the [Apache-2.0 license](https://github.com/GoogleChromeLabs/quicklink/blob/main/LICENSE).
