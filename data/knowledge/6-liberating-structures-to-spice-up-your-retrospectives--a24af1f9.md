---
title: "6 Liberating Structures to spice up your retrospectives"
notion_id: a24af1f9-7f18-465e-b81f-7471b7f4b3b8
notion_url: https://app.notion.com/p/6-Liberating-Structures-to-spice-up-your-retrospectives-a24af1f97f18465eb81f7471b7f4b3b8
last_edited: 2023-05-26T19:27:00.000Z
source_url: https://blog.logrocket.com/product-management/6-liberating-structures-to-spice-up-your-retrospectives/
tags: ["English", "Agile", "Line/People/Team Management", "Article", "LogRocket Blog"]
---
<!-- image hosted by Notion: its URL expires and is not preserved (ADR-05) -->

There’s hardly a better tool to improve team dynamics and effectiveness than a well-run retrospective.
...
- [What are Liberating Structures?](https://blog.logrocket.com/product-management/6-liberating-structures-to-spice-up-your-retrospectives/#what-are-liberating-structures)
- [What’s an effective retrospective?](https://blog.logrocket.com/product-management/6-liberating-structures-to-spice-up-your-retrospectives/#whats-an-effective-retrospective)
- [6 engaging retro formats using Liberating Structures](https://blog.logrocket.com/product-management/6-liberating-structures-to-spice-up-your-retrospectives/#six-retrospective-formats-using-liberating-structures) 

1. [1-2-4-all (for identifying problems and solutions)](https://blog.logrocket.com/product-management/6-liberating-structures-to-spice-up-your-retrospectives/#identify-problems-and-solutions-using-1-2-4-all)
2. [15 percent solutions (for solving the unsolvable)](https://blog.logrocket.com/product-management/6-liberating-structures-to-spice-up-your-retrospectives/#solve-unsolvable-with-15-percent-solutions)
3. [Conversation cafe (for unpacking complex problems)](https://blog.logrocket.com/product-management/6-liberating-structures-to-spice-up-your-retrospectives/#unpack-difficult-problems-with-a-conversation-cafe)
4. [Triz (for eliminating destructive behaviors)](https://blog.logrocket.com/product-management/6-liberating-structures-to-spice-up-your-retrospectives/#stop-destructive-behaviors-with-triz)
5. [Heard, Seen, Respected (for promoting healthy team dynamics)](https://blog.logrocket.com/product-management/6-liberating-structures-to-spice-up-your-retrospectives/#build-healthy-team-dynamics-with-heard-seen-respected)
6. [What3 (for debriefing)](https://blog.logrocket.com/product-management/6-liberating-structures-to-spice-up-your-retrospectives/#debrief-with-what3-debrief)

- [Combining structures for the best outcomes](https://blog.logrocket.com/product-management/6-liberating-structures-to-spice-up-your-retrospectives/#combining-structures-for-the-best-outcomes)

## What are Liberating Structures?

In simple terms, [Liberating Structures](https://blog.logrocket.com/product-management/what-are-liberating-structures/) is a set of facilitation techniques that can be used to lead productive workshops. They are focused on getting the most out of the collective knowledge and thoughts of the group and go beyond standard formats such as brainstorming and moderated discussions.
...
A [sprint retrospective](https://blog.logrocket.com/product-management/what-is-a-sprint-retrospective-templates-and-best-practices/) can be the most powerful meeting of an agile team. If facilitated well, it allows the team to improve its effectiveness, resolve conflicts before they happen, and help everyone excel.
...
1. Ask people to write sticky notes for things that were well and bad
2. Discuss or vote for sticky notes
3. Choose 2–3 action points
...
- Empowers everyone to be heard
- Leads to meaningful improvement

Because Liberating Structures are designed to achieve just that, they are an excellent fit for [creating engaging retrospective agendas](https://blog.logrocket.com/product-management/how-to-run-effective-sprint-retrospectives-20-formats-ideas/).
...
### 1. 1-2-4-all (for identifying problems and solutions)
...
### 2. 15% solutions (for solving the unsolvable)
...
- What’s the 15 percent improvement you can make regarding the challenge?
...
### 3. Conversation cafe (for unpacking complex problems)
...
1. Everyone shares their feelings and thoughts about the topic at hand. Only one person talks; there are no discussions
2. Everyone shares their thoughts after having listened to everybody at the table. Again, only one person talks
3. Have an open discussion within the group
4. Everyone shares their thoughts and takeaways after the conversion. Here, too, only one person talks
...
### 4. TRIZ (for eliminating destructive behaviors)
...
### 5. Heard, seen, respected (for fostering healthy team dynamics)
...
1. What just happened? What did you notice? What facts and observations stood out?
2. So what? Why is that important? What patterns are emerging?
3. Now what? What actions make sense?
