---
title: "How to hire a CTO"
notion_id: 53af48f4-2ea5-45af-9029-44c53c7a7fe9
notion_url: https://app.notion.com/p/How-to-hire-a-CTO-53af48f42ea545af902944c53c7a7fe9
last_edited: 2023-01-25T18:24:00.000Z
source_url: https://madewithlove.com/blog/leadership-and-team-management/how-to-hire-a-cto/
tags: ["Entrepreneurship", "Career Growth", "Jobs", "Article", "madewithlove Blog", "English"]
---
<!-- image hosted by Notion: its URL expires and is not preserved (ADR-05) -->

In short

How to hire a good CTO for your startup? Do you need a freelance CTO or an agency offering CTO as a service. This post will tell you all about it.
...
I talked to Vincent Battaglia (co-founder of [Ludus](https://ludus.io/)), Marijn Vandevoorde (Engineering Manager at madewithlove), and [Jonas Van Schoote](https://madewithlove.com/team/jonas-van-schoote/) (CTO ad interim at madewithlove) on topics like **startup growth**, [**CTO as a service**](https://madewithlove.com/our-services/technical-strategy/), the **different CTO profiles**, the CTO **skills needed**, whether or not your business even needs a CTO, and **how to find a good** one if you do.
...
We’ve written an elaborate post on the [different skills needed to be a successful CTO](https://madewithlove.com/blog/leadership-and-team-management/one-job-many-roles-the-different-skills-needed-to-be-a-successful-cto/). Usually, the CTO is **external** facing, strategy focused (similar to a CEO), while a VPoE (Vice President of Engineering) is **internal** facing, **tactically** focused (akin to the COO).
...
Periodic strategic advice from someone external to the company is a valid substitute. People management can be done by engineering managers or team leads, and (in some cases) [a strong product leader](https://madewithlove.com/blog/product-and-project-management/why-product-marketing-is-more-important-in-a-tech-company-than-you-think/) (the CPO perhaps?) could fill in for some of the missing strategic roles and product thinking.
...
There is no right or wrong answer. This greatly depends on the product, team maturity, and [technical debt](http://technica/). [Everything should start from the product vision](https://madewithlove.com/blog/leadership-and-team-management/the-first-days-as-a-firefighting-cto-what-to-focus-on-when-you-are-hired-to-lead-a-team-in-times-of-change/). If there is no product and company vision, define that first.
...
Another strategy is having the CTO start by trying [to assess the current state and the product vision](https://madewithlove.com/blog/product-and-project-management/the-minimum-viable-product-is-not-so-minimum-anymore/). With a clear, short term “todo” list, they can buy time to work on the long term vision and prioritise strategic initiatives.
...
It’s easiest to evaluate the CTO through thorough feedback from the team they manage, but the perspective of the business is equally important here. [Having a clear roadmap](https://madewithlove.com/blog/leadership-and-team-management/how-a-ceo-knows-whats-being-built/) and some steps that have been taken successfully on it are also a good indicator.

As a general rule, looking at soft skills rather than hard skills will do wonders. Apart from being good at all things technical, it’s important that your CTO can communicate well and be nice to work with. The CTO is [a T-shaped profile](https://madewithlove.com/blog/leadership-and-team-management/the-responsible-developer-profile-explained/) and there are a lot of factors that influence their performance.

## **What does a good assignment look like when hiring a CTO? How do you test unproven people?**

[A technical assignment during the hiring process](https://madewithlove.com/blog/leadership-and-team-management/our-hiring-process-three-steps-to-hiring-how-we-attract-lovely-developers/) is not an easy challenge. When hiring, the emphasis should be on the interviews. Your hiring and management team should have lots of those, preferably with specialists in the field.
...
For example: “_You are now in charge of a product where bugs are constantly reported by customers and the product is out of service at least one time a week. What would your first week at work look like?_”

Asking about their experience, with questions like “_What is the biggest problem you ever had at work and how did you solve it?_” can tell a lot. Dig deep to understand their role in the process, what _the person_ did, not just _the team_ they worked with. What is their philosophy when it comes to leading engineering teams?
...
Alternatively, with good leadership, you can grow promising back-end developers, technical leads, or even your technical founder to meet the needs of [the ever-changing role of CTO](https://madewithlove.com/blog/leadership-and-team-management/one-job-many-roles-the-different-skills-needed-to-be-a-successful-cto/).
...
When [our CTOs in residence](https://madewithlove.com/for-startups-and-scale-ups/) join a new client, they are often part of an advisory board, defending you and any decisions before the primary stakeholders. When difficult matters rise to the surface, we gather other experts to discuss the problem internally before offering a solution to the client.

Once the product vision, technical roadmap, and development team are up to speed, [we will start the search for an in-house CTO to replace ourselves](https://madewithlove.com/our-products/recruiting/). We like making ourselves redundant and — since honesty is a core value of ours — we see great results with the teams that work with us. **We truly believe offering CTO as a service is the best way for ambitious startups to achieve rapid growth**.

As always, if you have any questions, feel free [to reach out](https://madewithlove.com/contact/) or get to know [madewithlove](https://madewithlove.com/for-everyone/) better!
