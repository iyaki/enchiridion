...
notion_id: 7344ad8d-809d-4a5b-8dfd-b4181eca1ba0
notion_url: https://app.notion.com/p/Effective-Changelogs-7344ad8d809d4a5b8dfdb4181eca1ba0
last_edited: 2024-09-10T20:08:00.000Z
source_url: https://xavd.id/blog/post/effective-changelogs/
tags: ["English", "Programming", "System Design / Software Architecture", "Article", "David Brownman"]
---
<!-- image hosted by Notion: its URL expires and is not preserved (ADR-05) -->

Like [your versioning scheme](https://xavd.id/blog/post/versioning-as-communication/), your changelog is a vital and oft-overlooked method of communication to your users. Unfortunately, **it's easy to write a changelog, but hard to write a great one.**
...
- [Nothing Beats a File](https://xavd.id/blog/post/effective-changelogs/#nothing-beats-a-file)
- [Basic Formatting](https://xavd.id/blog/post/effective-changelogs/#basic-formatting)
- [Keep Headings Simple](https://xavd.id/blog/post/effective-changelogs/#keep-headings-simple)
- [Note the Date](https://xavd.id/blog/post/effective-changelogs/#note-the-date)
- [Be Iconic](https://xavd.id/blog/post/effective-changelogs/#be-iconic)
- [Writing Style](https://xavd.id/blog/post/effective-changelogs/#writing-style)
- [Focus on Impact](https://xavd.id/blog/post/effective-changelogs/#focus-on-impact)
- [Give (Some) Context](https://xavd.id/blog/post/effective-changelogs/#give-some-context)
- [Don't Include Everything](https://xavd.id/blog/post/effective-changelogs/#dont-include-everything)
- [A Full Example](https://xavd.id/blog/post/effective-changelogs/#a-full-example)

> Note: individual examples don't follow every guideline for brevity's sake. See the full example for everything at once.
...
Changelog items should focus on what changed, not why. This keeps each line focused and factual, ideal for a busy reader. If they're curious they can click through to the commit / pull request for the context behind the change.[1](https://xavd.id/blog/post/effective-changelogs/#fn-1)
...
1. You _are_ writing detailed PR descriptions, right?[↩](https://xavd.id/blog/post/effective-changelogs/#fnref-1)
