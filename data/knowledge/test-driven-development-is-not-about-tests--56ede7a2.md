...
notion_id: 56ede7a2-3b20-41ee-b128-439bf86d0364
notion_url: https://app.notion.com/p/Test-Driven-Development-is-not-about-tests-56ede7a23b2041eeb128439bf86d0364
last_edited: 2023-02-16T13:35:00.000Z
source_url: https://lucasfcosta.com/2018/10/18/TDD-is-not-about-tests.html
tags: ["Article", "Lucas F. Costa Blog", "English", "Testing", "Programming", "Agile"]
---
...
Many people don’t understand this because they think that TDD is about writing tests first and code later. They just go on and write a full-blown test, see it failing and then struggle with an implementation for a long time until it passes that test. This is not wrong in all cases, but it is definitely not suitable for _every_ case.
...
We could add another assertion which expects `fizzbuzz(5)` to _not_ be equal `fizz`, but using negated assertions [is, in general, a bad practice](https://lucasfcosta.com/2017/01/02/How-to-Write-Assertions-Right.html).
