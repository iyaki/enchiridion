...
notion_id: c72bb5c5-ab6c-400c-bb5f-dfefbafc7b29
notion_url: https://app.notion.com/p/SQLite-is-not-a-toy-database-c72bb5c5ab6c400cbb5fdfefbafc7b29
last_edited: 2024-10-21T20:45:00.000Z
source_url: https://antonz.org/sqlite-is-not-a-toy-database/
tags: ["English", "Databases", "Article", "Anton Zhiyanov"]
---
<!-- image hosted by Notion: its URL expires and is not preserved (ADR-05) -->

_English • _[_Russian_](https://habr.com/ru/post/547448/)_ • _[_Spanish_](https://sysarmy.com/blog/posts/sqlite-no-es-una-base-de-datos-de-juguete/)
...
[Console, import, and export](https://antonz.org/sqlite-is-not-a-toy-database/?utm_source=tldrwebdev#console-import-and-export) • [Native JSON](https://antonz.org/sqlite-is-not-a-toy-database/?utm_source=tldrwebdev#native-json) • [CTEs and set operations](https://antonz.org/sqlite-is-not-a-toy-database/?utm_source=tldrwebdev#ctes-and-set-operations) • [Math statistics](https://antonz.org/sqlite-is-not-a-toy-database/?utm_source=tldrwebdev#math-statistics) • [Performance](https://antonz.org/sqlite-is-not-a-toy-database/?utm_source=tldrwebdev#performance) • [Documents, graphs, and search](https://antonz.org/sqlite-is-not-a-toy-database/?utm_source=tldrwebdev#documents-graphs-and-search) • [And so much more](https://antonz.org/sqlite-is-not-a-toy-database/?utm_source=tldrwebdev#and-so-much-more)
...
There are fancy [window functions](https://antonz.org/sql-window-functions-book). [Upsert](https://antonz.org/sql-upsert/), [update from](https://sqlite.org/lang_update.html#update_from) and [R-tree indexes](https://sqlite.org/rtree.html). [Regular expressions](https://antonz.org/sqlean-regexp/), [fuzzy search](https://github.com/nalgeon/sqlean/blob/main/docs/fuzzy.md) and [dynamic SQL](https://antonz.org/sqlean-define/). In terms of features, SQLite can compete with any 'big' DBMS.

I hope this article will inspire you to try SQLite. Thanks for reading!

──

P.S. Interested in learning advanced SQLite features? Check out my book — [SQL Window Functions Explained](https://antonz.org/sql-window-functions-book)
