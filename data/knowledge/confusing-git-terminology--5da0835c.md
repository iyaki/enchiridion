...
tags: ["Programming", "Article", "Guide", "Julia Evans", "English"]
---
...
- [HEAD and “heads”](https://jvns.ca/blog/2023/11/01/confusing-git-terminology/?utm_source=tldrwebdev#head-and-heads)
- [“detached HEAD state”](https://jvns.ca/blog/2023/11/01/confusing-git-terminology/?utm_source=tldrwebdev#detached-head-state)
- [“ours” and “theirs” while merging or rebasing](https://jvns.ca/blog/2023/11/01/confusing-git-terminology/?utm_source=tldrwebdev#ours-and-theirs-while-merging-or-rebasing)
- [“Your branch is up to date with ‘origin/main’”](https://jvns.ca/blog/2023/11/01/confusing-git-terminology/?utm_source=tldrwebdev#your-branch-is-up-to-date-with-origin-main)
- [HEAD^, HEAD~ HEAD^^, HEAD~~, HEAD^2, HEAD~2](https://jvns.ca/blog/2023/11/01/confusing-git-terminology/?utm_source=tldrwebdev#head-head-head-head-head-2-head-2)
- [.. and …](https://jvns.ca/blog/2023/11/01/confusing-git-terminology/?utm_source=tldrwebdev#and)
- [“can be fast-forwarded”](https://jvns.ca/blog/2023/11/01/confusing-git-terminology/?utm_source=tldrwebdev#can-be-fast-forwarded)
- [“reference”, “symbolic reference”](https://jvns.ca/blog/2023/11/01/confusing-git-terminology/?utm_source=tldrwebdev#reference-symbolic-reference)
- [refspecs](https://jvns.ca/blog/2023/11/01/confusing-git-terminology/?utm_source=tldrwebdev#refspecs)
- [“tree-ish”](https://jvns.ca/blog/2023/11/01/confusing-git-terminology/?utm_source=tldrwebdev#tree-ish)
- [“index”, “staged”, “cached”](https://jvns.ca/blog/2023/11/01/confusing-git-terminology/?utm_source=tldrwebdev#index-staged-cached)
- [“reset”, “revert”, “restore”](https://jvns.ca/blog/2023/11/01/confusing-git-terminology/?utm_source=tldrwebdev#reset-revert-restore)
- [“untracked files”, “remote-tracking branch”, “track remote branch”](https://jvns.ca/blog/2023/11/01/confusing-git-terminology/?utm_source=tldrwebdev#untracked-files-remote-tracking-branch-track-remote-branch)
- [checkout](https://jvns.ca/blog/2023/11/01/confusing-git-terminology/?utm_source=tldrwebdev#checkout)
- [reflog](https://jvns.ca/blog/2023/11/01/confusing-git-terminology/?utm_source=tldrwebdev#reflog)
- [merge vs rebase vs cherry-pick](https://jvns.ca/blog/2023/11/01/confusing-git-terminology/?utm_source=tldrwebdev#merge-vs-rebase-vs-cherry-pick)
- [rebase –onto](https://jvns.ca/blog/2023/11/01/confusing-git-terminology/?utm_source=tldrwebdev#rebase-onto)
- [commit](https://jvns.ca/blog/2023/11/01/confusing-git-terminology/?utm_source=tldrwebdev#commit)
- [more confusing terms](https://jvns.ca/blog/2023/11/01/confusing-git-terminology/?utm_source=tldrwebdev#more-confusing-terms)
...
- Apparently the flags `-index` and `-cached` do not generally mean the same thing. I have personally never used the `-index` flag so I’m not going to get into it, but [this blog post by Junio Hamano](https://gitster.livejournal.com/39629.html) (git’s lead maintainer) explains all the gnarly details
...
There’s another great post about this from 2012 called [the most confusing git terminology](https://longair.net/blog/2012/05/07/the-most-confusing-git-terminology/). It talks more about how git’s terminology relates to CVS and Subversion’s terminology.
...
- [Korean](https://ptrtoj.com/confusing-git-term/)
