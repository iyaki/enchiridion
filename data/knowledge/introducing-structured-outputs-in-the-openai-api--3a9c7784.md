...
notion_id: 3a9c7784-248e-4ab8-9b87-31349aac061a
...
tags: ["Note", "Tutorial", "English", "Programming"]
---
We are introducing Structured Outputs in the API—model outputs now reliably adhere to developer-supplied JSON Schemas.

![image](https://images.ctfassets.net/kftzwdyauwt9/1XeXlBlWdUBSPFcVPsOmOD/dc8123f1031a0f9fe1b816790ee510a9/Structured_Outputs_Cover.png?w=3840&q=90&fm=webp)
...
_With Structured Outputs, __`gpt-4o-2024-08-06`__ achieves 100% reliability in our evals, perfectly matching the output schemas._
...
```plain text
123456789101112131415161718192021222324252627282930313233343536373839404142434445464748495051525354555657585960616263646566676869707172737475761from enum import Enum2from typing import Union3
...
```plain text
12345678910111213141516171819202122232425262728293031321from pydantic import BaseModel2
...
Welcome to GreenThumb Gardening
...
```plain text
12345678910111213141516171819202122232425262728293031323334353637381{2  "model": "gpt-4o-2024-08-06",3  "messages": [4    {5      "role": "system",6      "content": "You are a helpful assistant"7    },8    {9      "role": "user",10      "content": "9.11 and 9.9 -- which is bigger?"11    }12  ],13  "response_format": {14    "type": "json_schema",15    "json_schema": {16      "name": "reasoning_schema",17      "strict": true,18      "schema": {19        "type": "object",20        "properties": {21          "reasoning_steps": {22            "type": "array",23            "items": {24              "type": "string"25            },26            "description": "The reasoning steps leading to the final conclusion."27          },28          "answer": {29            "type": "string",30            "description": "The final answer, taking into account the reasoning steps."31          }32        },33        "required": ["reasoning_steps", "answer"],34        "additionalProperties": false35      }36    }37  }38}
```
...
```plain text
123456781{2  "type": "object",3  "properties": {4    "value": { "type": "number" }5  },6  "required": ["value"],7  "additionalProperties": false8}
```
...
- Structured Outputs allows only a subset of JSON Schema, detailed [in our docs](https://platform.openai.com/docs/guides/structured-outputs)[(opens in a new window)](https://platform.openai.com/docs/guides/structured-outputs). This helps us ensure the best possible performance.
...
To start using Structured Outputs, check out our [docs](https://platform.openai.com/docs/guides/structured-outputs)[(opens in a new window)](https://platform.openai.com/docs/guides/structured-outputs).
