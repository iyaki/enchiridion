---
title: "A 5-step framework for running great sprint retrospective sessions"
notion_id: 5106750c-2ba5-4a1d-a6c1-a1bb18d6daf0
notion_url: https://app.notion.com/p/A-5-step-framework-for-running-great-sprint-retrospective-sessions-5106750c2ba54a1da6c1a1bb18d6daf0
last_edited: 2022-12-19T14:02:00.000Z
source_url: https://blog.logrocket.com/product-management/5-step-framework-sprint-retrospective-sessions/
tags: ["Article", "LogRocket Blog", "English", "Agile", "Project Management", "Line/People/Team Management"]
---
<!-- image hosted by Notion: its URL expires and is not preserved (ADR-05) -->

A sprint retrospective is one of the most valuable meetings a sprint team has. Even teams that don’t work in a [scrum framework](https://blog.logrocket.com/product-management/what-are-five-types-of-scrum-meetings/) can benefit tremendously from inspecting and adapting their processes, culture, and way of working.

However, the [_Scrum Guide_](https://www.scrum.org/resources/scrum-guide) isn’t really prescriptive about what a good retrospective should look like. Lack of structure often leads to unproductive, unsafe sessions that yield no meaningful results.

Properly structuring a retrospective meeting can make a great difference.

## A 5-step retro framework

While there’s no one-size-fits-all way to structure a [retrospective session](https://blog.logrocket.com/product-management/what-is-a-sprint-retrospective-templates-and-best-practices/), one of the most popular and flexible frameworks includes the following five steps:
...
For a successful retrospective meeting, you need data you can inspect. Depending on the [retro format](https://blog.logrocket.com/product-management/how-to-run-effective-sprint-retrospectives-20-formats-ideas/), you might gather the data before or during the meeting itself.
...
- Remember that nothing is set in stone; you don’t have to commit to any solution permanently

Depending on a specific case, you might want to make a quick and dirty decision — for example, via dot voting or by spending more time to get a more informed decision using the [ICE matrix](https://medium.com/@nimay/inside-product-introduction-to-feature-priority-using-ice-impact-confidence-ease-and-gist-5180434e5b15).
...
- Help people retain the most crucial information
- Enable you to inspect and adapt the retrospective itself
...
- What’s the most important outcome of the meeting?
- What can we do better in the next retrospective?

## Additional tips for smoother retros

### No ‘last retro review’ section
...
Strive to build a culture in which the team is always accountable for retrospective outcomes. Discuss them after [daily standups](https://blog.logrocket.com/product-management/the-daily-scrum-meeting-overview-best-practices-anti-patterns/) or do weekly check-ins, whatever works for you.
