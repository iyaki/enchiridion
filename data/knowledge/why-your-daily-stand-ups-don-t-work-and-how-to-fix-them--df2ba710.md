...
tags: ["Agile", "Line/People/Team Management", "Project Management", "Communication", "Article", "Lucas F. Costa Blog", "English"]
---
...
Here’s [what ](https://www.scrum.org/resources/what-is-a-daily-scrum)[`Scrum.org`](https://www.scrum.org/resources/what-is-a-daily-scrum)[ says the purpose of a daily stand-up is](https://www.scrum.org/resources/what-is-a-daily-scrum):
...
The truth is that many managers weaponized their stand-up so that they could keep people busy. These types of managers believe in efficiency rather than effectiveness, which also usually leads them to [load their team to maximum capacity utilization thinking it will accelerate deliveries, when in fact it just slows their teams down](https://lucasfcosta.com/2022/06/12/measure-queues-not-cycle-time.html).
