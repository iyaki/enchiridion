---
title: "What are OKRs and how to write them (with templates and examples)"
notion_id: 19009334-c129-4b19-a676-d947689f194b
notion_url: https://app.notion.com/p/What-are-OKRs-and-how-to-write-them-with-templates-and-examples-19009334c1294b19a676d947689f194b
last_edited: 2022-12-19T14:26:00.000Z
source_url: https://blog.logrocket.com/product-management/what-are-okrs-how-to-write-templates-examples/
tags: ["Product Management", "Project Management", "Line/People/Team Management", "Article", "LogRocket Blog", "English"]
---
...
Doerr’s book, [_Measure What Matters_](https://www.amazon.com.au/Measure-What-Matters-Simple-Drives/dp/024134848X/ref=asc_df_024134848X/?tag=googleshopdsk-22&linkCode=df0&hvadid=341744909748&hvpos=&hvnetw=g&hvrand=5722699013198395126&hvpone=&hvptwo=&hvqmt=&hvdev=c&hvdvcmdl=&hvlocint=&hvlocphy=9071478&hvtargid=pla-440960730426&psc=1), demonstrates how to [gather timely and relevant data](https://blog.logrocket.com/product-management/what-metrics-kpis-product-managers-track/) to track progress so that you can improve your performance. In 2018, he also gave an excellent [TED Talk](https://www.youtube.com/watch?v=L4N1q4RNi9I) on why the secret to success is about setting the right goals.

OKRs are widely used in product management because they allow [product managers](https://blog.logrocket.com/product-management/product-managers-role-each-product-lifecycle-stage/) to concentrate on the objectives their business has set out to accomplish and rally others within the organization to focus on them too.
...
Although these are simply a few of the [product manager’s many responsibilities](https://blog.logrocket.com/product-management/what-does-a-product-manager-do-role-responsibilities/), they are usually some of the most important. PMs often dig through data and create reports and dashboards to [track progress toward key business goals](https://blog.logrocket.com/product-management/what-product-management-metrics-matter-most-to-pms/) and communicate updates to stakeholders.
...
Some objectives may be linked to your overall [product strategy](https://blog.logrocket.com/product-management/product-strategy-frameworks-examples/). These goals might be confined to the product experience itself and contribute significantly to the company’s financial goals.

You should also collaborate with your [engineering counterparts](https://blog.logrocket.com/product-management/3-scrum-roles-agile/#developers) to identify capacity needs for executing the objectives across the company by aligning your product goals across the business.
...
1. Relate it back to one of the company’s current objectives
2. Outline 2–3 measures that outline what success looks like
...
Considering the example above, [product, UX, and engineering](https://blog.logrocket.com/product-management/dual-track-agile-continuous-discovery/#the-trio-design-product-and-engineering) might need to work together to ensure enough planning has been done to guarantee sprint velocity. Product and UX will need to work together to recruit customers and plan, run, and synthesize results from the interviews. This might limit their effectiveness in helping to define work for the engineering teams.

## OKR templates and best practices

There are a few strategies for planning OKRs. When starting out, I recommend reviewing your [pirate metrics (AARRR)](https://blog.logrocket.com/product-management/6-product-management-frameworks-you-should-know/#aarrr-metrics):

_**Here is a **_[_**downloadable and customizable OKR template**_](https://docs.google.com/spreadsheets/d/1BjzPZgKdyY0O5KKn2cyVaPdo82acJTOKXpms5d-Uxgc/edit#gid=0)_** you can use when planning your OKRs. We also have templates available for the following (more on these later):**_
...
In the [OKR template](https://docs.google.com/spreadsheets/d/1BjzPZgKdyY0O5KKn2cyVaPdo82acJTOKXpms5d-Uxgc/edit#gid=0) linked above, the **OKR Alignment** tab provides a structure and checklist of the functions you should meet with to review and discuss OKRs for the quarter. Keep track of when the meetings are scheduled and any comments that need to be addressed as a result of the discussion.
...
In your [product management tool](https://blog.logrocket.com/product-management/product-roadmap-tools-best-features-free-paid/) (e.g., [Aha](https://blog.logrocket.com/product-management/product-roadmap-tools-best-features-free-paid/#aha), [ProductBoard](https://blog.logrocket.com/product-management/product-roadmap-tools-best-features-free-paid/#productboard), [ProductPlan](https://blog.logrocket.com/product-management/product-roadmap-tools-best-features-free-paid/#productplan), etc.), items on your roadmap should be aligned to the objectives. It’s worth checking in on the progress of those items to ensure timelines are up to date. Again, you should discuss where there are impacts and issues with date slippage.

### Send async OKR progress reports

There is a plethora of strategies out there to make communication easier, yet we still default to meeting hell.

If you don’t have time to share progress in a team meeting, invest the time to make information self-service by producing reports. Sending a quick email, Slack update, [Loom](https://www.loom.com/) video, or [Enform](https://www.enform.io/) update will work to keep stakeholders up to date.
...
_**Feel free to download and customize this **_[_**OKR weekly update template**_](https://docs.google.com/document/d/1njkpwajecfxE2IfS1QdeTHR_VRVcJg8_mSchqdVd7xs/edit)_** to help you compose your own progress reports.**_
...
- Not everyone will have been following along with the week-to-week progress
- It give the team an opportunity to take stock of what it has accomplished — after all, not everything is on fire all the time
...
- Showcase the achievements for each objective and the current state of the metrics
- Deep dive on any points of interest — e.g., trend data over time, before/after screenshots, etc.
- Introduce the team to the OKRs for the next quarter
- Deep-dive into the current state of any new problems areas and articulate why they’re important for the team to tackle now

_**To see what this looks like in practice, check out this **_[_**real-world example of a quarterly review deck**_](https://docs.google.com/presentation/d/1LvOq1tLP1tS6p_bYLfy1DjWwqvUHaHpQxZBF7TWDES0/edit#slide=id.g1f88252dc4_0_1535)_**.**_
