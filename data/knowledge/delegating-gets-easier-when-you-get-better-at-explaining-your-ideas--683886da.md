---
title: "Delegating gets easier when you get better at explaining your ideas"
notion_id: 683886da-8804-46cf-827d-909038cbf1a9
...
tags: ["Article", "Wes Kao's Newsletter", "English", "Line/People/Team Management", "Communication", "Entrepreneurship", "Leadersheep", "Career Growth", "Decision Making"]
---
...
Over the years, I developed the framework below when explaining projects to direct reports, dotted-line reports, vendors, agencies, contractors, recruiters, and anyone I’m managing formally or informally.
...
These apply to folks at all levels. The more senior the person, the less you’ll need to explain. The more junior, the more you should spell things out.

Use this as a checklist and starting point when you give context on a new project. Don’t be intimidated by the sub-questions/points within the five main points—they are meant to give you ideas of what to consider, and not every item will be applicable to you.
...
**Who is this person and how much do they already know?** Put yourself in their shoes. Every situation, project, etc will be different, so use your judgment. Am I setting this person up for success? What’s the next obvious question they might have? Considering their POV should bring to mind a bunch of things you should probably tell them. For example, you’d share different context with a new external contractor vs a direct report you’ve worked with for years on similar initiatives.
...
**How can I make this simpler? Am I sharing the right details in the right areas?** The more details you share, the more your recipient has to wade through information to discern what’s important. When you start going on a tangent, make sure those details are worth sharing.
...
**Stop talking sooner**. After I’m on a roll giving a monologue, at some point I’ll stop to ask what resonated and what my direct report heard. At that point, I usually realize they got 20% of what I said. _“But my brilliant point about x! What about the thing I said about Y? They didn’t even mention my insight around Z??”_ Let the other person share what they’re hearing.

**Ask what parts were confusing. Encourage them to ask questions**. Your team doesn’t want to feel dumb or admit they missed something. So you have to make it a positive experience to ask clarifying questions. Ideally, they ask in the moment but if they think of questions later, they should still speak up. The worst: They say they get it, but spin their wheels guessing what to do because they want to seem independent. Say this:

> “Btw I might not have explained well, so you should ask anything and everything that’s coming to mind for you. Both now, and once you get started.”

![image](https://substackcdn.com/image/fetch/w_1456,c_limit,f_auto,q_auto:good,fl_progressive:steep/https%3A%2F%2Fsubstack-post-media.s3.amazonaws.com%2Fpublic%2Fimages%2F64d6fbd5-41ad-429e-8fcf-33467f5ef96a_1254x428.png)

![image](https://substackcdn.com/image/fetch/w_1456,c_limit,f_auto,q_auto:good,fl_progressive:steep/https%3A%2F%2Fsubstack-post-media.s3.amazonaws.com%2Fpublic%2Fimages%2Fb172c5e1-7925-49b8-848b-bdc5b52574d4_1262x554.png)
...
**Keep them on the hook in the moment**. Go a few steps further than you think you need to while you’re together. Not later—now. This _brings issues upstream_ and saves one round of future alignment. This is incredibly useful and an underused lever. It will give them a head start when they go off on their own. Say this:
...
### “But shouldn’t they just ask me questions?”

There is some information you should volunteer without being asked. That’s how using your brain and communicating with other people works.
...
Even if you explain well, folks will still have questions because (a) you didn’t explain as well as you think and (b) they’ll bring up aspects you didn’t cover. When you cover the basics, you’re setting them up to ask _better_, _more advanced questions_.

In terms of measuring results, you’ll know you’re setting expectations poorly if you aren’t seeing the results you want to see. It’s possible your team members simply aren’t very good, in which case, you may want to part ways. Before you jump to that conclusion, be intellectually honest about whether you have room to improve as a manager/leader.

There will always be issues to clarify because you’re not copying-pasting your full knowledge and consciousness into the other person. But if you give context, you’ll get to spend time on more strategic discussions.

Here’s what reader Emily Rand, a senior communications staff member at Lockheed Martin, says:

> The first time a manager did this for me, my ability to think strategically and creatively expanded, because I wasn't wasting time figuring out next steps or who to work with. And once you know those things, you file them for the next project.

Sharing business context adds up. It compounds. It pays dividends. Start doing it.

### Your senior employees need context too

Senior folks are better at getting what they need. But this doesn’t mean you should skip getting aligned.

At the start of the post, I mentioned that junior and mid-level employees need more context. I didn’t want to scare you away if you think it’s too much work to do this with everyone.

Like, “Wait, Wes, you’re saying I have to do this with execs too? Aren’t you just hiring low-performing wahoo leaders if you need to do this much explaining?”

But actually, senior folks crave context, they see it as thought partnership, and it will enable them to be bolder and more creative. But they feel like they can’t ask for it because they should “already know” or “already be aligned” or should be completely independent.

![image](https://substackcdn.com/image/fetch/w_1456,c_limit,f_auto,q_auto:good,fl_progressive:steep/https%3A%2F%2Fsubstack-post-media.s3.amazonaws.com%2Fpublic%2Fimages%2F08d7e6b3-573f-4160-95e1-e59a53555467_1256x388.png)

A few last thoughts:

- The five steps aren’t necessarily linear or mutually exclusive. I roughly start with the buckets in order, then quickly start jumping between them.
- Do an async overview before meeting, if possible. This will make your meeting more efficient. For example, do a Loom walkthrough where you record on your own time, and your direct reports can pause the recording, watch on 2x speed, refer back to it. I’ve gotten great feedback doing this. When you meet live, you can jump in deeper, faster.
- If you’re wondering if you have (or should make) time to do this, the answer is yes. You can mentally run through this checklist in 5 minutes if needed, and surface items you might have forgotten to mention otherwise.

Context-sharing should be an ongoing activity—it might be more heightened when there are new projects, but shouldn’t be limited to those moments. Make it a regular part of the conversations you have with your team.

Thanks for being here, and I’ll see you next Wednesday at 8am ET.

Wes

PS If you found this valuable, here are other ways I can help:

1. Follow me on [Twitter](https://twitter.com/wes_kao) or [LinkedIn](https://www.linkedin.com/in/weskao/) for bite-sized tips throughout the week (free).
2. Book me as a [keynote speaker](https://www.weskao.com/contact) to level up your team.
3. [Promote your brand](https://docs.google.com/forms/d/e/1FAIpQLSePx56Fjl-Pg26FTvI_4ES7rseSiAiS3c19F5tW3yMPR8VHow/viewform) to 40,000 thoughtful operators by sponsoring this newsletter.
4. [Work with me for 1:1 executive coaching](https://www.weskao.com/coaching). I help hands-on founders and executives improve their ability and confidence with delegating, among other areas. Hit reply and I’m happy to share more.
