---
title: "mox - modern full-featured open source secure mail server for low-maintenance self-hosted email"
notion_id: cd134a66-7725-4f80-b7e9-9446776d476b
notion_url: https://app.notion.com/p/mox-modern-full-featured-open-source-secure-mail-server-for-low-maintenance-self-hosted-email-cd134a6677254f80b7e99446776d476b
last_edited: 2023-02-22T19:01:00.000Z
source_url: https://github.com/mjl-/mox
tags: ["Email", "Untried", "Tool", "English"]
---
...
Mox was created by Mechiel Lukkien, [mechiel@ueber.net](mailto:mechiel@ueber.net).

For discussions/talk, join #mox on irc.oftc.net, or #mox on the "Gopher slack".

# Download

You can easily (cross) compile mox if you have a recent Go toolchain installed (see "go version", it must be >= 1.19; otherwise, see [https://go.dev/dl/](https://go.dev/dl/) or [https://go.dev/doc/manage-install](https://go.dev/doc/manage-install) and $HOME/go/bin):
...
Or you can download a binary built with the latest Go toolchain from [https://beta.gobuilds.org/github.com/mjl-/mox](https://beta.gobuilds.org/github.com/mjl-/mox), and symlink or rename it to "mox".
...
See all commands and help text at [https://pkg.go.dev/github.com/mjl-/mox/](https://pkg.go.dev/github.com/mjl-/mox/), and example config files at [https://pkg.go.dev/github.com/mjl-/mox/config/](https://pkg.go.dev/github.com/mjl-/mox/config/).
...
Regular users (doing IMAP/SMTP with authentication) can change their password at the account page, e.g. [http://127.0.0.1/](http://127.0.0.1/). Or you can set a password with "mox setaccountpassword".
