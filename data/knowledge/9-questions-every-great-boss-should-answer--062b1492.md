---
title: "9 Questions Every Great Boss Should Answer"
notion_id: 062b1492-dc22-439b-b14e-974a0351b3bf
notion_url: https://app.notion.com/p/9-Questions-Every-Great-Boss-Should-Answer-062b1492dc22439bb14e974a0351b3bf
last_edited: 2023-03-29T23:44:00.000Z
source_url: https://hackernoon.com/9-questions-every-great-boss-should-answer?source=rss
tags: ["English", "Leadersheep", "Line/People/Team Management", "Article", "Hackernoon"]
---
## Too Long; Didn't Read

The art of management lies in the capacity to select from the many activities of seemingly comparable significance the one or two or three that provide leverage well beyond the others and concentrate on them. My MOTs, **moments of truth** as I call them are a monthly improvement exercise. They don’t need drastic changes or sudden improvements. Being effective in implementing a change requires time and effort. It also maintains the balance between utilizing what works and doing experimentation. All it needs is a commitment to do it every month by purposefully setting time aside.
...
Every day, multiple things vie for your attention, and you make hundreds of [decisions](https://hackernoon.com/alignment-model-leaders-need-to-make-better-decisions?ref=hackernoon.com), some good and some bad. Some consciously and others subconsciously. Do you take time to analyze your decisions? Are you aware of what gets your attention? With so much feedback around you (both direct and indirect), how do you separate signal from noise?

Generally, I see two reasons why most managers are not able to improve:

1. They are unable to ask themselves the right questions
2. They lack the humility required to be truthful
...
To improve, you need a repeatable system. My MOTs, **moments of truth** as I call them are a monthly improvement exercise. Years of putting it into practice, adjusting, and adapting got me excellent results over the years. All it needs is a commitment to do it every month by purposefully setting time aside.
...
### What’s my process to prioritize and how well do I prioritize?

What’s your framework for saying yes to something and no to something else? How do you know the impact of your decisions?
...
> The art of management lies in the capacity to select from the many activities of seemingly comparable significance the one or two or three that provide leverage well beyond the others and concentrate on them - Andy Groove

Some people have the tendency to incline towards the negative, thinking they are doing worse than they are and others exaggerate their prioritization skills. The only way to know how well you prioritize is to put your hunch to the test with this exercise.

Look at everything you prioritized last month:

1. Put a score against each activity 1-5, 1 being the lowest priority and 5 being the highest priority.
2. How many of your high-priority activities actually turned out to be impactful?
3. How many of the low-priority activities that you deprioritized turned out to be far more valuable later?
4. What were your decision criteria? What factors did you take into account? What did you miss?
5. Where was most of your time spent doing? Attending to the urgent or prioritizing the important?
...
Looking at the process you use to prioritize can get your team out of the rut and move them toward excellence.
...
> The first big part of your job as a manager is to ensure that your team knows what success looks like and cares about achieving it - Julie Zhuo

When the manager hasn’t communicated what’s expected of the employee, how can the employee live up to those expectations? How can people make the right decisions when they don’t even have a sense of their direction?
...
Using the success criteria keeps you close to the reality of how you’re doing. It also gives you the opportunity to improve your team’s effectiveness by identifying where they are lacking and taking measures to implement appropriate changes.
...
> Problems have to be solved, not managed. You can’t get away with burying them, minimizing them, reorganizing around them, softening them, or assigning blame somewhere outside your responsibility. You have to make real and effective changes - Colin Powell

Not taking responsibility for the outcomes makes you defensive. You feel like a victim, and spend time agonizing over your situation instead of focusing your time and energy on finding solutions.
...
Your behavior has a huge impact on how your team behaves when faced with similar situations. Acknowledging the fears that prevent you from taking responsibility and practicing courage is the only way to get rid of negative emotions and replace them with constructive action.

### Do I lead by example?

Do you only talk the talk or also walk the walk? You can’t have a different set of rules for yourself and your team. Just like your goals, your fundamental principles on how things are done, and what behaviors are acceptable to have to be aligned.
...
For example, if you tell your team to have healthy work-life boundaries, but end up calling them late in the evening or sending them emails in the night, what should they trust?
...
When the message is important, to reinforce it you need to say it out loud multiple times. You can’t say it once and expect it to stick. You can’t blame them if they didn’t understand something well. You have to provide clarity in the way they understand and ask questions to validate it.
...
> Spend zero time on what you could have done, and devote all of your time on what you might do - Ben Horowitz

How do you identify things that are not only important but clearly aren’t working? For example, giving aggressive deadlines might be leading to team exhaustion and [burnout](https://www.techtello.com/wrong-about-burnout-at-work/?ref=hackernoon.com), lack of clear requirements might be causing rework, and constant reshuffling of priorities makes your team unproductive.

Do this:

- Prepare a list of things that are hurting your team's productivity, outcomes, and hence impact.
- Stack ranks them in order of priority.
...
### What role does my ego play in decision-making?
...
Making the right decisions has less to do with your own knowledge and competence. It requires self-awareness and openness to acknowledge the gaps in your understanding and the curiosity to fill those gaps.
...
When executed well, collaboration is a gift. However, bad execution often turns it into a mess. Knowing how your team collaborates gives you the opportunity to make it better. For example, the wrong estimation can impact integration and cause the whole project to delay. Arguing endlessly over inconsequential decisions hurts their productivity.

> The challenge is not to eliminate conflict but to transform it. It is to change the way we deal with our differences - Roger Fisher
...
Asking these nine questions every month will help you identify hidden problems, acknowledge your team's strengths and give you the perspective you need to be flexible, to adjust and adapt. Getting better as a manager isn’t only about knowing how you’re doing. It’s also about taking action. This _Moments of Truth_ monthly exercise will help you do just that.
