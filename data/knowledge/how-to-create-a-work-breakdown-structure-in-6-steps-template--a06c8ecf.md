---
title: "How to Create a Work Breakdown Structure in 6 Steps [Template]"
notion_id: a06c8ecf-6fc7-4446-a694-153cf7b1bb3f
...
tags: ["English", "Productivity", "Project Management", "Article", "CheatSheet", "Toggl Blog"]
---
...
1. Collect [project requirements](https://toggl.com/blog/requirements-gathering)
...
We recommend checking out our guide on [gathering project requirements](https://toggl.com/blog/project-requirements) to learn more about becoming a pro on this step.
...
[WBS Template](https://docs.google.com/spreadsheets/d/1sEvWPo1hpklU_OlmbAPj3qIHvu_2v_Tjgb15fh8AVl4/copy)
...
Each phase may fit into your weekly sprints if you work using [agile methodologies](https://toggl.com/blog/agile-planning) and want to take a phased approach.

Check out this video below to learn more about using a phased sprint approach.

How to break a project down by The Futur
...
Alternatively, using [Toggl Track](https://toggl.com/track/), you can view past project data within the [project dashboard](https://support.toggl.com/en/articles/3167701-project-dashboard) to better understand what [tasks](https://support.toggl.com/en/articles/2220738-tasks), time, and costs went into each task.
...
1. Independent of other tasks and not duplicated elsewhere in the WBS
2. Broken down as far as possible without going too far

Yes, it’s possible to go too far. Breaking down a task until it’s manageable is what you’re aiming to do — but break it down _too far_, and you end up micromanaging your team.
...
If it contributes _one percent_ to the final product, it should be in the WBS.

The idea is to ensure that nothing gets left out to ensure your [project estimates](https://toggl.com/blog/project-cost-estimating) are as accurate as possible. This level of specificity means that you eliminate the risk of missing anything.

This breakdown in tasks will also help you to create your [project timeline](https://toggl.com/blog/create-project-timeline) and schedule.
...
1. Describing elements with nouns over verbs
2. Focusing on what an activity accomplishes—and write that

For example, the _task_ is ‘Design first draft of logo’ and the _outcome-oriented version_ is ‘First draft of the logo.’

## Purpose of a Work Breakdown Structure

Some of the [biggest causes of project failure](https://www.pmi.org/-/media/pmi/documents/public/pdf/learning/thought-leadership/pulse/pulse-of-the-profession-2018.pdf) are inadequate requirements gathering (35%) and inadequate vision or goal (29%). And both can be avoided by using a WBS.
...
The [latest PMBOK® Guide](https://www.pmi.org/pmbok-guide-standards/foundational/PMBOK) has 368 pages.
