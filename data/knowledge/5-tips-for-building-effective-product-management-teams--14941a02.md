---
title: "5 Tips for Building Effective Product Management Teams"
notion_id: 14941a02-1434-40d1-829e-04db9f402dff
...
tags: ["Itamar Gilad", "English", "Product Management", "Productivity", "Line/People/Team Management", "Article"]
---
### Let PMs Be PMs

Product management is at an interesting point. More and more companies embrace it as a way to supercharge the business, gratify customers and align the org, yet few product teams are able to deliver on these big expectations. I get asked by managers quite frequently how to get PMs to deliver more, have more impact, be more accountable. The answer, more often than not, starts with management itself — its perception of what product management is, how it operates, and how it should be built in the org. This post describes 5 of the most important ways to address this gap.

### 1. Focus the PM Mission on Delivering Value, Not Bits
...
> _The mission of product management is to find and help build the right product._

What makes a product right? Two things:

1. **It delivers high **[**value**](https://www.google.com/url?q=https%3A%2F%2Fmedium.com%2F%40itamargilad%2Fperceived-value-and-why-you-should-care-e03be4f3e3c3&sa=D&ust=1520286764185000&usg=AFQjCNF4kp25SQjiGOmkOvTSx0oX_-Unpw)** to a sizeable market, and**
2. **It helps capture lots of value back. (value can be monetary or other)**

![image](https://cdn-images-1.medium.com/max/800/0*Fc6iLu1hEPdhOIrO.)
...
Hundreds of product people have already taken my [Lean Product Management Workshops](http://itamargilad.com/workshops).

It’s consistently highly rated, and widely implemented. Some companies send every new PM to attend this workshop.

Join my next [public workshop](https://ti.to/itamar-gilad-events/), or [message me](mailto:info@itamargilad.com) to enquire about a private workshop for your company.
...
### 3. Encourage PMs to Discover as Well as Deliver

Google, Facebook, Amazon and other leading tech companies expect and encourage their PMs to act as intrapreneurs — discovering and building the right thing rather than managing a [feature factory](https://itamargilad.com/feature-factory/). They believe this is key to staying innovative and nimble. In this vein I coach product managers to employ both the mindset and the toolset of the entrepreneur even when working in larger companies. These include:

- Optimizing for [learning AND execution](https://blog.itnig.net/optimizing-your-project-for-learning-dfb60e86fd09)
- Creating [agile plans](https://hackernoon.com/why-i-stopped-using-product-roadmaps-and-switched-to-gist-planning-3b7f54e271d1) that assume constant change
- Setting and tracking metrics
- Idea [prioritization](https://medium.com/@itamargilad/why-impact-effort-prioritization-doesnt-work-57d141fafc2c) using impact, effort and [evidence](https://medium.com/@itamargilad/evidence-based-scoring-a-systematic-way-to-know-if-you-have-a-good-idea-44d39e166abf)
...
![image](https://itamargilad.com/wp-content/uploads/2018/03/Product-YinYang-v2-2048x755.jpg)
...
_**Thousands of product people are receiving my articles, eBooks and templates by email. **_[_**Sign up to my newsletter**_](http://itamargilad.com/newsletter)_** to be one of them.**_

### 4. Look For the Right Abilities, Not the Right Resume

When hiring PMs many companies tend to overlook for some key qualities that are crucial for role success:
...
At the same time, I see people being hired as PMs for the wrong reasons:
...
- They’re just there—Some companies convert project managers, designers, or engineers into product managers just because these people are already hired and need a role. This is not the right way to fill such a central and skill-specific role.

### 5. Have PMs Report to PMs
...
_Itamar Gilad (_[_itamargilad.com_](https://www.google.com/url?q=https%3A%2F%2Fitamargilad.com&sa=D&ust=1509627138041000&usg=AFQjCNEE9NcnCNm5NUjk-E51q1CnXPfQ7A)_) is a product coach, author, and speaker helping companies build high-value products. He held senior product management roles at Google, Microsoft and a number of startups for over 15 years._

### Want to learn more? [_**Sign up to my newsletter**_](http://eepurl.com/djUMjn)_** and join one of my **_[_**workshops**_](http://itamargilad.com/workshops)_**.**_
...
![image](https://itamargilad.com/wp-content/uploads/2023/10/evidence-Guided-cover-transaprent-small.png)
