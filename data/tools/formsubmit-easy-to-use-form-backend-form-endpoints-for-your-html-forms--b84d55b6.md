...
notion_id: b84d55b6-b4d6-471e-ac65-7931e76789dd
notion_url: https://app.notion.com/p/FormSubmit-Easy-to-use-form-backend-Form-endpoints-for-your-HTML-forms-b84d55b6b4d6471eac657931e76789dd
last_edited: 2024-06-05T18:35:00.000Z
source_url: https://formsubmit.co/
tags: ["Web Development", "Untried", "Service", "English"]
---
...
[  ](https://formsubmit.co/services)[**Deliver Your Software Projects With a Trusted Partner**](https://formsubmit.co/services)
...
Include a name attribute in all form elements (i.e. _<input>_, _<select>_, and _<textarea>_) to receive the submission data.
...
### [Try It Now →](https://formsubmit.co/live-demo)
...
[View all templates here →](https://formsubmit.co/email-templates)
