---
title: "github/gitignore: A collection of useful .gitignore templates"
notion_id: 2eb227c6-7917-4ebe-9671-d1b88e5ee1ef
notion_url: https://app.notion.com/p/github-gitignore-A-collection-of-useful-gitignore-templates-2eb227c679174ebe9671d1b88e5ee1ef
last_edited: 2023-01-18T14:07:00.000Z
source_url: https://github.com/github/gitignore#a-collection-of-gitignore-templates
tags: ["English", "Programming", "Guide"]
---
...
If a template is mostly a list of files installed by a particular version of some software (e.g. a PHP framework), it could live under the `community` directory. See [versioned templates](https://github.com/github/gitignore#versioned-templates) for more details.

If you have a small set of rules, or want to support a technology that is not widely in use, and still believe this will be helpful to others, please read the section about [specialized templates](https://github.com/github/gitignore#specialized-templates) for more details.
...
**Please only modify **_**one template**_** per pull request**. This helps keep pull requests and feedback focused on a specific project or technology.
