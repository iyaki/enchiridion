---
title: "4 laws and effects that govern user behavior"
notion_id: fcb0ea3f-8611-4cb6-a1d0-d03580900e3a
notion_url: https://app.notion.com/p/4-laws-and-effects-that-govern-user-behavior-fcb0ea3f86114cb6a1d0d03580900e3a
last_edited: 2022-12-19T14:00:00.000Z
source_url: https://blog.logrocket.com/product-management/user-behavior-laws-effects/
tags: ["Article", "LogRocket Blog", "English", "Product Management", "UI/UX"]
---
<!-- image hosted by Notion: its URL expires and is not preserved (ADR-05) -->

In this guide, we’ll introduce you to four of the most impactful laws, effects, and principles that influence user behavior:

## Table of contents

## The Von Restorff effect: Why the odd one out counts

The [Von Restorff effect](https://thebehavioursagency.com/von-restorff-effect/#:~:text=What%20is%20the%20Von%20Restorff,it%20is%20to%20be%20seen.), also known as The Isolation Effect, states that when you place multiple similar objects together, the object that differs most from the rest will more likely be remembered.

Named after the German psychiatrist Hedwig von Restorff, who, in her 1933 study, found that when participants were presented with a list of categorically similar items with one distinctive item on the list, memory for the distinctive item was improved:

<!-- image hosted by Notion: its URL expires and is not preserved (ADR-05) -->

### How does this impact user behavior?

This theory manifests itself regularly in our everyday lives. We encounter decisions that use this insight constantly when designing and improving our products.
...
[Miller’s Law](https://uxdesign.cc/millers-law-is-there-a-magical-number-in-ux-design-7999f92ef7b8#:~:text=Miller%27s%20Law%20states%20that%20the,number%20of%20choices%20to%20them.) focuses on the ability to multitask.
...
[Hick’s Law](https://lawsofux.com/hicks-law/), or more formally known as the Hick-Hyman Law, is named after the psychologists William Hick and Ray Hyman who, in 1952, set out to research the relationship between the number of stimuli an individual is presented with and the impact that this has on the individual’s reaction time.

The research resulted in the discovery that the more stimuli an individual has to choose from, the longer it takes them to make a decision:

<!-- image hosted by Notion: its URL expires and is not preserved (ADR-05) -->

### How does this impact user behavior?

You’ll see the basis of this theory present in numerous products that you’ll likely have interacted with.
...
In 1995, researchers at the Hitachi Design Center started looking at human-computer interaction and identified a strong correlation between the ratings of how the user interface looked and how they perceived its usability to be. This came to be known as the [aesthetic-usability effect](https://www.nngroup.com/articles/aesthetic-usability-effect/#:~:text=Definition%3A%20The%20aesthetic%2Dusability%20effect,actually%20more%20effective%20or%20efficient.).
...
Making products more aesthetically pleasing may override any usability difficulties.

Can you provide low-fidelity [wireframes or prototypes](https://blog.logrocket.com/product-management/wireframe-vs-mockup-vs-prototype/), where the content and usability is the star and not the aesthetic?

## And it doesn’t end there

These four effects and theories are not the only ones that are influencing the way we develop our products.

From the [Verbatim Effect](https://effectiviology.com/verbatim-effect/) to the [Schema Theory](http://web.mit.edu/pankin/www/Schema_Theory_and_Concept_Formation.pdf), [Jakob’s Law](https://lawsofux.com/jakobs-law/) to the [Peak-End Rule](https://thedecisionlab.com/biases/peak-end-rule), there is reason and thought behind why our users are doing what they are doing.
